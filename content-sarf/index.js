// "Advanced Sarf" course — module registry, mirroring content/index.js's,
// content-fstu/index.js's, and content-fstu-sarf/index.js's pattern exactly.
// Modules unlock in array order (see isModuleUnlocked in content/index.js).
// Source: شذا العرف في فن الصرف by أحمد الحملاوي.
...
export const MODULES = [m01, m02, m03, m04, m05, m06, m07, m08, m09, m10, m11, m12, m13, m14, m15]
  .map(mod => ({ ...mod, lessons: mod.lessons.map(lesson => ({ ...lesson, learningModel: 'mizan-sarf', learningKey: `${mod.id}/${lesson.id}` })) }));
