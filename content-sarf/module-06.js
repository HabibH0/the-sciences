// Module 06 — المتعدي واللازم (The Transitive Verb and the Intransitive)
//
...
// verb lists, شواهد and examples are kept faithful to the source. Concept
...
// التقسيم السادس (المعلوم والمجهول) follows in Module 07.
      ...
      concepts: [
        {
          ...
          lines: [
            { html: `<bdi>يَنْقَسِمُ الفِعْلُ إلى</bdi> two, each of which has a second name.`, list: false },
            { table: { headers: ['القسم', 'ويُسَمَّى'], rows: [
              ['مُتَعَدٍّ', 'مُجاوِزًا'],
              ['لازِم', 'قاصِرًا'],
            ] } },
          ...
          exercise: {
            prompt: `The definition of المتعدي adds بِنَفْسِهِ. What does that exclude?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `<bdi>الهاءُ لَيْسَتْ بِمَفْعُولٍ بِهِ، إنَّما هي مَفْعُولٌ مُطْلَقٌ</bdi> — which is why it proves nothing about transitivity.`, list: false },
          ],
          clarification: `The test can be stated as a single question: what does the هاء refer back to? In زَيْدٌ ضَرَبَهُ عَمْرٌو it refers to زيد, a person — someone the striking landed on — and only a transitive verb can have that. In الفَرْحُ فَرِحَهُ زَيْدٌ it refers to الفَرْح, which is the verb's own مصدر; the phrase amounts to "Zayd rejoiced the rejoicing", and every verb can do that, transitive or not, because a مفعول مطلق is just the action named again for emphasis. So the sign is not "a هاء attaches" but "a هاء attaches referring to something other than the action itself".`,
          exercise: {
            prompt: `In الفَرْحُ فَرِحَهُ زَيْدٌ, a هاء has attached to a verb. Why does that not prove فَرِحَ is متعدٍّ؟`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `Why must the اسم مفعول be تام for the test to work?`,
            kind: 'mcq',
            options: ['The تام form is the only one that is مبني', 'Because otherwise it would be a مصدر', 'A لازم verb also yields one, but only attached to a حرف جر or ظرف', 'A لازم verb yields no اسم مفعول at all'],
            correct: 2,
          },
        },
        {
          ...
          exercise: {
            prompt: `Which of the three kinds of متعدٍّ is described as كثير؟`,
            kind: 'mcq',
            options: ['باب أعلم وأرى', 'ما يتعدى إلى مفعول واحد', 'ما يتعدى إلى مفعولين', 'ما يتعدى إلى ثلاثة مفاعيل'],
            correct: 1,
          },
        },
      ],
      ...
      bank: [
        {
          title: 'مجاوز وقاصر',
          kind: 'mcq',
          prompt: 'Which pair of second names belongs to this division?',
        ...
        },
        {
          title: 'ترتيب النظر',
          kind: 'mcq',
          prompt: 'To place a verb in this division, what do you ask first?',
    ...
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            prompt: `Which of the three kinds of متعدٍّ needs no further subdivision?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `In ظَنَّ الطالِبُ الدَّرْسَ سَهْلًا, what were الدَّرْسَ and سَهْلًا originally?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `Strip the verb from أَعْطَى زَيدٌ عَمْرًا دِرْهَمًا and the two objects do not form a sentence. What does that establish?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `In ﴿يُرِيهِمُ اللَّهُ أَعْمَالَهُمْ حَسَرَاتٍ عَلَيْهِمْ﴾, how many مفاعيل does the verb take?`,
            kind: 'mcq',
      ...
      bank: [
        ...
        },
        {
          title: 'سورة الشاهد',
          kind: 'mcq',
          prompt: 'From which sūra is ﴿كَذَٰلِكَ يُرِيهِمُ اللَّهُ أَعْمَالَهُمْ حَسَرَاتٍ عَلَيْهِمْ﴾ taken?',
          options: ['آل عمران', 'النور', 'يوسف', 'البقرة'],
          correct: 3,
        },
        {
          title: 'خالَ وزعم',
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            prompt: `فَرَّحْتُ زَيْدًا. Which سبب has made the verb transitive?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `ذَهَبْتُ بِعَلِيٍّ is marked متعدٍّ معنًى. How does that differ from a plain متعدٍّ؟`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `In ﴿ولا تَعْزِمُوا عُقْدَةَ النِّكاحِ﴾, whose meaning has تَعْزِمُوا absorbed?`,
            kind: 'mcq',
            options: ['تَنْوُوا', 'تَبْلُغُوا', 'تَعْقِدُوا', 'تَحْذَرُوا'],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            prompt: `A لازم verb has never been heard taking an object. May you make it transitive by one of the eight أسباب؟`,
            kind: 'mcq',
      ...
      bank: [
        ...
        },
        {
          ...
          kind: 'mcq',
          prompt: 'What do the first three أسباب have in common?',
        ...
        },
        {
          title: 'وقد تقدَّمت',
          kind: 'mcq',
          prompt: 'The third سبب is marked وقد تقدَّمت. Where was it treated before?',
          options: ['Under الميزان الصرفي', 'Under فَاعَلَ among معاني صيغ الزوائد', 'Under الجامد والمتصرف', 'Under الصحيح والمعتل'],
          correct: 1,
        },
        {
          title: 'متعدٍّ معنى',
        ...
        },
        {
          title: 'سورة تعزموا',
          kind: 'mcq',
          prompt: 'From which sūra is ﴿ولا تَعْزِمُوا عُقْدَةَ النِّكاحِ﴾ taken?',
          options: ['النور', 'آل عمران', 'الأعراف', 'البقرة'],
          correct: 3,
        },
        {
    ...
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            prompt: `ضَرَبَ is متعدٍّ but ضَرُبَ is لازم. Why does the shift to فَعُلَ cost the verb its object?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `In ﴿إِنْ كُنْتُمْ لِلرُّؤْيَا تَعْبُرُونَ﴾, why is a لام supplied before الرؤيا؟`,
            kind: 'mcq',
        ...
        },
        {
          ...
          exercise: {
            prompt: `How does الضرورة الشعرية differ from the other four أسباب؟`,
            kind: 'mcq',
      ...
      bank: [
        {
          title: 'عكس الأسباب',
          kind: 'mcq',
          prompt: 'How do these five أسباب relate to the eight of the previous lesson?',
        ...
        },
        {
          ...
          kind: 'mcq',
          prompt: 'التضمين appears in both lists. What differs between the two uses?',
        ...
        },
        {
          title: 'سورة يخالفون',
          kind: 'mcq',
          prompt: 'From which sūra is ﴿فَلْيَحْذَرِ الَّذِينَ يُخَالِفُونَ عَنْ أَمْرِهِ﴾ taken?',
          options: ['النور', 'البقرة', 'يوسف', 'الأعراف'],
          correct: 0,
        },
        {
        ...
        },
        {
          title: 'سورة الرؤيا',
          kind: 'mcq',
          prompt: 'From which sūra is ﴿إِنْ كُنْتُمْ لِلرُّؤْيَا تَعْبُرُونَ﴾ taken?',
          options: ['البقرة', 'آل عمران', 'يوسف', 'النور'],
          correct: 2,
        },
        {
          title: 'عبر الرؤيا',
        ...
        },
        {
          title: 'أسباب متكررة',
          kind: 'mcq',
          prompt: 'Which of the five أسباب is marked كما تقدَّم, having been treated earlier?',
          options: ['ضعف العامل بتأخيره', 'التضمين', 'صيرورته مطاوعًا', 'الضرورة الشعرية'],
          correct: 2,
        },
        {
          title: 'اتجاها التقسيم',
          kind: 'mcq',
          prompt: 'Taking both lists together, how many أسباب are given in all?',
