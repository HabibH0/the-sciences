// Module 06 — الجامد والمتصرف (The Frozen Verb and the Inflecting Verb)
//
...
// التقسيم الخامس (اللازم والمتعدي) follows in Module 07.
      ...
      concepts: [
        {
          ...
          lines: [
            ...
            { table: { title: 'أقسام الجامد (Divisions of الجامد)', headers: ['القسم (Division)', 'ما يترتب عليه (What Follows From It)', 'أمثلة (Examples, with Meaning)'], rows: [
              ...
              ['ما يكونُ مُلازِمًا لِلْأَمْرِيَّةِ — locked into the أمر', 'فليس له ماضٍ ولا مُضارِعٌ — so it has no ماضي and no مضارع', 'هَبْ (suppose), تَعَلَّمْ (know!)'],
            ] } },
            { html: `The first group is much the larger of the three; the other two hold only a handful of verbs each.`, list: false },
            { html: `The prose itself treats only the first and third of these:`, list: false },
            { box: { title: 'Core Text', lines: [
              `إمَّا أن يكونَ مُلازِمًا لِلْمُضِيِّ … وإمَّا أن يكونَ مُلازِمًا لِلْأَمْرِيَّةِ`,
            ] } },
            { html: `The summary table adds the middle case — verbs frozen in the مضارع — so the fuller picture is three.`, list: false },
          ],
          exercise: {
        ...
        },
        {
          ...
          lines: [
            ...
            { box: { title: 'Core Text', lines: [
              `على خِلافٍ في بَعْضِها؛ فإنَّ بَعْضَهُم يَعُدُّونَ (خَلا) و(عَدا) و(حاشا) حُرُوفًا، ويَعُدُّ الكُوفِيُّونَ (نِعْمَ) و(بِئْسَ) اسْمَيْنِ`,
            ] } },
      ...
      bank: [
        ...
        },
        {
          ...
          options: [
            ...
            'They are held by some to be حروف rather than أفعال',
            'They both carry a مضارع in poetry',
          ],
          correct: 1,
        },
        {
          title: 'ليس وأخواتها',
          kind: 'mcq',
          prompt: 'لَيْسَ is جامد. In this باب it is grouped with which family?',
          options: ['أخوات كان (kān’s sisters)', 'أفعال الرجاء (verbs of hope)', 'أفعال الشروع (verbs of commencement)', 'أفعال المقاربة (verbs of imminence)'],
          correct: 0,
        },
        {
          title: 'نعم الرجل زيد',
    ...
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          lines: [
            { box: { title: 'Core Text', lines: [
              `والمُتَصَرِّف: ما لا يُلازِمُ صُورَةً واحِدَةً`,
            ] } },
            { html: `The exact opposite of the جامد's ما لازَمَ صُورَةً واحِدَةً — and it splits by how far the inflection reaches.`, list: false },
            ...
            { html: `So the whole division turns on one word: whether the verb لازَمَ a single form or not.`, list: false },
          ],
          exercise: {
        ...
        },
        {
          ...
          lines: [
            { box: { title: 'Core Text', lines: [
              `وهو يَأْتِي منه الماضي والمُضارِعُ والأَمْرُ، كنَصَرَ ودَحْرَجَ`,
        ...
        },
        {
          ...
          lines: [
            { box: { title: 'Core Text', lines: [
              `وهو ما يَأْتِي منه الماضي والمُضارِعُ فقط`,
            ] } },
            { html: `Only the ماضي and المضارع come from it — no أمر. Two families fall here, and the first is:`, list: false },
            ...
            { box: { title: 'Core Text', lines: [
              `وهي أَفْعالُ الاسْتِمْرارِ بِمَعْنَى (بَقِيَ)`,
            ] } },
            { html: `All four carry the sense of remaining or continuing.`, list: false },
          ],
          exercise: {
      ...
      bank: [
        ...
        },
        {
          title: 'مطابقة فتئ',
          kind: 'mcq',
          prompt: 'Which مضارع correctly pairs with the ماضي فَتِئَ, from the أفعال الاستمرار table?',
          options: ['يَفْتَأُ', 'يَزالُ', 'يَبْرَحُ', 'يَنْفَكُّ'],
          correct: 0,
        },
        {
          title: 'أفعال الاستمرار كلّها',
          kind: 'mcq',
          prompt: 'زالَ، بَرِحَ، فَتِئَ and انْفَكَّ are grouped under أفعال الاستمرار here because, beyond their shared meaning, they share which property؟',
          options: ['They are all ناقصة التصرف — a ماضٍ and مضارع but no أمر', 'They are all رباعية', 'They are all معتلة', 'They are all متعدية'],
          correct: 0,
        },
        {
          title: 'مطابقة أوشك',
          kind: 'mcq',
          prompt: 'Which مضارع correctly pairs with the ماضي أَوْشَكَ, from the أفعال المقاربة table?',
          options: ['يُوشِكُ', 'يَكادُ', 'يَنْتَهِي', 'يَبْقَى'],
          correct: 0,
        },
        {
          title: 'كرَب وكاد',
        ...
        {
          title: 'تام مقابل ناقص',
          kind: 'mcq',
          prompt: 'What is the one difference between تام التصرف and ناقص التصرف؟',
          options: ['ناقص التصرف has a ماضٍ and مضارع but no أمر; تام التصرف has all three', 'تام التصرف has no أمر', 'ناقص التصرف has no ماضٍ', 'They differ in whether the verb is لازم or متعدٍّ'],
          correct: 0,
        },
      ],
    },
      ...
      concepts: [
        {
          ...
          lines: [
            { html: `Building a مضارع out of a ماضي starts with one addition.`, list: false },
            { box: { title: 'Core Text', lines: [
              `أن يُزادَ في أوَّلِهِ أَحَدُ أَحْرُفِ المُضارَعَةِ`,
            ] } },
        ...
        },
        {
          ...
          lines: [
            { html: `The أمر is built from the مضارع in two steps, the second conditional on the first.`, list: false },
            { box: { title: 'Core Text', lines: [
