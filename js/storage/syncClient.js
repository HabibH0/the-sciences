...
export function mergeProgressData(localProgress = {}, remoteProgress = {}) {
  ...
  for (const key of ['theme', 'accent', 'arabicFace', 'arabicHeadingFace', 'lessonTextScale', 'uiTextScale', 'tarkeebTranslations', 'tarkeebLabelsBlue', 'kufiHeadings', 'nav', 'litCheckLang', 'litTextScale', 'litHoverTranslate']) {
