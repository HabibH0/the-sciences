  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      quiz: [
        ...
        { q: `وا is technically one of the seven أحرف النداء, but grammarians classify its use differently from the other six. How?`, options: [`It is مجاز — a figurative expression of grief, not real calling`, `It is used only لِلْقَريب`, `It cannot ever begin a sentence`, `It always requires تنوين on what follows`], correct: 0 },
      ...
      bank: [
        ...
        { title: `الله: هل يجوز حذف يا`, kind: 'mcq', prompt: `Can حرف النداء ever be dropped before لَفْظ الجَلالَة, so that a speaker says اللهُ اغْفِرْ لي instead of يا اللهُ اغْفِرْ لي?`, options: [`No — the drop is never allowed before لفظ الجلالة`, `Yes, since الله is a علم`, `Yes, since الله is مضاف`, `Only in poetry`], correct: 0 },
        ...
        { title: `الفرق بين حالتي الحذف والمنع`, kind: 'mcq', prompt: `مضاف and علم allow حرف النداء to be dropped; لفظ الجلالة and نكرة مقصودة block it. What do the two blocking cases share, that the two allowing cases don't?`, options: [`Without حرف النداء, the calling would no longer be recognisable on its own`, `They are both أعلام`, `They both take تنوين`, `They are both مضاف`], correct: 0 },
        {
          ...
          distractors: [`فعل أمر`, `مفعول لأجله`],
        },
        {
        ...
        },
        {
          ...
          distractors: [`مضاف إليه`, `مفعول به`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`شبيه بالمضاف — it governs ذُنوبَنا the way a مضاف governs its مضاف إليه`, `مضاف`, `نكرة غير مقصودة`, `لفظ الجلالة`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`زَيْنَب has only three root letters once the extra ب is removed; عَبْدَ اللهِ is a مركب`, `زَيْنَب is مؤنث; عَبْدَ اللهِ is مذكر`, `Both are already مرخّم`, `Both end in تاء مربوطة`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `جَعْفَر can be shortened to يا جَعْفُ through الترخيم, but زَيْد cannot be shortened at all. Why not?`, options: [`زَيْد has only three letters total, failing the "more than three letters" condition`, `زَيْد ends in تاء مربوطة`, `زَيْد is مركب`, `الترخيم never applies to أعلام مذكرة`], correct: 0 },
        { q: `اللَّهُمَّ نَعَمْ signals something specific about the speaker's answer. What does it signal?`, options: [`Certainty — "yes, absolutely, without a doubt"`, `Doubt about the answer`, `A rare, extraordinary exception`, `A polite refusal`], correct: 0 },
      ],
      bank: [
        ...
        { title: `لفظا أم محلا`, kind: 'mcq', prompt: `المنادى's نصب can show in two different ways. What are they?`, options: [`لفظًا (visible on the word) or محلًّا (only in underlying position)`, `رفعًا أو جرًا`, `أصليًا أو فرعيًا`, `ظاهرًا أو مقدرًا فقط`], correct: 0 },
        ...
        { title: `شرط النصب لفظا: شبيه بالمضاف`, kind: 'mcq', prompt: `What makes غافِرًا in يا غافِرًا ذُنوبَنا count as شبيه بالمضاف, even though it isn't literally مضاف?`, options: [`It governs ذُنوبَنا as its own مفعول به, the way a مضاف governs a مضاف إليه`, `It ends in تنوين`, `It is a علم`, `It is مبني`], correct: 0 },
        ...
        { title: `حارث: حالتا الترخيم`, kind: 'mcq', prompt: `After shortening حارِث by الترخيم, the remaining letter can carry either of two vowels. What are they, and which is preferred?`, options: [`الحركة الأصلية (preferred) or الضمة`, `الفتحة (preferred) or الكسرة`, `السكون فقط`, `التنوين أو السكون`], correct: 0 },
        { title: `عائشة: شرط الترخيم`, kind: 'mcq', prompt: `عائِشَة can be shortened to يا عائِشُ. Which of the two conditions for ترخيم does عائِشَة satisfy?`, options: [`المختوم بالتاء — it ends in تاء مربوطة`, `العلم المذكر الزائد على ثلاثة أحرف`, `كلا الشرطين معًا`, `لا شيء منهما`], correct: 0 },
        { title: `عبد الله: لماذا لا يُرخَّم`, kind: 'mcq', prompt: `عَبْدَ اللهِ cannot be shortened through الترخيم even though it names a person. Why not?`, options: [`It is مركب (a compound name), which الترخيم excludes`, `It is مؤنث`, `It ends in تاء مربوطة`, `It is فقط ثلاثة أحرف`], correct: 0 },
        ...
        { title: `ثلاثة أسباب للنصب لفظا`, kind: 'mcq', prompt: `Which three conditions together make المنادى منصوب لفظًا rather than مبني?`, options: [`مضاف، شبيه بالمضاف، نكرة غير مقصودة`, `علم، نكرة مقصودة، مثنى`, `مضاف، علم، جمع مذكر سالم`, `نكرة مقصودة، مثنى، جمع`], correct: 0 },
        {
          ...
          distractors: [`منادى مبني`, `فعل أمر`],
        },
        {
        ...
        },
        {
          ...
          distractors: [`منادى منصوب لفظا`, `مضاف إليه`],
        },
        {
          ...
          words: [`يا`, `رَجُلُ`],
          labels: [`حرف نداء`, `منادى مبني على الضم في محل نصب`],
          distractors: [`منادى منصوب لفظا`, `نعت`],
        },
        {
          ...
          distractors: [`منادى مبني على الألف`, `فاعل`],
        },
        {
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`واحد فقط — يا`, `اثنان — يا وآ`, `ثلاثة`, `سبعة كلها`],
            correct: 0,
          },
        },
        {
          ...
          lines: [
            ...
            { html: `In يا لَلَّهِ, اللَّهِ carries the فتحة-لام (لام الاستغاثة), which is جارّة, making اللهِ مجرور لفظا while المستغاث itself stays منصوب محلا (as any منادى). يا زَيْدا and يا زَيْداهْ instead add an ألف onto زَيْد, achieving the same effect without the لام.`, list: false },
          ],
          exercise: {
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `In يا لَلَّهِ لِلْمُسْلِمينَ ("O for the sake of Allah's help, for the Muslims!"), اللَّهِ (المستغاث) carries لام مفتوحة, while المُسْلِمينَ (المستغاث له) carries لام مكسورة. The same contrast distinguishes زيد (the helper being called) from خالد (the one who needs help) in يا لَزَيْدٍ لِخالِدٍ.`, list: false },
            {
              tarkeebDiagram: {
          ...
          exercise: {
            prompt: `In يا لَلَّهِ لِلْمُسْلِمينَ, both اللَّهِ and المُسْلِمينَ carry a جارّة لام, but with opposite vowels. Which carries the كسرة?`,
            kind: 'mcq',
            options: [`المُسْلِمينَ, since it is المستغاث له`, `اللَّهِ, since it is المستغاث`, `Both carry كسرة`, `Neither carries a vowel — both are مبنيان`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `يا زَيْدا achieves the same effect as يا لَزَيْدٍ, but without a لام. What does it use instead?`, options: [`An ألف added to the end of المستغاث`, `A كسرة on المستغاث`, `A تنوين on المستغاث`, `A second يا`], correct: 0 },
      ...
      bank: [
        { title: `الاستغاثة: التعريف`, kind: 'mcq', prompt: `Which of these correctly defines الاستغاثة?`, options: [`نداء المنادي — calling someone to seek their aid for someone else`, `Calling the منادى to express grief`, `Calling merely to draw attention`, `Calling to express amazement at something`], correct: 0 },
        ...
        { title: `الألف بدلا من اللام`, kind: 'mcq', prompt: `Instead of adding لام الاستغاثة, a speaker can achieve the same effect another way. How؟`, options: [`Adding an ألف onto the end of المستغاث itself`, `Repeating يا twice`, `Dropping المستغاث entirely`, `Using وا instead of يا`], correct: 0 },
        { title: `يا لله: الإعراب`, kind: 'mcq', prompt: `In يا لَلَّهِ, اللَّهِ carries a جارّة لام, making it مجرور لفظا. What is المستغاث's إعراب overall, despite that لفظي جر؟`, options: [`منصوب محلا, like any منادى`, `مجرور محلا`, `مرفوع لفظا`, `مجزوم`], correct: 0 },
        { title: `المعطوف بتكرار يا`, kind: 'mcq', prompt: `When a second مستغاث is coordinated with a repeated يا, what vowel does its لام carry؟`, options: [`فتحة, exactly like the first`, `كسرة, unlike the first`, `ضمة`, `لا لام له أصلا`], correct: 0 },
        { title: `المعطوف بلا تكرار يا`, kind: 'mcq', prompt: `When a second مستغاث is coordinated WITHOUT repeating يا, what vowel does its لام carry, and why؟`, options: [`كسرة — so it isn't mistaken for المستغاث له's لام`, `فتحة — no change from the first`, `ضمة — since it is now مرفوع`, `لا لام له أصلا`], correct: 0 },
        { title: `لماذا الفرق بين اللامين مقصود`, kind: 'mcq', prompt: `Why does الاستغاثة deliberately give المستغاث and المستغاث له opposite لام vowels؟`, options: [`To keep the two roles distinguishable when both sit side by side as جار ومجرور`, `Because المستغاث له is always مذكر`, `Because المستغاث always comes first alphabetically`, `It has no grammatical purpose`], correct: 0 },
        { title: `يا لزيد لخالد: من المستغاث ومن المستغاث له`, kind: 'mcq', prompt: `In يا لَزَيْدٍ لِخالِدٍ, who is being called for help, and who is being helped؟`, options: [`زيد is المستغاث (called for help); خالد is المستغاث له (being helped)`, `خالد is المستغاث; زيد is المستغاث له`, `Both are المستغاث`, `Neither role applies here`], correct: 0 },
        { title: `نداء التعجب: التعريف`, kind: 'mcq', prompt: `Which of these correctly defines نداء التعجب?`, options: [`"Calling out" the thing one is amazed by`, `Calling someone to seek their aid for someone else`, `Calling to express grief`, `An ordinary call, just to draw attention`], correct: 0 },
        { title: `هل نداء التعجب نداء حقيقي`, kind: 'mcq', prompt: `In نداء التعجب, is the thing being "called" always a hearing, living addressee؟`, options: [`No — it may be something like القرآن, since the construction exists only to voice astonishment`, `Yes — it must always be a person`, `Yes — it must always be الله`, `No — it can never be a real noun at all`], correct: 0 },
        { title: `يا للقرآن: أي دور`, kind: 'mcq', prompt: `يا لَلْقُرْآنِ places القرآن in which slot from الاستغاثة's own machinery؟`, options: [`المستغاث's slot (لام مفتوحة)`, `المستغاث له's slot (لام مكسورة)`, `حرف الاستغاثة's slot`, `لا يشغل أي دور`], correct: 0 },
        ...
        { title: `لام الاستغاثة: وظيفتها`, kind: 'mcq', prompt: `What purpose does لام الاستغاثة serve, beyond marking المستغاث's إعراب لفظا؟`, options: [`It clarifies that genuine help is being sought, not a trivial summons`, `It changes المستغاث into المستغاث له`, `It replaces حرف الاستغاثة entirely`, `It marks المستغاث as نكرة`], correct: 0 },
        {
          ...
          distractors: [`منادى مبني`, `مضاف إليه`],
        },
        {
        ...
        },
        {
          ...
          distractors: [`مستغاث بلام مفتوحة أخرى`, `حرف جر زائد`],
        },
        {
          ...
          distractors: [`متعجب منه بمنزلة المستغاث له`, `مضاف إليه`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`وا is never used for anything but expressing grief, so no context is needed to rule out ambiguity`, `وا is grammatically easier to pronounce`, `يا can never follow a علم`, `وا always takes تنوين`],
            correct: 0,
          },
        },
        {
          ...
          lines: [
            ...
            { html: `وا زَيْدُ treats زَيْدُ exactly as يا زَيْدُ would: مبني على الضم في محل نصب. وا عَبْدَ اللهِ likewise treats عَبْدَ as منصوب لفظا because مضاف, exactly as يا عَبْدَ اللهِ would.`, list: false },
          ],
          exercise: {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`حرف نداء + منادى, standing in for a dropped أدعو`, `فعل ماضٍ + فاعل`, `مبتدأ + خبر`, `حرف جر + مجرور`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `وارَأْساهْ carries both extra letters. When specifically is هاء السكت added?`, options: [`عند الوقف — when pausing on the word`, `عند الوصل فقط`, `في أول الكلمة`, `بعد حرف الجر فقط`], correct: 0 },
        { q: `What single grammatical skeleton do النداء العادي, الاستغاثة, نداء التعجب, and الندبة all share, despite serving four different purposes?`, options: [`حرف نداء + منادى, standing in for a dropped أدعو`, `فعل + فاعل + مفعول به`, `مبتدأ + خبر فقط`, `حرف جر + اسم مجرور فقط`], correct: 0 },
      ],
      bank: [
        ...
        { title: `يا في الندبة: الشرط`, kind: 'mcq', prompt: `A speaker uses يا instead of وا to mourn someone who just passed away. Under what condition is that acceptable؟`, options: [`Only if the context rules out confusion with an ordinary call`, `Never — يا can only ever be an ordinary حرف نداء`, `Only if the deceased is مذكر`, `Only in poetry`], correct: 0 },
        ...
        { title: `وا عبد الله: الإعراب`, kind: 'mcq', prompt: `In وا عَبْدَ اللهِ, what makes عَبْدَ منصوب لفظا؟`, options: [`It is مضاف, exactly as it would be after يا`, `It is علم مفرد`, `It is نكرة غير مقصودة`, `الندبة always forces النصب لفظا regardless of the word's type`], correct: 0 },
        { title: `ألف الندبة: وظيفتها`, kind: 'mcq', prompt: `What effect does ألف الندبة have when added to the end of المنادى؟`, options: [`It lengthens the cry, intensifying the note of grief`, `It changes المنادى's إعراب from مبني to منصوب لفظا`, `It marks المنادى as نكرة`, `It replaces حرف الندبة entirely`], correct: 0 },
        { title: `هاء السكت: متى تُضاف`, kind: 'mcq', prompt: `هاء السكت is added after ألف الندبة under one specific condition. What is it؟`, options: [`عند الوقف — only when pausing on the word`, `Whenever المنادى is مذكر`, `Whenever وا is used instead of يا`, `It is always added, regardless of context`], correct: 0 },
        { title: `وا زيدا مقابل وارأساه`, kind: 'mcq', prompt: `وا زَيْدا adds only one extra letter; وارَأْساهْ adds two. What is the difference between them?`, options: [`وا زَيْدا adds only ألف الندبة; وارَأْساهْ adds ألف الندبة plus هاء السكت`, `وا زَيْدا adds هاء السكت only; وارَأْساهْ adds ألف الندبة only`, `There is no real difference between them`, `وا زَيْدا uses يا instead of وا`], correct: 0 },
        ...
        { title: `ما الذي يبقى ثابتا عبر أوجه النداء الأربعة`, kind: 'mcq', prompt: `Despite their different purposes, what stays constant across all four faces of النداء؟`, options: [`The underlying skeleton: حرف نداء + منادى standing in for a dropped أدعو`, `The specific حرف used`, `Whether المنادى is منصوب لفظا or مبني`, `The presence of لام الاستغاثة`], correct: 0 },
        {
          ...
          distractors: [`حرف استغاثة`, `مستغاث له`],
        },
        {
