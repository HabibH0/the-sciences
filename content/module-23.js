  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      bank: [
        ...
        { title: `الفرق بين حالتي الحذف والمنع`, kind: 'mcq', prompt: `مضاف and علم allow حرف النداء to be dropped; لفظ الجلالة and نكرة مقصودة block it. What do the two blocking cases share, that the two allowing cases don't?`, options: [`Without حرف النداء, the calling would no longer be recognisable on its own`, `They are both أعلام`, `They both take تنوين`, `They are both مضاف`], correct: 0 },
        {
          ...
          distractors: [`فعل أمر`, `مفعول لأجله`, `حرف جر`, `حرف عطف`],
        },
        {
          ...
          distractors: [`حرف جر`, `خبر`, `مبتدأ`, `مفعول به`],
        },
        {
          ...
          distractors: [`مضاف إليه`, `مفعول به`, `مبتدأ`, `فاعل`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      bank: [
        ...
        { title: `ثلاثة أسباب للنصب لفظا`, kind: 'mcq', prompt: `Which three conditions together make المنادى منصوب لفظًا rather than مبني?`, options: [`مضاف، شبيه بالمضاف، نكرة غير مقصودة`, `علم، نكرة مقصودة، مثنى`, `مضاف، علم، جمع مذكر سالم`, `نكرة مقصودة، مثنى، جمع`], correct: 0 },
        {
          ...
          distractors: [`منادى مبني`, `فعل أمر`, `منادى منصوب لفظا (شبيه بالمضاف)`, `حرف جر`],
        },
        {
          ...
          distractors: [`مضاف إليه`, `خبر`, `منادى منصوب لفظا (مضاف)`, `منادى مبني`],
        },
        {
          ...
          distractors: [`منادى منصوب لفظا`, `مضاف إليه`, `منادى مبني على الواو في محل نصب`, `منادى مبني على الألف في محل نصب`],
        },
        {
          ...
          words: [`يا`, `رَجُلُ`],
          labels: [`حرف نداء`, `منادى مبني على الضم في محل نصب`],
          distractors: [`منادى منصوب لفظا`, `نعت`, `منادى مبني على الواو في محل نصب`, `منادى مبني على الألف في محل نصب`],
        },
        {
          ...
          distractors: [`منادى مبني على الألف`, `فاعل`, `منادى مبني على الضم في محل نصب`, `منادى منصوب لفظا (شبيه بالمضاف)`],
        },
        {
          ...
          distractors: [`مضاف إليه`, `حرف جر`, `منادى مبني على الضم في محل نصب`, `حرف عطف`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`المُسْلِمينَ, since it is المستغاث له`, `لَفْظِ الجَلالَةِ, since it is المستغاث`, `Both carry كسرة`, `Neither carries a vowel — both are مبنيان`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        ...
        { title: `يا لله: الإعراب`, kind: 'mcq', prompt: `In يا لَلَّهِ, لَفْظِ الجَلالَةِ carries a جارّة لام, making it مجرور لفظا. What is المستغاث's إعراب overall, despite that لفظي جر؟`, options: [`منصوب محلا, like any منادى`, `مجرور محلا`, `مرفوع لفظا`, `مجزوم`], correct: 0 },
        ...
        { title: `لام الاستغاثة: وظيفتها`, kind: 'mcq', prompt: `What purpose does لام الاستغاثة serve, beyond marking المستغاث's إعراب لفظا؟`, options: [`It clarifies that genuine help is being sought, not a trivial summons`, `It changes المستغاث into المستغاث له`, `It replaces حرف الاستغاثة entirely`, `It marks المستغاث as نكرة`], correct: 0 },
        {
          ...
          distractors: [`منادى مبني`, `مضاف إليه`, `متعجب منه بمنزلة المستغاث`, `حرف نداء`],
        },
        {
          ...
          labels: [`حرف الاستغاثة`, `مستغاث مجرور بلام مفتوحة`, `مستغاث له مجرور بلام مكسورة`],
          distractors: [`منادى منصوب`, `فاعل`, `متعجب منه بمنزلة المستغاث له`, `حرف نداء`],
        },
        {
          ...
          distractors: [`مستغاث له`, `حرف جر`, `منادى مبني على الضم في محل نصب`, `متعجب منه بمنزلة المستغاث`],
        },
        {
          ...
          distractors: [`منادى مبني`, `نعت`, `مستغاث معطوف بلام مكسورة (بلا تكرار يا)`],
        },
        {
          ...
          distractors: [`مستغاث بلام مفتوحة أخرى`, `حرف جر زائد`, `حرف عطف وحرف استغاثة مكرر`, `منادى مبني`],
        },
        {
          ...
          distractors: [`متعجب منه بمنزلة المستغاث له`, `مضاف إليه`, `مستغاث مجرور بلام مفتوحة`, `منادى مبني`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      bank: [
        ...
        { title: `ما الذي يبقى ثابتا عبر أوجه النداء الأربعة`, kind: 'mcq', prompt: `Despite their different purposes, what stays constant across all four faces of النداء؟`, options: [`The underlying skeleton: حرف نداء + منادى standing in for a dropped أدعو`, `The specific حرف used`, `Whether المنادى is منصوب لفظا or مبني`, `The presence of لام الاستغاثة`], correct: 0 },
        {
          ...
          distractors: [`حرف استغاثة`, `مستغاث له`, `مستغاث`, `منادى مبني على الضم في محل نصب`],
        },
        {
          ...
          distractors: [`منادى منصوب لفظا`, `مضاف إليه`, `حرف استغاثة`, `مستغاث`],
        },
        {
          ...
          distractors: [`منادى مبني`, `مستغاث`, `حرف استغاثة`, `مستغاث له`],
        },
        {
          ...
          distractors: [`مستغاث`, `حرف جر`, `حرف استغاثة`, `منادى مبني على الضم في محل نصب`],
        },
      ],
    },
  ],
