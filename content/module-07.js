...
export default {
  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`كان يفعل doesn't always show repetition — it can point at what was a person's way, not a repeated act`, `كان يفعل is only ever used for events that occur many times — the very sense of على وجه العادة`, `The حديث is describing a different فعل, not كان — يُصَلِّي alone carries the reported action`, `كان يفعل here means الاستقبال, a future event — the same ماضي-for-certainty sense carried by جزاك الله`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Certainty — الاستقبال expressed with a ماضي form to highlight that it is sure to happen`, `الماضي المنقطع على وجه الثبوت — a settled quality that has since ended, as with كَانُوا عَلَيْهِ شُهَدَاءَ`, `معنى الانبغاء — that something is fitting or permissible, the sense كان carries in place of يَنْبَغِي`, `الماضي المتجدد على وجه العادة — a recurring habit, the sense carried by ﴿كَانَا يَأْكُلَانِ الطَّعَامَ﴾`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `Which of the following correctly defines الأفعال الناقصة?`, options: [`Verbs entering on a مبتدأ and خبر, raising the first as اسمها and putting the second in نصب as خبرها`, `Verbs that always require a فاعل and never a خبر — confusing them with الفعل التام, which is satisfied by its فاعل alone`, `Verbs restricted to الماضي alone — though كان itself carries six distinct shades of meaning within that default`, `Verbs that only govern a single مفعول به, the way an ordinary transitive فعل does`], correct: 0 },
        { q: `الفعل الناقص is called ناقص for a specific reason. What is it?`, options: [`It cannot deliver its meaning without its خبر, unlike a فعل تام which is satisfied with its فاعل`, `It has no مصدر at all, since it enters directly on an already-built مبتدأ وخبر rather than naming an event of its own`, `It cannot be conjugated in المضارع, being one of a handful of أفعال ناقصة التصرف among أخوات كان`, `It is restricted to poetry, its سماعي status resting on سماع rather than a fixed قياسي pattern`], correct: 0 },
        ...
        { q: `A حديث uses كان يُصَلِّي about the Prophet ﷺ carrying Umāmah, describing something that happened, without implying it happened over and over. What does the Careful box on كان يفعل say this pattern can express?`, options: [`What was a person's way or nature, not necessarily a repeated act`, `Only events repeated at least twice — the sense carried by وجه العادة, as with ﴿كَانَا يَأْكُلَانِ الطَّعَامَ﴾`, `Exclusively future events — the الاستقبال sense كان carries in ﴿كَانَتْ لَهُمْ جَنَّاتُ الفِرْدَوْسِ نُزُلًا﴾`, `A settled quality that has since ended — the وجه الثبوت sense, as with كَانُوا فُقَرَاءَ`], correct: 0 },
      ...
      bank: [
        { title: `السماعي: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines a سماعي verb?`, options: [`One with no fixed rule producing more of its kind — known only through سماع`, `One that follows a قياسي pattern any grammarian can generalize from`, `One that never takes a خبر, unlike الأفعال الناقصة which specifically require one`, `One restricted to المضارع, though كان itself in fact carries a ماضي sense by default`], correct: 0 },
        ...
        { title: `الأفعال الناقصة: اسمها وخبرها`, kind: 'mcq', prompt: `الأفعال الناقصة enter on an already-built جملة اسمية. What happens to its مبتدأ and خبر?`, options: [`The مبتدأ stays مرفوع and is now called اسمها; the خبر becomes منصوب and is now called خبرها`, `Both the مبتدأ and الخبر become منصوب, each now called خبرها of the فعل الناقص`, `The مبتدأ becomes منصوب and the خبر stays مرفوع, the reverse of الفعل الناقص's actual rule`, `Neither changes its إعراب, since الفعل الناقص is treated as only adding meaning, not altering case`], correct: 0 },
        { title: `الفعل الناقص مقابل الفعل التام`, kind: 'mcq', prompt: `What distinguishes a فعل تام from a فعل ناقص?`, options: [`الفعل التام delivers its meaning with just its فاعل; الفعل الناقص needs its خبر too`, `الفعل التام never takes a فاعل — it works only when a مبتدأ وخبر are already in place`, `الفعل الناقص always appears in الأمر, confusing it with ناقصة التصرف verbs like ما دام وليس, which are restricted to just one tense`, `الفعل التام cannot appear with a مبتدأ, since its معنى is already complete once it has a فاعل`], correct: 0 },
        ...
        { title: `جنات الفردوس: الاستقبال`, kind: 'mcq', prompt: `﴿كَانَتْ لَهُمْ جَنَّاتُ الفِرْدَوْسِ نُزُلًا﴾ speaks of something that has not happened yet, phrased with a ماضي verb. Why?`, options: [`الاستقبال — the ماضي form marks the future event as certain`, `الماضي المنقطع على وجه الحدوث — the event already finished, exactly as with كَانَ قَدْ صَدَقَ`, `معنى القدرة — the verse is about ability, not time, as with وَمَا كَانَ لِنَفْسٍ أَنْ تَمُوتَ`, `الماضي المتجدد على وجه الاستمرار — a stretched-out event, as with كُنْتُ أَذْهَبُ يَوْمًا`], correct: 0 },
        { title: `جزاك الله: الاستقبال في الدعاء`, kind: 'mcq', prompt: `جَزَاكَ اللهُ is ماضي in form but understood as "Allah will most certainly reward you." Why does دعاء lean on the ماضي this way?`, options: [`A ماضي form marks certainty, and جملة اسمية دعاء has no verb of its own to carry that certainty without كان`, `Because دعاء can never use المضارع — the same restriction الأفعال ناقصة التصرف carry`, `Because الماضي is grammatically required in every دعاء, the way جَزَاكَ اللهُ itself is offered as proof`, `Because جزاك is not really a فعل — it is treated as a اسم فعل borrowed for دعاء`], correct: 0 },
        ...
        { title: `الآية الثانية للانبغاء`, kind: 'mcq', prompt: `﴿وَمَا يَنْبَغِي لِلرَّحْمَنِ أَنْ يَتَّخِذَ وَلَدًا﴾ states ينبغي outright, rather than leaving كان to carry the sense alone. Why does this verse matter for reading معنى الانبغاء into كان elsewhere?`, options: [`It establishes that كان can substitute for ينبغي, since the same sense appears with ينبغي made explicit`, `It proves كان never means انبغاء anywhere in the قرآن, ruling out معنى الانبغاء altogether`, `It shows ينبغي and كان are never interchangeable, contradicting the earlier verse's own reading`, `It is unrelated to الانبغاء — the verse instead concerns الاستقبال, a certain future event`], correct: 0 },
        { title: `القدرة والأسباب`, kind: 'mcq', prompt: `﴿وَمَا كَانَ لِنَفْسٍ أَنْ تَمُوتَ إِلَّا بِإِذْنِ اللهِ﴾ is explained with the example of a person putting a gun to themself. What point does that example make about معنى القدرة?`, options: [`Even an ordinary سبب of death only takes effect because Allah permits it, so death occurs only by إذن الله`, `Ordinary أسباب are irrelevant to when death occurs, since القدرة here has nothing to do with سبب at all`, `القدرة here means physical strength, not divine permission, the sense the gun example is meant to illustrate`, `The verse is only about الماضي المنقطع, not about معنى القدرة at all`], correct: 0 },
        { title: `العلاقة بين الانبغاء والقدرة`, kind: 'mcq', prompt: `How does the lesson describe the relationship between معنى الانبغاء and معنى القدرة in كان?`, options: [`القدرة sits close to الانبغاء — a proper study of الانبغاء turns up القدرة as one of its senses`, `They are entirely unrelated meanings of كان — القدرة belongs with الاستقبال instead`, `القدرة is a subtype of الاستقبال, not of الانبغاء, since both concern events yet to happen`, `Only one of the two is a real meaning of كان; the other was rejected by grammarians`], correct: 0 },
        ...
        { title: `تحديد المعنى من السياق`, kind: 'mcq', prompt: `كان's several shades of meaning — منقطع, متجدد, حال, استقبال — are not marked by a different verb form. How is the intended shade actually identified?`, options: [`From context — what the surrounding sentence and situation indicate`, `From the verb's موزون pattern alone`, `From whether كان is مرفوع or منصوب`, `Every shade is marked by a distinct spelling of كان`], correct: 0 },
        {
          ...
          distractors: [`فعل تام + واو الجماعة فاعله`, `فعل ناقص + ياء المخاطبة اسمه`, `مبتدأ`, `اسم كان مرفوع`, `خبر كان مرفوع`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار`, `فعل تام`, `فاعل مرفوع`, `مبتدأ`, `خبر مرفوع`, `نعت منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`يَكُنِ الإِيمَانُ — the فعل ناقص يكن and its اسم الإيمان, together, as جواب الأمر`, `Only آمِنُوا itself — the أمر is treated as elided, leaving خَيْرًا as its own جملة`, `A حرف جر before خَيْرًا, elided on the same kind of license this lesson already grants to dropping كان itself`, `Nothing — the Kufi reading treats خَيْرًا as an ordinary مفعول به`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مفعول مطلق لآمنوا, with the مفعول مطلق itself elided and خَيْرًا standing as its صفة`, `اسم كان مؤخر, on the same حذف الكوفيين already propose and البصريون reject`, `مضاف إليه لآمنوا, as though آمِنُوا itself were a مصدر governing خَيْرًا`, `بدل من آمنوا, restating the same أمر in different words`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `The Basrians reject the Kufi حذف for ﴿فَآمِنُوا خَيْرًا لَكُمْ﴾. Which two roles do they instead propose for خَيْرًا؟`, options: [`مفعول مطلق (with its مطلق itself elided), or مفعول به لفعل مضمر`, `فاعل, or نائب فاعل (the role either would take if خَيْرًا were a verb's subject rather than governed by آمِنُوا)`, `مبتدأ, or خبر (though neither carries the رفع that role would require, and خَيْرًا is plainly منصوب)`, `حال, or تمييز (though there is no preceding فاعل needing a حال, nor a vague count needing a تمييز)`], correct: 0 },
      ],
      bank: [
        ...
        { title: `لم نك من المصلين`, kind: 'mcq', prompt: `﴿لَمْ نَكُ مِنَ المُصَلِّينَ﴾ shows the نون dropped from لَمْ نَكُنْ. Why is the حذف valid here?`, options: [`The verb is مجزوم and nothing that blocks the حذف follows it`, `Because the verse is in الماضي, and النون always drops in الماضي`, `Because المصلين is مجرور, and a مجرور خبر always triggers حذف النون`, `Because the verb has no اسم at all, so there is nothing for النون to attach to`], correct: 0 },
        ...
        { title: `القراءة الثانية عند البصريين`, kind: 'mcq', prompt: `On the second Basri reading, خَيْرًا is مفعول به لفعل مضمر. Which reconstruction fits that reading?`, options: [`أَيِ اقْصِدُوا خَيْرًا، أَوِ ائْتُوا خَيْرًا`, `أَيْ آمِنُوا إِيمَانًا خَيْرًا`, `أَيْ يَكُنِ الإِيمَانُ خَيْرًا لَكُمْ`, `أَيْ خَيْرٌ لَكُمُ الإِيمَانُ`], correct: 0 },
        {
          ...
          distractors: [`فعل ناقص واسمه، كلاهما محذوف — هو جواب الأمر`, `حرف شرط (كان محذوفة فقط بعدها)`, `خبر كان مرفوع`, `مبتدأ`, `فاعل`, `قسم`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      quiz: [
        { q: `أصبح، أضحى، أمسى، ظل, and بات all work the way كان works. What is the only thing that differs between them?`, options: [`The part of the day at which the اسم is described by the خبر`, `Whether they take an اسم at all — some of the five work as فعل تام only`, `Whether their خبر is مرفوع or منصوب — each fixes a different إعراب`, `Whether they can be مجزوم — only some of the five ever appear مجزومة`], correct: 0 },
        ...
        { q: `Unlike أصبح, ظل, and بات, what is distinctive about أضحى among the five time-of-day sisters?`, options: [`It has no قرآن or ready حديث example in the ناقص sense — the lesson's own example is constructed`, `It cannot take a خبر منصوب — its خبر is always شبه جملة instead`, `It is the only one restricted to poetry, unlike ظَلْتَ which occurs in the قرآن`, `It always functions as فعل تام, never entering on a مبتدأ وخبر`], correct: 0 },
        { q: `﴿ظَلْتَ﴾, from ظَلَّ عَلَيْهِ عَاكِفًا, is a shortened form of a longer original. What happened to produce it؟`, options: [`It is originally ظَلِلْتَ, with one of its two لام letters dropped`, `It is originally تَظَلَّلْتَ, with the reflexive تَ prefix later dropped`, `It is originally ظَالَلْتَ, with a medial ألف later dropped`, `No letters were dropped — ظَلْتَ is the base form`], correct: 0 },
      ...
      bank: [
        ...
        { title: `أضحى: غياب المثال القرآني`, kind: 'mcq', prompt: `Why does the lesson describe أَضْحَى الرَّجُلُ عَامِلًا as a "constructed" example rather than a quotation؟`, options: [`أضحى in this ناقص sense has no قرآن occurrence and no readily found حديث example`, `أضحى is not actually one of أخوات كان, despite being listed among the five time-of-day sisters`, `The sentence uses a rare word, unlike الرجل and عاملا which are both common terms`, `أضحى cannot take a اسم ظاهر, requiring a ضمير مستتر like the other four sisters`], correct: 0 },
        ...
        { title: `ظل: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines ظل as a فعل ناقص؟`, options: [`It describes the اسم by the خبر during الظل, standing here for النهار`, `It describes the اسم by the خبر during المساء, the sense properly carried by أمسى`, `It describes the اسم by the خبر during المبيت, the sense properly carried by بات`, `It negates the خبر outright, confusing ظل's stretch across النهار with ليس's flat denial of الحال`], correct: 0 },
        { title: `ظلت عليه عاكفا: المخاطب`, kind: 'mcq', prompt: `﴿وَانْظُرْ إِلَىٰ إِلَٰهِكَ الَّذِي ظَلْتَ عَلَيْهِ عَاكِفًا﴾ — موسى عليه السلام is speaking to whom about what؟`, options: [`The man who set the calf up as a god, about his devotion to it`, `فرعون, about his claim to divinity, the same claim answered in ﴿مَا كَانَ لَنَا أَنْ نُشْرِكَ﴾`, `هارون عليه السلام, about guarding the قوم while موسى was away receiving الوحي`, `بنو إسرائيل, about their journey out of مصر toward الأرض المقدسة`], correct: 0 },
        ...
        { title: `الذين يبيتون لربهم: عباد الرحمن`, kind: 'mcq', prompt: `﴿وَالَّذِينَ يَبِيتُونَ لِرَبِّهِمْ سُجَّدًا وَقِيَامًا﴾ describes عباد الرحمن doing what during the night؟`, options: [`Making سجدة and standing in قيام before Allah`, `Sleeping undisturbed, the very sense بات's root would suggest without its سجدًا وقيامًا خبر`, `Traveling toward مكة, in preparation for the following day's رحلة`, `Reciting only in silence, without سجود or قيام, unlike what the آية actually names`], correct: 0 },
        ...
        { title: `غدا: الجذر والمعنى`, kind: 'mcq', prompt: `غَدَا يَغْدُو غُدُوًّا shares its root with the phrase غُدُوًّا وَعَشِيًّا. What does that phrase mean؟`, options: [`Morning and evening`, `Day and night`, `Sunrise and sunset only`, `Every hour of the day`], correct: 0 },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار + اسمه ضمير مستتر`, `فعل تام`, `خبر ثانٍ`, `فاعل مرفوع`, `مبتدأ`, `جار ومجرور متعلق بخائف`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار`, `فعل تام`, `اسم أصبح`, `خبر أصبح`, `فاعل مرفوع`, `مبتدأ`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار`, `فعل تام`, `اسم ظلّ`, `خبر بات`, `فاعل مرفوع`, `حال منصوب`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار`, `اسم بات`, `جار ومجرور`, `خبر بات`, `فاعل مرفوع`, `مفعول به منصوب`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار`, `اسم ظلّ`, `خبر ظلّ`, `فاعل مرفوع`, `حال منصوب`, `مضاف إليه مجرور`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It stays present in some measure — it doesn't vanish just because أصبح now carries صار's sense`, `It disappears entirely once أصبح means صار, leaving only the borrowed sense behind`, `It only survives when أصبح is فعل تام, never when it works ناقصًا بمعنى صار`, `It transfers fully onto صار itself, leaving أصبح an empty carrier of صار's meaning`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`The image of a fresh dawn — أصبح is built on صبح, freshness and new light after the darkness of enmity`, `Nothing — the two verbs are fully interchangeable in every respect`, `A shift in tense from الماضي to المستقبل, since صرتم reports a completed change and أصبحتم does not`, `A change from خبر منصوب to خبر مرفوع, altering إِخْوَانًا's own إعراب`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `أصبح carries the sense of صار in ﴿فَأَصْبَحْتُمْ بِنِعْمَتِهِ إِخْوَانًا﴾. What does the rule on retained original meaning say should still be true of أصبح's own صبح-sense here؟`, options: [`It stays present in some measure, which is part of why أصبح was chosen over صار`, `It vanishes completely once أصبح means صار, leaving the two verbs fully synonymous`, `It transfers onto إِخْوَانًا instead of staying in أصبح, coloring the خبر rather than the فعل`, `It only applies to كان, not to أصبح, since only كان's ماضي-sense was said to persist`], correct: 0 },
        { q: `On the قراءة مجازية of ﴿وَكَانَ مِنَ الْكَافِرِينَ﴾ (كان بمعنى صار), what does the rule كَانَ بِمَعْنَى صَارَ يَدُلُّ عَلَى أَنَّ التَّحَوُّلَ مِنْ طَبِيعَتِهِ add that صار alone would not؟`, options: [`That the change came from إبليس's own nature, already destined, rather than being an arbitrary shift`, `That إبليس never actually disbelieved — contradicting the verse's own plain wording either way it is read`, `That the verse must be read حقيقةً, not مجازًا, ruling the second reading out entirely`, `That كان here is فعل تام, meaning simply that إبليس existed among الكافرين`], correct: 0 },
        { q: `Two reasons are given for using ظل rather than أصبح or صار in ﴿ظَلَّ وَجْهُهُ مُسْوَدًّا﴾. What are they؟`, options: [`ظل's root image suits darkening rather than brightness, and it carries امتداد (duration) that صار lacks`, `ظل is the only one of the three that can govern a خبر at all`, `ظل is مبني while أصبح and صار are معربة, so only ظل can take وَجْهُهُ as its اسم`, `ظل only appears with a مؤنث اسم, and وَجْهُهُ happens to be مؤنث`], correct: 0 },
        { q: `فَارْتَدَّ بَصِيرًا reports يعقوب عليه السلام regaining his sight. What does ارتدّ add here that صار alone would not؟`, options: [`That he became seeing again — back to a state he had already held before`, `That his sight became permanently damaged, unlike the plain change صار alone would report`, `That the change was gradual rather than sudden, unlike a plain change with صار`, `That the change was against his own طبيعة, the opposite of what كان بمعنى صار would signal`], correct: 0 },
      ],
      bank: [
        { title: `صار: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines صار as a فعل ناقص؟`, options: [`It reports تحول الذات or تحول الصفات — the اسم coming to be the خبر`, `It negates the خبر entirely, confusing صار's change-of-state sense with ليس's flat denial of الحال`, `It only ever reports تحول الذات, never تحول الصفات, as though صَارَ المُذْنِبُ مُتَّقِيًا did not exist`, `It requires a فاعل rather than an اسم, the way it behaves once it becomes فعل تام`], correct: 0 },
        ...
        { title: `كان بمعنى صار: القراءة الثانية`, kind: 'mcq', prompt: `On the مجازي reading of ﴿وَكَانَ مِنَ الْكَافِرِينَ﴾ (كان بمعنى صار), what does it say about إبليس؟`, options: [`He became one of الكافرين, after having been in سجود وعبادة`, `He was always among الكافرين from the start, the قراءة الحقيقية's own reading`, `He never actually disbelieved, contrary to how both readings understand the verse`, `He is described as كافر only metaphorically, not literally, contradicting the verse's own force`], correct: 0 },
        { title: `لماذا استُعملت كان لا صار`, kind: 'mcq', prompt: `If كان بمعنى صار in ﴿وَكَانَ مِنَ الْكَافِرِينَ﴾, why not simply use صار directly?`, options: [`كان's own ماضي sense signals the outcome was already destined for إبليس, from his own nature`, `صار cannot follow إلّا in an استثناء, unlike كان which readily follows it`, `كان and صار are not actually interchangeable in any context, contrary to what القراءة المجازية assumes`, `The verse requires a فعل تام, and صار is always ناقص, a claim the verse itself doesn't actually test`], correct: 0 },
        ...
        { title: `لماذا أصبح لا صار (الإخوان)`, kind: 'mcq', prompt: `فَصِرْتُمْ بِنِعْمَتِهِ إِخْوَانًا was available as an alternative to فَأَصْبَحْتُمْ بِنِعْمَتِهِ إِخْوَانًا. What image does أصبح add that صرتم would not carry؟`, options: [`A fresh dawn, new light breaking after the darkness of enmity — the sense built into صبح`, `A stronger emphasis on permanence than صار carries, the way ما زال would`, `A shift from خبر منصوب to خبر مرفوع, altering إِخْوَانًا's own إعراب`, `Nothing — the two are fully interchangeable here`], correct: 0 },
        { title: `ظل وجهه مسودا: السياق`, kind: 'mcq', prompt: `﴿ظَلَّ وَجْهُهُ مُسْوَدًّا وَهُوَ كَظِيمٌ﴾ describes a reaction to being told what news about himself؟`, options: [`That he himself has been given a daughter — the same claim he makes about الرحمن having daughters`, `That he has lost his wealth, news that would darken any face just as easily`, `That his sins have been forgiven, news that would brighten rather than darken his face`, `That his family has emigrated, unrelated to the بنات الله claim the verse actually turns on him`], correct: 0 },
        { title: `لماذا ظل لا أصبح (الوجه المسود)`, kind: 'mcq', prompt: `Why would أصبح have been a poor choice in ﴿ظَلَّ وَجْهُهُ مُسْوَدًّا﴾, according to the lesson؟`, options: [`أصبح's root carries morning brightness, which pulls against a verse describing a face going dark`, `أصبح cannot take a خبر منصوب, unlike ظل which readily governs one here`, `أصبح is restricted to human subjects only, and وَجْهُهُ names only a part of a person`, `أصبح never occurs with a صفة مشبهة as its خبر, unlike مُسْوَدًّا which is exactly that`], correct: 0 },
        { title: `لماذا ظل لا صار (الامتداد)`, kind: 'mcq', prompt: `Beyond suiting the image of darkening, what second reason favors ظل over صار in ﴿ظَلَّ وَجْهُهُ مُسْوَدًّا﴾؟`, options: [`ظل carries امتداد — the state holds through the day — while صار reports only the change, without duration`, `ظل is grammatically required after بُشِّرَ, the way جواب الشرط is required after إن`, `صار cannot take a مرفوع اسم, unlike ظل which governs وَجْهُهُ that way here`, `ظل is more common in poetry than صار, and this آية leans on poetic usage`], correct: 0 },
        ...
        { title: `عاد في ملتنا: القراءتان`, kind: 'mcq', prompt: `﴿أَوْ لَتَعُودُنَّ فِي مِلَّتِنَا﴾ is addressed to شعيب عليه السلام. Why does the lesson prefer keeping عاد on its own meaning of "returning," read as the قوم's own زعم, over a صار reading؟`, options: [`No نبي was ever upon كفر, so a true "return" to it is impossible — the wording instead reflects the قوم's own mistaken assumption`, `عاد can never mean صار under any circumstance in Arabic, ruling that reading out on lexical grounds alone`, `شعيب's ملة before نبوة was identical to his قوم's شرك, making عاد's literal sense accurate`, `The قرآن never permits two readings of the same verse, so only one interpretation can stand`], correct: 0 },
        { title: `استحال مودة: تدارك الهفوات`, kind: 'mcq', prompt: `إِنَّ العَدَاوَةَ تَسْتَحِيلُ مَوَدَّةً بِتَدَارُكِ الهَفَوَاتِ بِالحَسَنَاتِ describes enmity turning into affection. What is said to bring that change about؟`, options: [`Repaying someone's bad treatment with acts of kindness`, `Simply waiting for enough time to pass`, `Formally ending the relationship first`, `A third party intervening to mediate`], correct: 0 },
        {
          ...
          distractors: [`فعل تام`, `اسم صار منصوب`, `خبر صار مرفوع`, `مبتدأ`, `فاعل مرفوع`, `نعت منصوب`],
        },
        {
          ...
          labels: [`فعل ناقص`, `اسم صار مرفوع`, `خبر صار منصوب`],
          distractors: [`فعل تام`, `خبر صار مرفوع`, `اسم صار منصوب`, `حال منصوب`, `بدل منصوب`, `مبتدأ`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى صار`, `فعل تام`, `اسم كان مرفوع`, `شبه جملة في محل نصب خبر أصبح`, `خبر كان منصوب`, `مبتدأ`],
        },
        {
          ...
          distractors: [`فعل ناقص`, `فعل ناقص بمعنى الانبغاء`, `اسم ظل`, `خبر ظل منصوب`, `فاعل مرفوع`, `فعل تام`],
        },
        {
          ...
          distractors: [`فعل ناقص`, `فعل ناقص بمعنى صار + اسمه ضمير مستتر`, `اسم بات مرفوع`, `خبر بات منصوب`, `نعت منصوب`, `مضاف إليه مجرور`],
        },
        {
          ...
          distractors: [`فعل ناقص بمعنى الانبغاء + اسمه ضمير مستتر`, `فعل ناقص + اسمه ضمير مستتر`, `خبر ظل منصوب`, `خبر أصبح منصوب`, `مفعول به منصوب`, `حال منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L5
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`رَجَاء isn't something anyone would want to break free of, unlike مَا انْفَكَّ الرَّجُلُ مُذْنِبًا, which fits the root sense better`, `المُذْنِبُ is not a valid اسم انفك at all — as though انفك could only govern a hidden pronoun, never a named noun`, `رَاجِيًا cannot grammatically serve as a خبر — as though a فعل ناقص's خبر had to name something escapable`, `انفكّ never occurs with a human اسم, unlike المُذْنِبُ which is exactly that`], correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`An expectation that the state ought to have changed or ended by now, even though it hasn't`, `That the state will certainly end within the next moment, the sense الاستقبال carries for كان`, `That the state has never been expected to change at all, the opposite of زوال's own root sense`, `That the speaker doubts the state is real, rather than simply expecting it to end`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It drops all three layered senses — rest, being put out, and forgetting — that فتئ carries together`, `English has no word at all for "remember," so the translation substitutes a vaguer verb`, `The Arabic verse doesn't actually mean "continue to remember," making any such translation wrong`, `فتئ in this verse means something unrelated to continuity, closer to الاستقبال than استمرار`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `زَالَ يَزَالُ and زَالَ يَزُولُ share the same ماضي but differ in the مضارع. What is the key difference between them؟`, options: [`زَالَ يَزَالُ is ناقص, needing an اسم and خبر; زَالَ يَزُولُ is تام, needing only a فاعل`, `زَالَ يَزَالُ is تام, needing only a فاعل; زَالَ يَزُولُ is ناقص, needing an اسم and خبر`, `They are simply two spellings of the exact same verb with no functional difference`, `زَالَ يَزُولُ can never appear in المضارع at all, unlike تَزُولَا in ﴿أَنْ تَزُولَا﴾`], correct: 0 },
      ],
      bank: [
        { title: `أفعال الاستمرار: الأصل المشترك`, kind: 'mcq', prompt: `What do ما برح، ما انفك، ما زال, and ما فتئ have in common, beyond all being أفعال ناقصة للاستمرار؟`, options: [`Each was originally an ordinary complete فعل, and that older meaning still works inside the ناقص use`, `Each is restricted to appearing only in الأمر, unlike ما زال which appears here in الماضي`, `None of them can ever take a خبر منصوب, unlike رَاجِيًا and عَاكِفِينَ, both خبر of verbs from this very group`, `Each requires a preceding اسم إشارة, rather than simply a نهي, a نفي, or a دعاء`], correct: 0 },
        ...
        { title: `لماذا لا يقال ما برح حزينا`, kind: 'mcq', prompt: `Why does the lesson say مَا بَرِحَ حَزِينًا is not the work ما برح is naturally built for؟`, options: [`حزين names a state, not a physical place, and برح's root sense is about leaving a place`, `حزين cannot ever serve as a خبر — as though every خبر of a فعل ناقص had to name a physical place`, `The قرآن explicitly forbids this combination, the way it forbids يَلِيسُ`, `برح only ever takes a اسم ظاهر, never an implied one, unlike نَبْرَحَ which takes a ضمير مستتر`], correct: 0 },
        ...
        { title: `أن تزولا: زال التام`, kind: 'mcq', prompt: `﴿إِنَّ اللهَ يُمْسِكُ السَّمَاوَاتِ وَالأَرْضَ أَنْ تَزُولَا﴾ uses تَزُولَا with no خبر following. What role does الألف play here؟`, options: [`فاعل لفعل تام`, `اسم فعل ناقص مرفوع`, `مفعول به`, `توكيد للفاعل المستتر`], correct: 0 },
        {
          ...
          distractors: [`نفي`, `فعل ناقص مرفوع + اسمها ضمير مستتر`, `اسمها مرفوع`, `خبرها منصوب`, `جار ومجرور`, `فعل أمر`],
        },
        {
          ...
          distractors: [`حرف نفي ونصب`, `فعل ناقص منصوب`, `اسمها منصوب`, `خبرها مرفوع`, `فاعل`, `مبتدأ`],
        },
        {
          ...
          distractors: [`حرف نفي ونصب`, `اسمها مرفوع`, `خبرها منصوب`, `جار ومجرور`, `فعل ناقص منصوب`, `شبه جملة في محل نصب خبر كان`],
        },
        {
          ...
          distractors: [`فعل ناقص`, `اسمها`, `خبرها منصوب`, `جملة في محل نصب حال`, `فاعل`, `مفعول به`],
        },
        {
          ...
          distractors: [`فعل ناقص`, `اسمها`, `جملة في محل نصب خبر`, `خبرها مرفوع`, `حال منصوب`, `تمييز منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L6
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`The stretch of time during which the اسم stays described by the خبر — here, as long as حياة lasts`, `A fixed number of days named elsewhere in the verse, the way a ظرف زمان would set one`, `The lifetime of the person being addressed, not the speaker, reversing the actual roles`, `ما دام here sets no limit at all — it is purely emphatic, like تَاللهِ before a قسم`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `ما دام sets a time limit on the statement before it. What exactly defines that limit?`, options: [`The stretch of time during which the اسم stays described by the خبر`, `A fixed calendar period stated separately, the way a ظرف زمان would set one`, `The lifetime of the addressee only, never the speaker, reversing the actual roles in the verse`, `The limit is left entirely open, with no defined end, since ما دام is purely emphatic`], correct: 0 },
        ...
        { q: `Which of the following correctly describes ما دام and ليس's own تصرف?`, options: [`Neither has a مضارع in this sense; only the ماضي occurs, with its person ending changing`, `Both fully conjugate through ماضي, مضارع, and أمر, like a fully متصرف فعل`, `ما دام has an أمر form, but ليس does not, unlike the four أفعال الاستمرار which lack it too`, `ليس has a مضارع, but ما دام does not, the reverse of what غير متصرفين actually means`], correct: 0 },
        ...
        { q: `In ﴿أَهَؤُلَاءِ إِيَّاكُمْ كَانُوا يَعْبُدُونَ﴾, what has happened to إِيَّاكُمْ relative to كَانُوا؟`, options: [`إِيَّاكُمْ, the معمول of يَعْبُدُونَ, has been fronted ahead of الفعل الناقص كان`, `إِيَّاكُمْ has become اسم كان itself, displacing the واو of الجماعة from that role`, `إِيَّاكُمْ has become خبر كان مقدم, with يَعْبُدُونَ left as اسمها مؤخر`, `No fronting has occurred — إِيَّاكُمْ is in its normal position`], correct: 0 },
      ],
      bank: [
        { title: `ما دام: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines ما دام as a فعل ناقص؟`, options: [`It times the preceding statement by the stretch during which the اسم is described by the خبر`, `It negates الخبر entirely, confusing ما دام's time-limit sense with ليس's flat denial of الحال`, `It marks a future event stated in الماضي, the sense properly carried by الاستقبال`, `It reports a change from one state to another, the sense properly carried by صار`], correct: 0 },
        { title: `ما دمت حيا: تطبيق`, kind: 'mcq', prompt: `﴿وَأَوْصَانِي بِالصَّلَاةِ وَالزَّكَاةِ مَا دُمْتُ حَيًّا﴾ — for how long does the ruling before ما دام hold, according to the lesson؟`, options: [`For as long as the اسم (the تاء) stays متصف with الخبر (حياة)`, `For exactly one full lifetime, regardless of health, treating حَيًّا as fixed rather than as متصف`, `Only until the first صلاة is performed, reading the آية as timing الصلاة alone`, `The ruling has no time limit at all, treating ما دام as purely emphatic`], correct: 0 },
        ...
        { title: `مسؤولية النبي ﷺ في الآية`, kind: 'mcq', prompt: `﴿لَيْسَ عَلَيْكَ هُدَاهُمْ﴾ places a boundary on the Prophet's ﷺ duty. What is that duty, per the lesson؟`, options: [`To convey the message and work at guiding people — not to guarantee they actually accept guidance`, `To guarantee every listener accepts guidance, the very thing ﴿لَيْسَ عَلَيْكَ هُدَاهُمْ﴾ denies`, `To avoid speaking to disbelievers altogether, contrary to what دعوة to Islam requires`, `To judge who deserves guidance and who does not, a matter left to Allah alone`], correct: 0 },
        { title: `عدم تصرف ما دام وليس`, kind: 'mcq', prompt: `مَا دَامَ وَلَيْسَ غَيْرُ مُتَصَرِّفَيْنِ. What does this rule say about their مضارع forms?`, options: [`Neither has one — يَلِيسُ and مَا يَدُومُ (in this sense) are not used`, `Both have regular مضارع forms, just avoided in this lesson's own examples`, `ليس has a مضارع (يَلِيسُ), but ما دام lacks one`, `ما دام has a مضارع (يَدُومُ), but ليس lacks one`], correct: 0 },
        { title: `الفعل التام: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines الفعل التام؟`, options: [`It is satisfied with its فاعل and does not need a خبر, as in كَانَتْ حَرْبٌ`, `It always requires both an اسم and a خبر, the mark of الفعل الناقص instead`, `It can never take a فاعل at all — confusing it with الفعل الناقص, which takes an اسم instead of a فاعل`, `It is restricted to appearing in الأمر, unlike كَانَتْ which is ماضي`], correct: 0 },
        ...
        { title: `آض وعاد وغدا وراح`, kind: 'mcq', prompt: `Beyond the thirteen core members of كان وأخواتها, which four verbs does the lesson note some grammarians also count among الأفعال الناقصة؟`, options: [`آضَ، عَادَ، غَدَا، وَرَاحَ`, `صَارَ، لَيْسَ، ظَلَّ، وَبَاتَ`, `كَادَ، عَسَى، أَوْشَكَ، وَحَرَى`, `نِعْمَ، بِئْسَ، حَبَّذَا، وَسَاءَ`], correct: 0 },
        {
          ...
          distractors: [`فعل تام`, `فاعل`, `اسم ليس مؤخر`, `خبر ليس مقدم`, `حرف نفي`, `مفعول به`],
        },
        {
          ...
          distractors: [`مبتدأ`, `فاعل`, `اسم ليس مقدم`, `خبر ليس مؤخر`, `فعل تام`, `اسم ما دام`],
        },
        {
          ...
          labels: [`فعل تام`, `فاعل`],
          distractors: [`فعل ناقص`, `اسم كان مرفوع`, `خبر كان منصوب`, `مبتدأ`, `خبر ليس مقدم`, `اسم ليس مؤخر`],
        },
        {
          ...
          labels: [`فعل تام`, `فاعل`],
          distractors: [`فعل ناقص`, `اسم كان مرفوع`, `خبر كان منصوب`, `مبتدأ`, `اسم ما دام`, `خبر ما دام`],
        },
        {
          ...
          distractors: [`فاعل`, `مضاف إليه`, `اسم كان مقدم`, `خبر كان مؤخر`, `فعل تام`, `اسم ليس مؤخر`],
        },
        {
          ...
          distractors: [`خبر كان مقدم`, `اسمها مؤخر`, `فعل تام + اسمه (واو الجماعة)`, `حال`, `مضاف إليه`, `مفعول به منصوب`],
        },
      ],
    },
  ],
