      ...
      concepts: [
        {
          ...
          exercise: {
            prompt: `السماعي divides into three أقسام. الأفعال الناقصة is one of them. Which of the following completes the other two?`,
            kind: 'mcq',
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `On the Kufi reading, the تقدير is فَآمِنُوا يَكُنِ الإِيمَانُ خَيْرًا لَكُمْ. آمِنُوا is أمر, and يَكُنْ is its جواب الأمر: the فعل يَكُنْ is محذوف and its اسم الإيمان is محذوف with it, leaving خَيْرًا standing as the خبر.`, list: false },
      ...
      concepts: [
        {
          ...
          lines: [
            ...
            { html: `The wording as it stands is صَارَ الخَمْرُ خَلًّا. خمر is مؤنث, so صَارَتِ الخَمْرُ خَلًّا is what would be expected — the form without the تاء looks like a slip.`, list: false },
          ],
          exercise: {
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `Two different أفعال share one ماضي and part company in the مضارع. زَالَ يَزُولُ means to come to an end, to cease to exist.`, list: false },
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `The sense is not that the heavens are described as being something — it is that they endure, with no خبر present; السَّمَاوَاتُ وَالْأَرْضُ together are the فاعل. أَمْسَى and صَارَ can occur تامة the same way: تُمْسُونَ above simply means to enter the evening, and صَارُوا إِلَى مَصِيرِهِمْ means they went to, arrived at, their final destination — فعل and فاعل, nothing further in either case.`, list: false },
          ],
          exercise: {
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `هَؤُلَاءِ is the مبتدأ, and the جملة إِيَّاكُمْ كَانُوا يَعْبُدُونَ is its خبر. Inside that جملة, كان is the فعل ناقص, the واو is its اسم, and يَعْبُدُونَ is its خبر. إِيَّاكُمْ is the معمول of يَعْبُدُونَ, and it has come before كان rather than after it.`, list: false },
