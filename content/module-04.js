  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — the meaning stays with the doers themselves, so يَحْزَنُونَ is فعل لازم`, `Yes — هُمْ is its direct مفعول به, since the verb's effect passes onto the pronoun`, `Yes, because يَحْزَنُونَ ends in ون, and that ending always marks a transitive verb`, `No, because يَحْزَنُونَ has no فاعل at all, so the sentence carries no doer`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — it remains لازم in direct إعراب; it only reaches a meaning through the حرف جر`, `Yes — any verb followed by an اسم is متعدي, since the اسم must be its direct object`, `Yes, because لام and إلى always make a verb متعدي بواسطة حرف الجر whenever they appear`, `No, because استمع has no فاعل, so it cannot be classified as لازم or متعدي at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`اللازم الصرف — pure لازم verbs that do not naturally become transitive at all`, `متعدي بنفسه, since they clearly reach a مفعول به with no حرف جر needed`, `متعدي بواسطة حرف الجر, exactly like غَضِبَ`, `أفعال ناقصة, since they never take a direct مفعول به of their own`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        ...
        { title: `القياسي vs السماعي`, kind: 'mcq', prompt: `الفعل القياسي's grammatical behaviour follows a consistent rule. What distinguishes it from الفعل السماعي؟`, options: [`السماعي's behaviour is taken as heard from the Arabs case by case, with no such general rule`, `السماعي only ever appears in الأمر, never showing up in الماضي or المضارع`, `السماعي never takes a فاعل, since its case endings are memorized rather than rule-governed`, `There is no real difference between them; both terms describe the very same regular pattern`], correct: 0 },
        ...
        { title: `يحزنون: where the meaning stays`, kind: 'mcq', prompt: `In وَلا هُمْ يَحْزَنُونَ, where does the meaning of grieving remain?`, options: [`With the doers (هُمْ) themselves — it does not pass to a مفعول به`, `It passes to a مفعول به صريح, reached directly with no preposition involved`, `It passes to a مفعول به بواسطة حرف الجر, through a preposition left unstated`, `It has no فاعل to remain with, since هُمْ here is actually its dropped مفعول به`], correct: 0 },
        ...
        { title: `غضب الله عليهم: لازم أم متعدٍ؟`, kind: 'mcq', prompt: `غَضِبَ takes no مفعول به صريح in غَضِبَ اللهُ عَلَيْهِمْ, yet it reaches عَلَيْهِمْ through على. How should غضب be described here?`, options: [`لازم in direct إعراب, but transitive in meaning through the حرف جر, exactly like استمع`, `متعدي بنفسه, since it clearly reaches an object with no preposition mediating the connection`, `لازم الصرف, since it never reaches any object at all`, `ناقص, since a حرف جر like على is thought to only ever follow أفعال ناقصة`], correct: 0 },
        { title: `المغضوب عليهم: same pattern`, kind: 'mcq', prompt: `المَغْضُوبِ عَلَيْهِمْ reaches عَلَيْهِمْ the same way غَضِبَ اللهُ عَلَيْهِمْ does. What does that confirm about this pattern؟`, options: [`It is تعدٍّ بواسطة حرف الجر, not a direct مفعول به صريح`, `عَلَيْهِمْ is a مفعول به صريح here, reached directly with no preposition mediating it`, `المغضوب is فعل متعدي بنفسه, since اسم المفعول here still governs a direct object`, `على has no grammatical role in either phrase`], correct: 0 },
        ...
        { title: `جلس: لازم رغم ثلاثة مكملات`, kind: 'mcq', prompt: `جَلَسَ carries three منصوب complements in جَلَسَ الطَّالِبُ أَمَامَ المُعَلِّمِ مُتَأَدِّبًا تَبْجِيلًا لِلْعِلْمِ. Does having three complements make جَلَسَ متعدي؟`, options: [`No — none of the three (مفعول فيه، حال، مفعول له) is a مفعول به صريح, so جَلَسَ stays لازم`, `Yes — any verb with three complements is متعدي إلى ثلاثة مفاعيل, regardless of what type each complement is`, `Yes — أَمَامَ المُعَلِّمِ alone makes it متعدي, since it directly follows the verb the way a مفعول به would`, `Yes — مُتَأَدِّبًا alone makes it متعدي, since a منصوب complement right after a فعل always signals a مفعول به`], correct: 0 },
        { title: `أبواب وتصريفات: القياسي's evidence`, kind: 'mcq', prompt: `القِيَاسِيُّ مَا لَهُ قَاعِدَةٌ مُطَّرِدَةٌ — the Core Text names what kind of evidence shows a verb is قياسي؟`, options: [`Its known أبواب and conjugations follow a shared, repeatable pattern`, `It is quoted directly from a single line of poetry`, `It never appears with a حرف جر`, `It only takes a واحد مفعول`], correct: 0 },
        {
          ...
          distractors: [`خبر: فعل مضارع متعدي وفاعله المستتر`, `خبر: فعل ماضٍ لازم وفاعله المستتر`, `خبر: فعل مضارع لازم وفاعله واو الجماعة`, `خبر: فعل مضارع متعدي بواسطة حرف الجر وفاعله المستتر`, `مبتدأ مرفوع`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`فعل مضارع لازم وفاعله واو الجماعة`, `فعل أمر متعدي وفاعله واو الجماعة`, `فعل أمر لازم وفاعله ألف الاثنين`, `جار ومجرور متعلق بالمفعول به`, `مفعول به صريح`, `حال منصوب`],
        },
        {
          ...
          distractors: [`فعل أمر لازم وفاعله واو الجماعة`, `فعل مضارع متعدي وفاعله واو الجماعة`, `فعل مضارع لازم وفاعله نون النسوة`, `جار ومجرور متعلق بالمفعول به`, `مفعول به غير صريح`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`فعل لازم يتعدى بواسطة حرف الجر`, `فعل متعدي بنفسه`, `فعل متعدي بواسطة حرف الجر`, `مفعول به منصوب`, `مضاف إليه مجرور`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`اسم فاعل من فعل لازم بواسطة حرف الجر`, `اسم مفعول من فعل متعدي بنفسه`, `اسم مفعول من فعل متعدي بواسطة حرف الجر`, `جار ومجرور متعلق بالفعل`, `مفعول به منصوب`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`فعل متعدي`, `مفعول به`, `مفعول فيه منصوب`, `حال منصوب`, `مفعول له منصوب`, `مفعول مطلق منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مفعول به غير صريح — reached through a حرف جر instead of directly`, `مفعول به صريح — reached directly, with no preposition mediating the connection`, `فاعل — the doer of the action, unaffected by the الباء here`, `حال — describing the state, not the object, of the action`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `Which of the following correctly defines الفعل المتعدي؟`, options: [`The verb whose effect passes from its فاعل to a مفعول به`, `The verb whose effect does not pass from its فاعل to a مفعول به`, `A verb that always reaches its object through a حرف جر`, `A verb tied to الأمر only, never appearing in الماضي or المضارع`], correct: 0 },
      ...
      bank: [
        ...
        { title: `مفعول به صريح vs غير صريح`, kind: 'mcq', prompt: `What is the difference between مفعول به صريح and مفعول به غير صريح؟`, options: [`صريح is reached directly with no حرف جر; غير صريح is reached through a حرف جر`, `صريح is always مؤنث; غير صريح is always مذكر`, `صريح only appears with الأمر; غير صريح only appears with الماضي`, `There is no real difference between them; both terms are simply alternate names for the same مفعول به`], correct: 0 },
        ...
        { title: `فعل واحد، وصفان مختلفان`, kind: 'mcq', prompt: `The same verb can sometimes be called لازم in one respect and متعدي in another. Is that a contradiction؟`, options: [`No — the two labels describe the verb from different angles (direct إعراب vs meaning), not conflicting facts`, `Yes — a verb must be exclusively one or the other, always`, `Yes, because لازم and متعدي are simply two names for the same thing`, `No, because متعدي always overrides لازم, so the لازم label never really applies once a verb reaches an object`], correct: 0 },
        {
          ...
          distractors: [`فعل لازم`, `فعل متعدي بواسطة حرف الجر`, `مفعول به غير صريح`, `مفعول به منصوب`, `فاعل مرفوع`, `مفعول فيه`],
        },
        {
          ...
          distractors: [`فعل متعدي بواسطة حرف الجر`, `جار ومجرور في معنى المفعول به غير الصريح`, `جار ومجرور متعلق بالمفعول به`, `فاعل مرفوع`, `مفعول فيه`, `مفعول به منصوب`],
        },
        {
          ...
          distractors: [`فعل متعدي بنفسه`, `جار ومجرور متعلق بالفعل`, `جار ومجرور، في معنى المفعول به الثاني (غير صريح)`, `مفعول به صريح`, `فاعل مرفوع`, `مفعول به منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`One reaches its second object directly (مفعول به ثانٍ صريح); the other reaches it through إلى (مفعول به غير صريح)`, `One uses هدى as لازم; the other as متعدي بنفسه, since only one of the two takes any object`, `Neither structure reaches a second object at all; both verses mention only a single مفعول`, `Both reach the second object exactly the same way, with إلى playing no real role in either`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`The direct form asks to be placed on the path itself with more تضرع; the إلى form shows direction toward it, leaving the final step to the person`, `The two forms are stylistic variants with no difference in meaning at all; إلى here adds nothing beyond rhythm`, `اهدنا is فعل ماضٍ while لتهدي is فعل أمر, and that tense shift alone explains the difference in nuance`, `إلى here is a حرف عطف, not a حرف جر, joining الصراط to a dropped noun rather than marking a preposition`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — السَّمَاوَاتِ وَالأَرْضَ is one مفعول به category joined by عطف, so خَلَقَ here is متعدي إلى مفعول واحد`, `Yes — و always creates a second, independent مفعول به, regardless of what it joins`, `No — الأَرْضَ is actually الفاعل here, sharing the action alongside السَّمَاوَاتِ`, `Yes — الأَرْضَ is a separate فعل, coordinated with خَلَقَ by the و`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `In خَلَقَ السَّمَاوَاتِ وَالأَرْضَ, السَّمَاوَاتِ and الأَرْضَ are joined by عطف. Does خَلَقَ here count as متعدي إلى مفعولين؟`, options: [`No — the two nouns form one مفعول به category joined by عطف, so خَلَقَ is متعدي إلى مفعول واحد`, `Yes — عطف always produces a second independent مفعول به, no matter how the two nouns are related`, `No — خَلَقَ here is لازم, since السَّمَاوَاتِ وَالأَرْضَ together only look like a مفعول به`, `Yes — الأَرْضَ is مفعول به ثانٍ, joined onto السَّمَاوَاتِ as its own separate object`], correct: 0 },
      ],
      bank: [
        ...
        { title: `حرف الجر وأثره في المعنى`, kind: 'mcq', prompt: `Why can the presence or absence of a حرف جر matter for meaning, per this lesson's discussion of washing up to the elbows؟`, options: [`Because whether an endpoint like the elbows is included can depend on whether إلى mediates the object or the verb governs it directly`, `Because a حرف جر always changes the verb's tense, shifting it from الماضي into المضارع`, `Because a حرف جر always turns the verb into الأمر, regardless of the tense it started in`, `Because حرف جر has no effect on meaning at all, only on the case ending that follows it`], correct: 0 },
        ...
        { title: `فعل واحد، تركيبان، معنيان`, kind: 'mcq', prompt: `The lesson uses the same verb هدى in two different constructions. What does comparing them show, overall؟`, options: [`The same verb can be متعدي بنفسه in one structure and متعدي بواسطة حرف الجر in another, and the choice can shift the meaning`, `A verb can only ever appear in one fixed structure, no matter what nuance the speaker intends`, `متعدي بنفسه and متعدي بواسطة حرف الجر can never apply to the same verb, since each verb is fixed to just one type`, `Only السماعي أفعال can shift structures this way; القياسي verbs like هدى stay locked to one pattern`], correct: 0 },
        { title: `والله أعلم بالصواب: طبيعة القول`, kind: 'mcq', prompt: `The lesson closes its meaning-nuance discussion with والله أعلم بالصواب. What does that phrase signal about the claim being made؟`, options: [`It is offered as a reasoned reflection, not asserted as a settled, certain ruling`, `It is a definitive, unquestionable rule of grammar`, `It applies only to poetry, never to normal speech`, `It contradicts everything stated earlier in the lesson`], correct: 0 },
        {
          ...
          distractors: [`مفعول به ثانٍ غير صريح`, `جار ومجرور، في معنى المفعول به الثاني (غير صريح)`, `فعل متعدي إلى مفعول واحد`, `فعل متعدي إلى مفعولين`, `فاعل مرفوع`, `مفعول به أول غير صريح`],
        },
        {
          ...
          distractors: [`مفعول به ثانٍ، متصل بالفعل مباشرة`, `جار ومجرور، في معنى المفعول به الأول (غير صريح)`, `مفعول به ثانٍ صريح`, `فعل متعدي`, `حرف جر`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`مفعول به ثان`, `فعل متعدي إلى مفعولين`, `حرف جر`, `معطوف على الفاعل`, `فاعل مرفوع`, `مفعول به منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Whether the two مفعول به were originally a مبتدأ وخبر, or not`, `Whether the verb is ماضٍ or مضارع, since tense alone decides how many objects it takes`, `Whether the verb takes a حرف جر, the same test used for لازم vs متعدي`, `Whether الفاعل is مذكر or مؤنث, the way تأنيث الفعل can signal which noun is which`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`The second object — what they were guided to is never stated anywhere in the verse`, `The first object — who was guided is not stated anywhere in the verse`, `Both objects — nothing at all is mentioned about who was guided or where`, `Nothing has been omitted here — both the guided people and their destination are named in full`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Whether إلى's انتهاء الغاية necessarily includes the endpoint it marks in every case`, `Whether أيديكم is مفرد or جمع, since number agreement can settle similar questions`, `Whether المرافق is مذكر or مؤنث, since gender agreement can settle similar questions`, `Whether the verb is مبني للمجهول, since a passive verb changes what counts as included`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مبتدأ وخبر — خَالِدٌ صَادِقٌ, before ظَنَّ turned them into its two objects`, `مضاف ومضاف إليه, as if خَالِدًا simply possessed the description صَادِقًا`, `فاعل ومفعول به, as if خَالِدًا performed the action صَادِقًا names`, `They had no relationship before ظَنَّ; the two words were entirely unconnected`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because رأى can be either physical seeing or inner judgement, so the label shows which reading is meant — unlike verbs that only carry one reading`, `Because رأى is the only فعل جارحة in the whole language, so every other sensory verb needs no label at all`, `Because رأى is never فعل جارحة at all, only ever carrying the inner-judgement reading`, `Because سَمِعَ, مَشَى, أَكَلَ, and شَمَّ are not real أفعال, so no label question ever arises for them`],
            correct: 0,
          },
        },
      ],
      quiz: [
        { q: `الفعل المتعدي إلى مفعولين splits into two categories. Which question decides which category a given verb belongs to؟`, options: [`Whether its two مفعول به were originally a مبتدأ وخبر, or not`, `Whether the verb is سماعي or قياسي, the way that split governs verbs generally`, `Whether the verb takes ثلاثة مفاعيل, the same count used for أفعال القلوب`, `Whether the فاعل is ظاهر or مستتر, the same distinction used throughout الإعراب`], correct: 0 },
        ...
        { q: `In ﴿أُولَئِكَ الَّذِينَ هَدَاهُمُ اللهُ﴾, which object of هَدَى has been dropped؟`, options: [`The second object — what they were guided to is never named in this verse`, `The first object — who was guided is never named in this verse`, `Both objects — neither the guided people nor their destination is named`, `Neither — nothing is dropped here; both objects appear explicitly in the verse`], correct: 0 },
        { q: `In ﴿وَأَيْدِيَكُمْ إِلَى المَرَافِقِ﴾, scholars differ on whether the elbows are included in the washing. What grammatical point does that disagreement hinge on؟`, options: [`Whether إلى's انتهاء الغاية necessarily includes its endpoint in every context`, `Whether أيديكم is مفرد, since number agreement rarely settles a question like this`, `Whether المرافق takes تنوين, since definiteness alone would not decide what's included`, `Whether the verb is فعل أمر, since mood does not usually affect what an object includes`], correct: 0 },
      ...
      bank: [
        ...
        { title: `المفعول الأول محذوف`, kind: 'mcq', prompt: `In ﴿وَإِنَّكَ لَتَهْدِي إِلَى صِرَاطٍ مُسْتَقِيمٍ﴾, the understood full meaning is وَإِنَّكَ لَتَهْدِي النَّاسَ إِلَى صِرَاطٍ مُسْتَقِيمٍ. Which object was dropped؟`, options: [`The first object, النَّاسَ — understood from context, though never written in the verse`, `The second object — though إِلَى صِرَاطٍ مُسْتَقِيمٍ already names it in the verse`, `Both objects — though the verse only omits one of the two, not both`, `Neither — the verse states both objects explicitly, with nothing left for context to supply`], correct: 0 },
        ...
        { title: `أيديكم إلى المرافق: الرأي الآخر`, kind: 'mcq', prompt: `A minority of scholars held that the elbows are not included in ﴿وَأَيْدِيَكُمْ إِلَى المَرَافِقِ﴾. On what grammatical basis؟`, options: [`إلى does not necessarily include the endpoint it marks, unlike a direct مفعول به`, `المرافق is مبني, so its case ending can never show the elbows are included`, `أيديكم has no إعراب at all, since it is مبني like a pronoun`, `إلى here is a حرف عطف, not جر, joining أيديكم to a dropped noun instead`], correct: 0 },
        ...
        { title: `فعل الجارحة: الافتراضي غير الملقّب`, kind: 'mcq', prompt: `سَمِعَ، مَشَى، أَكَلَ، and شَمَّ are all technically أفعال الجوارح. Why does nobody bother labelling them that way؟`, options: [`فعل الجارحة is the default reading, so the label only earns its place when a verb runs both ways`, `They are not really أفعال الجوارح at all, despite being performed with the limbs`, `They are أفعال ناقصة instead, needing a خبر the way كان does`, `They never take a فاعل, since their meaning stays entirely within the verb itself`], correct: 0 },
        { title: `رأى: لماذا يُذكر اللقب`, kind: 'mcq', prompt: `Why does رأى specifically need رأى الجارحة or رأى القلبية stated explicitly؟`, options: [`Because رأى genuinely carries both a physical-seeing sense and an inner-judgement sense, so the label disambiguates which is meant`, `Because رأى never means physical seeing at all, only ever carrying the inner-judgement sense`, `Because رأى is سماعي and has no فاعل, unlike the regular أفعال الجوارح`, `Because رأى always takes three مفاعيل, unlike the other أفعال القلوب`], correct: 0 },
        {
          ...
          distractors: [`مفعول به ثان غير صريح`, `جار ومجرور في معنى المفعول الثاني`, `فعل متعدي إلى مفعول واحد`, `فاعل ظاهر`, `مضاف إليه مجرور`, `حرف جر`],
        },
        {
          ...
          distractors: [`فعل مضارع (مفعوله الثاني محذوف تقديره الصراط)`, `فعل أمر (مفعوله الأول محذوف تقديره الناس)`, `مفعول به ثان صريح`, `مفعول به أول مذكور`, `فاعل ظاهر`, `جار ومجرور متعلق بالفعل`],
        },
        {
          ...
          distractors: [`فعل ومفعوله الثاني (والمفعول الأول محذوف)`, `مفعول به أول محذوف`, `مفعول به ثان صريح`, `فعل متعدي إلى مفعولين`, `فاعل مرفوع`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`مفعول به لفعل مذكور (اغسلوا)`, `جار ومجرور متعلق بالفعل المذكور`, `مفعول به ثان`, `مفعول به منصوب`, `مضاف إليه مجرور`, `فاعل ظاهر`],
        },
        {
          ...
          distractors: [`فعل قلب متعدي إلى مفعولين`, `فعل جارحة متعدي إلى مفعولين`, `فعل تحويل متعدي إلى مفعولين`, `خبر مرفوع`, `مبتدأ مرفوع`, `مضاف إليه مجرور`],
        },
        {
          ...
          distractors: [`فعل قلب متعدي إلى مفعولين وفاعله المستتر`, `فعل متعدي إلى مفعولين وفاعله الظاهر`, `خبر مرفوع`, `مبتدأ مرفوع`, `فاعل ظاهر`, `مفعول به ثان غير صريح`],
        },
      ],
    },
  ],
