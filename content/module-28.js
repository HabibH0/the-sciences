  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`An اسم نكرة named to clarify a vague word or a vague relation between two parts of a sentence`, `A حرف that changes a verb's tense`, `An اسم that always follows a عدد without exception`, `A فعل that never takes a فاعل`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It is the تمييز that clarifies what أَحَدَ عَشَرَ is eleven of`, `It is the فاعل of رَأَيْتُ`, `It is a حال describing رَأَيْتُ`, `It is تمييز نسبة, not تمييز مفرد`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`الإضافة — خَاتَمُ فِضَّةٍ — is the more usual construction`, `عِنْدِي خَاتَمٌ فِضَّةً is always preferred over الإضافة`, `Both are equally rare in Arabic`, `Neither construction is grammatical`],
            correct: 0,
          },
        },
      ],
      ...
      bank: [
        ...
        { title: `وزن الآلة الحقيقية مقابل التقدير الحسي`, kind: 'mcq', prompt: `المقدار measured by a real instrument (like لِتْر or مِثْقَال) and ما يُشْبِهُ المِقْدارَ measured by rough approximation (like رَاحَة) both still function the same way in a sentence. What do they share؟`, options: [`Each is followed by a تمييز that says what the quantity is of`, `Each must be مجرور بالإضافة`, `Each is a type of تمييز النسبة`, `Each requires the number to be مبهم`], correct: 0 },
        { title: `تحديد نوع التمييز: نخلا`, kind: 'mcq', prompt: `In عِنْدِي جَرِيبٌ نَخْلًا, what is نَخْلًا؟`, options: [`تمييز مفرد منصوب, clarifying جَرِيبٌ (المساحة)`, `تمييز نسبة, clarifying the sentence as a whole`, `مضاف إليه مجرور`, `خبر مقدم`], correct: 0 },
        { title: `تحديد نوع التمييز: لبنا`, kind: 'mcq', prompt: `In عِنْدِي لِتْرٌ لَبَنًا, what is لَبَنًا؟`, options: [`تمييز مفرد منصوب, clarifying لِتْرٌ (الكَيْل)`, `تمييز نسبة, clarifying the sentence as a whole`, `مضاف إليه مجرور`, `فاعل`], correct: 0 },
        {
          ...
          distractors: [`تمييز نسبة`, `مضاف إليه مجرور`, `العدد المبهم`, `مفعول به`],
        },
        {
          ...
          distractors: [`مضاف إليه مجرور`, `تمييز نسبة`, `فاعل مرفوع`, `مفعول به منصوب`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `خبر مرفوع`, `اسم دالّ على الكَيْل منصوب`, `مفعول به منصوب`],
        },
        {
          ...
          distractors: [`تمييز نسبة`, `مضاف إليه مجرور`, `فاعل مرفوع`, `مبتدأ مؤخر (الكَيْل)`],
        },
        {
          ...
          distractors: [`مضاف إليه مجرور`, `العدد الصريح`, `فاعل مرفوع`, `تمييز (ما اُجري مجرى المقادير) منصوب`],
        },
        {
          ...
          distractors: [`تمييز عدد`, `مضاف إليه مجرور`, `تمييز (فرع للتمييز) منصوب`, `حرف عطف`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Numbers 3 through 10 take a جمع تمييز مجرور بالإضافة`, `Numbers 11-99 take a مفرد تمييز منصوب`, `المِائَة والأَلْف always take a منصوب تمييز`, `العدد المبهم is always مجرور`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        ...
        { title: `شيبا: المحول من الفاعل`, kind: 'mcq', prompt: `وَاشْتَعَلَ الرَّأْسُ شَيْبًا's original meaning was شَابَ شَيْبُ الرَّأْسِ, with شَيْبُ as الفاعل. Why was it transformed into تمييز؟`, options: [`For مُبَالَغَة — attributing الاشتعال to الرَّأْس itself intensifies the meaning`, `Because الفاعل can never be مضاف`, `Because شَيْبًا must always be مجرور`, `Because الرَّأْس cannot take تنوين`], correct: 0 },
        ...
        { title: `كم الخبرية: الإعراب`, kind: 'mcq', prompt: `كَمْ مِّن فِئَةٍ قَلِيلَةٍ غَلَبَتْ فِئَةً كَثِيرَةً بِإِذْنِ اللَّهِ expresses abundance with كَمِ الخَبَرِيَّة. How is its تمييز, فِئَةٍ, إعراب'd؟`, options: [`مجرور بحرف جر زائد, ظاهر هنا (مِنْ)`, `منصوب مفرد, like الاستفهامية`, `مجرور بالإضافة`, `مرفوع, as if it were a خبر`], correct: 0 },
        { title: `كم الخبرية: الجر المقدر`, kind: 'mcq', prompt: `كَمْ مُلوكٍ بَادَ مُلْكُهُمْ shows تمييز كم الخبرية مجرور بحرف جر مقدر rather than ظاهر. What does مُقَدَّر mean here؟`, options: [`The زائد جار is understood but not written`, `The زائد جار is written but silent`, `التمييز is dropped entirely`, `التمييز is منصوب instead`], correct: 0 },
        { title: `مفصول عن كم: وجوب الجر الظاهر`, kind: 'mcq', prompt: `كَمْ أَهْلَكْنَا قَبْلَهُمْ مِّنَ الْقُرُونِ separates القُرون from كَمْ by a verb phrase in between. What does that separation require؟`, options: [`The تمييز must be مجرور بحرف جر ظاهر, not مقدر`, `The تمييز must become منصوب instead`, `The تمييز must be dropped`, `The تمييز can no longer be نكرة`], correct: 0 },
        ...
        { title: `التمييز للتأكيد`, kind: 'mcq', prompt: `إِنَّ عِدَّةَ الشُّهُورِ عِندَ اللَّهِ اثْنَا عَشَرَ شَهْرًا already names الشُّهُور before شَهْرًا repeats it. What's the difference between this تمييز and an ordinary مُفَسِّر تمييز؟`, options: [`It confirms a meaning already clear rather than lifting a genuine ambiguity`, `It is مجرور instead of منصوب`, `It clarifies تمييز النسبة rather than تمييز المفرد`, `It can never appear after إنّ`], correct: 0 },
        {
          ...
          distractors: [`مضاف إليه مجرور`, `تمييز مفرد`, `تمييز نسبة محوّل من الفاعل منصوب`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`مفعول به منصوب`, `تمييز مفرد`, `تمييز نسبة محوّل من المبتدأ منصوب`, `فعل مضارع`],
        },
        {
          ...
          distractors: [`تمييز عدد`, `مضاف إليه مجرور`, `تمييز نسبة محوّل من الفاعل منصوب`, `فاعل`],
        },
        {
          ...
          distractors: [`تمييز منصوب`, `مضاف إليه في محل نصب`, `العدد المبهم`, `تمييز مجرور بحرف جر زائد`],
        },
        {
          ...
          distractors: [`تمييز منصوب`, `مفعول به منصوب`, `كم الاستفهامية`],
        },
        {
          ...
          distractors: [`تمييز نسبة`, `مضاف`, `تمييز العدد الصريح منصوب`, `خبر مرفوع`],
        },
      ],
    },
  ],
