  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`الهمزة precedes the عاطف (أَوَ...); هل follows the عاطف (وَهَلْ...)`, `Both always precede the عاطف — the same fixed lead position only الهمزة actually holds`, `Both always follow the عاطف — mirroring the restriction that limits هل to التصديق alone`, `هل precedes the عاطف; الهمزة follows it — the reverse of the actual fixed order`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`السين marks the near future (paired against لا); سوف marks the far future (paired against لن)`, `السين marks the far future (paired against لن); سوف marks the near future (paired against لا)`, `Only السين futurizes a فعل مضارع; سوف does something else entirely`, `They are fully interchangeable, with no difference in meaning`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`السين — named حرف تنفيس`, `سوف — named حرف تنفيس`, `السين — named حرف تسويف`, `سوف — named حرف تسويف`],
            correct: 0,
          },
        },
      ],
      quiz: [
        { q: `هل is restricted to one of the two logical question types الهمزة can express. Which type can هل never introduce?`, options: [`تصوّر — a choice between two or more named options`, `تصديق — a plain yes/no question, confirmed or denied with نعم or لا`, `Neither type — هل cannot introduce any question`, `Both types equally — هل, like الهمزة, can introduce either تصديق or تصوّر`], correct: 0 },
        { q: `أَلَمْ نَشْرَحْ لَكَ صَدْرَكَ opens with الهمزة directly before a negated verb. What does this show about الهمزة compared to هل?`, options: [`الهمزة can enter on both الإيجاب and النفي; هل only ever enters on الإيجاب`, `Both enter equally on النفي — neither particle is restricted from negated sentences`, `هل enters on النفي but الهمزة does not, the reverse of the actual restriction`, `Neither particle can enter on النفي — a negated verb blocks both الهمزة and هل alike`], correct: 0 },
        { q: `A sentence opens وَهَلْ..., عاطف then هل. Could it instead open هَلْ وَ..., هل then عاطف?`, options: [`No — هل always follows a preceding عاطف rather than leading it`, `Yes — the order between هل and a عاطف is genuinely free either way`, `Yes, but only in poetry, where metrical needs occasionally override the fixed order`, `No — هل can never combine with a عاطف at all, the same restriction that limits it to تصديق alone`], correct: 0 },
      ...
      bank: [
        ...
        { title: `محل من الإعراب`, kind: 'mcq', prompt: `Do الهمزة and هل occupy a محل من الإعراب of their own?`, options: [`No — neither particle has a محل من الإعراب`, `Yes — both are always مبتدأ, since each opens a جملة اسمية by default`, `Only الهمزة has a محل من الإعراب of its own`, `Only هل has a محل من الإعراب of its own`], correct: 0 },
        { title: `اسمية أو فعلية`, kind: 'mcq', prompt: `فَهَلْ أَنْتُمْ مُنْتَهُونَ opens a جملة اسمية, while ﴿أَكَفَرْتُمْ بَعْدَ إيمانِكُمْ﴾ opens a جملة فعلية. What does this show about حرفا الاستفهام?`, options: [`Both particles can introduce either a جملة اسمية or a جملة فعلية`, `الهمزة only introduces a جملة فعلية, never a جملة اسمية`, `هل only introduces a جملة اسمية, never a جملة فعلية`, `Neither particle can introduce a جملة فعلية — both are restricted to جملة اسمية alone`], correct: 0 },
        { title: `تصديق: definition`, kind: 'mcq', prompt: `A تصديق question is answerable with a plain نعم or لا. What kind of question is it — polar or a choice between options?`, options: [`A polar yes/no question, answerable with نعم or لا`, `A non-polar choice between two or more options`, `Neither — تصديق never expects an answer`, `A question that is always rhetorical`], correct: 0 },
        { title: `تصوّر: definition`, kind: 'mcq', prompt: `A تصوّر question cannot be answered with نعم or لا. What must the listener do instead?`, options: [`Choose between two or more specific options named in the question`, `Simply confirm or deny one proposition, the same job تصديق does instead`, `Answer with silence, since no named options are actually offered`, `Repeat the question back verbatim, without answering it at all`], correct: 0 },
        ...
        { title: `هل أنبئكم: only تصديق`, kind: 'mcq', prompt: `هَلْ أُنَبِّئُكُمْ بِشَرٍّ مِنْ ذَلِكَ مَثُوبَةً عِنْدَ اللهِ only ever admits a yes/no response. Could it be restructured into a تصوّر question the way an الهمزة question can?`, options: [`No — هل is restricted to تصديق alone`, `Yes — هل can introduce either type freely`, `Yes, but only in the Qur'an, rarely elsewhere`, `No, because هل never introduces a question at all`], correct: 0 },
        { title: `الإيجاب والنفي: which particle is restricted`, kind: 'mcq', prompt: `Between الهمزة and هل, which one is restricted to opening only a positive (إيجاب) sentence?`, options: [`هل — the one restricted to الإيجاب alone, since it never enters on النفي`, `الهمزة — even though elsewhere it freely enters on both الإيجاب and النفي`, `Both are restricted equally, since الإيجاب and النفي never actually distinguish the two particles`, `Neither is restricted, since both freely combine with a حرف عطف regardless of order`], correct: 0 },
        ...
        { title: `حرف تنفيس: why السين is named that`, kind: 'mcq', prompt: `السين is called حرف تنفيس. What sense does that name capture?`, options: [`A sense of "opening up" the verb into the near future — relief or breathing space`, `A sense of endlessly postponing the verb's action — the same "keep putting it off" meaning سوف carries instead`, `A sense of negating the verb entirely, as if a لا or لن had attached instead`, `A sense of doubling the verb's meaning, as though the verb had been repeated twice`], correct: 0 },
        { title: `حرف تسويف: why سوف is named that`, kind: 'mcq', prompt: `سوف is called حرف تسويف, sharing its root with المسوّفون. What does that name capture?`, options: [`The sense of "putting off," constantly deferring an action to later`, `The sense of immediate, imminent action — the same nearness that السين marks instead`, `The sense of negating the verb entirely, as though لن had attached to it`, `The sense of doubling the verb's subject, as though the فاعل had been repeated`], correct: 0 },
        { title: `Near and far are relative`, kind: 'mcq', prompt: `Comparing سَيَشِبُّ الغُلَامُ against وَسَوْفَ يَشِيخُ الفَتَى, are السين's "near" and سوف's "far" fixed spans of time, or relative to one another?`, options: [`Relative to one another — السين's future is simply nearer than سوف's`, `Fixed spans — السين always means within a day, سوف always means decades`, `They mark identical spans of time — nearness and farness collapse into the same meaning here`, `Neither marks any span of time at all — both merely signal tense, not distance`], correct: 0 },
        {
          ...
          distractors: [`حرف استفهام للتصديق فقط`, `حرف عطف يفيد التصديق`, `حرف استقبال للمستقبل القريب`, `خبر مرفوع`, `حرف نفي`, `الخيار الأول مرفوع`],
        },
        {
          ...
          distractors: [`حرف استفهام سابق للعاطفة`, `حرف استفهام تالٍ للعاطفة`, `حرف استفهام للتصديق فقط`, `حرف نفي فقط`, `فعل مضارع مرفوع`, `فعل مضارع مجزوم بلا الناهية`],
        },
        {
          ...
          distractors: [`حرف عطف سابق لهل`, `حرف استفهام تالٍ للعاطفة`, `حرف عطف سابق للهمزة`, `حرف استقبال`, `حرف تفسير`, `حرف جواب`],
        },
        {
          ...
          distractors: [`حرف استفهام سابق للعاطفة`, `حرف عطف تالٍ للهمزة`, `حرف استفهام للتصوّر`, `حرف استفهام للتصديق فقط`, `حرف استقبال`, `حرف تفسير`],
        },
        {
          ...
          distractors: [`فعل ماضٍ`, `فعل مضارع مقترن بسوف للمستقبل البعيد`, `حرف استقبال`, `فاعل مرفوع`, `مفعول به`, `فعل مضارع مرفوع`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`النداء — نادى carries the meaning of قول without being the word قال`, `الوحي — نادى means "to reveal," as in وَأَوْحَيْنَا إِلَى مُوسَى أَنْ أَلْقِ عَصَاكَ`, `العهد — نادى means "to make a covenant," as in وَعَهِدْنَا إِلَى إِبْراهيمَ وَإِسْماعيلَ أَنْ طَهِّرَا بَيْتِيَ`, `الكتابة — نادى means "to write," the way Bilqīs's letter is introduced by أَنْ`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because يأمر elsewhere takes the preposition بِ, so a بِ is understood before أنْ`, `Because ذبح is not a real جملة فعلية, so no جملة precedes أنْ at all`, `Because بقرة is إضافة, not مفعول به, so أنْ has no object to explain`, `Because يأمر never carries the meaning of قول, unlike نادى or أوحى elsewhere in the lesson`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `أيْ can introduce an explanation of which kinds of expression?`, options: [`Either a مفرد or a جملة, since أيْ is the flexible one`, `Only a مفرد, never a جملة on its own`, `Only a جملة, never a single مفرد word`, `Neither — أيْ never introduces an explanation`], correct: 0 },
        { q: `أنْ التفسيرية can only introduce which kind of expression?`, options: [`A جملة, never a مفرد word on its own`, `A مفرد, the same flexibility أيْ has instead`, `Either a مفرد or a جملة, the flexibility only أيْ actually has`, `A حرف جر — the thing that must not precede أنْ instead`], correct: 0 },
        { q: `What must precede أنْ for it to be تفسيرية?`, options: [`A جملة carrying the meaning of قول without using the word قال`, `Any single مفرد word, the same way أيْ can`, `A حرف جر, spoken or understood, must come directly before أنْ instead`, `Nothing — أنْ التفسيرية needs no preceding جملة`], correct: 0 },
        { q: `إِنَّ اللهَ يَأْمُرُكُمْ أَنْ تَذْبَحُوا بَقَرَةً uses أنْ that looks تفسيرية but is actually مصدرية. Why?`, options: [`Because يأمر elsewhere takes the preposition بِ, understood here before أنْ`, `Because ذبح carries no meaning of قول, unlike نادى or أوحى elsewhere in the lesson`, `Because بقرة is مفرد, not جملة, and أنْ التفسيرية never explains a مفرد`, `Because a مضاف إليه precedes أنْ, the same problem that blocks آخِرُ دَعْواهُمْ`], correct: 0 },
        { q: `وَنَادَاهُمَا رَبُّهُمَا أَلَمْ أَنْهَكُمَا عَنْ تِلْكُمَا الشَّجَرَةِ meets every condition for أنْ التفسيرية, yet no أنْ appears. What does that show?`, options: [`Meeting the شروط makes أنْ permissible, not obligatory`, `The شروط were not actually met, since a حرف جر precedes أنْ`, `أنْ التفسيرية can never be omitted when the شروط are met`, `نادى does not carry the meaning of قول here`], correct: 0 },
        { q: `In وَآخِرُ دَعْوَاهُمْ أَنِ الحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ, what precedes أنِ, and what does that make أنِ?`, options: [`A مبتدأ still awaiting its خبر, not a full جملة — so أنِ is مخففة من الثقيلة`, `A full جملة with the meaning of قول — so أنِ is تفسيرية`, `A حرف جر مقدّر — so أنِ is مصدرية, the same problem that blocks أَنْ in يَأْمُرُكُمْ أَنْ تَذْبَحُوا`, `Nothing at all precedes أنِ here — so it would have to be زائدة with no function`], correct: 0 },
      ],
      bank: [
        ...
        { title: `أيْ: the more flexible particle`, kind: 'mcq', prompt: `Between أيْ and أنْ, which one can introduce an explanation of a single مفرد word?`, options: [`أيْ — it can explain either a مفرد or a جملة`, `أنْ — it can explain either a مفرد or a جملة`, `Neither can explain a مفرد — both are restricted to a جملة alone`, `Both are restricted to a جملة only, never a single مفرد word`], correct: 0 },
        { title: `أسأل الله الفردوس أي الجنة: what is explained`, kind: 'mcq', prompt: `In أَسْأَلُ اللهَ الفِرْدَوْسَ أَيِ الجَنَّةَ, what does أيِ الجَنَّةَ explain?`, options: [`A single word, الفردوس`, `A whole جملة, the way أيْ can elsewhere`, `Nothing — أيِ here has no explanatory function`, `The verb أسأل itself`], correct: 0 },
        { title: `استغفرت الله أي سألت الله أن يغفر لي: مفرد or جملة؟`, kind: 'mcq', prompt: `In اسْتَغْفَرْتُ اللهَ أَيْ سَأَلْتُ اللهَ أَنْ يَغْفِرَ لِي, does أيْ here unpack a single word or a whole verb-phrase into a fuller sentence?`, options: [`A whole verb-phrase, unpacked into a fuller explanatory جملة`, `A single word only, the same job it does for الفردوس`, `Neither — the two clauses are unrelated`, `A حرف جر, unrelated to أيْ's explanatory function entirely`], correct: 0 },
        { title: `أنْ التفسيرية: restricted scope`, kind: 'mcq', prompt: `Can أنْ التفسيرية ever introduce an explanation of a single مفرد word, the way أيْ can?`, options: [`No — أنْ التفسيرية can only introduce a full جملة`, `Yes, under the same conditions as أيْ`, `Yes, but only in poetry, for metrical reasons`, `No — أنْ التفسيرية cannot introduce anything at all`], correct: 0 },
        { title: `First condition on أنْ التفسيرية`, kind: 'mcq', prompt: `What must the جملة before أنْ التفسيرية carry, for أنْ to be تفسيرية?`, options: [`The meaning of قول, without the actual word قال/يقول`, `The literal word قال, since only that exact word is said to license أنْ التفسيرية`, `A حرف جر, spoken or understood, must not precede it`, `A negation particle must precede the جملة before أنْ`], correct: 0 },
        ...
        { title: `إن الله يأمركم بالعدل: the parallel evidence`, kind: 'mcq', prompt: `إِنَّ اللهَ يَأْمُرُكُمْ بِالْعَدْلِ shows يأمر followed by an explicit بِ. What does this parallel verse help establish about أَنْ تَذْبَحُوا بَقَرَةً؟`, options: [`That a بِ is understood before أنْ in the ذبح verse too, making أنْ مصدرية`, `That يأمر never takes بِ elsewhere, so no حرف جر مقدّر could apply here either`, `That أنْ is تفسيرية in both verses, since يأمر always carries the meaning of قول`, `That العدل and بقرة are the same grammatical role, both entered by the same حرف جر بِ`], correct: 0 },
        { title: `Meeting the شروط: permissible, not obligatory`, kind: 'mcq', prompt: `A جملة meets every condition for أنْ التفسيرية. Must أنْ then appear?`, options: [`No — meeting the شروط only makes bringing أنْ permissible`, `Yes — أنْ must always appear once the شروط are met`, `Only if the جملة before it is جملة اسمية, not جملة فعلية`, `Only in Qur'anic Arabic; bringing أنْ elsewhere remains fully obligatory`], correct: 0 },
        ...
        { title: `آخر دعواهم: مبتدأ still awaiting خبر`, kind: 'mcq', prompt: `In وَآخِرُ دَعْوَاهُمْ أَنِ الحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ, what is آخِرُ, and what is دَعْوَاهُمْ, in the phrase before أنِ؟`, options: [`آخِرُ is مبتدأ; دَعْوَاهُمْ is مضاف إليه, with the خبر still awaited`, `آخِرُ is خبر; دَعْوَاهُمْ is مبتدأ, with the whole phrase already complete`, `Both together form a complete جملة فعلية, the same complete-جملة status أنْ التفسيرية itself requires`, `آخِرُ is فعل; دَعْوَاهُمْ is فاعل, treating the phrase as a verbal جملة`], correct: 0 },
        { title: `Why آخر دعواهم أن الحمد لله is not تفسيرية`, kind: 'mcq', prompt: `Why can أنِ in وَآخِرُ دَعْوَاهُمْ أَنِ الحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ not be تفسيرية, despite دعوى carrying a sense connected to speech?`, options: [`No complete جملة precedes أنِ — آخِرُ دَعْوَاهُمْ is still awaiting its خبر`, `الحمد لله is not a جملة اسمية, so it cannot serve as أنِ's explanation`, `دعوى never carries any meaning connected to قول, unlike نادى, أوحى, or عهد elsewhere in the lesson`, `A حرف جر مقدّر precedes أنِ here, the same block that affects يَأْمُرُكُمْ أَنْ تَذْبَحُوا`], correct: 0 },
        {
          ...
          distractors: [`أنْ التفسيرية`, `المفسَّر (جملة)`, `تفسير موضّح للجملة`, `حرف جر`, `مفعول به`, `أنْ مصدرية`],
        },
        {
          ...
          distractors: [`جملة فيها معنى القول (العهد)`, `أنْ مصدرية`, `أنْ مخففة من الثقيلة`, `حرف مصدر`, `حرف جر`, `أنْ ناصبة للمضارع`],
        },
        {
          ...
          distractors: [`جملة فيها معنى القول (النداء)`, `جملة فيها معنى القول (الوحي)`, `أنْ مصدرية`, `أنْ مخففة من الثقيلة`, `حرف مصدر`, `حرف جر`],
        },
        {
          ...
          distractors: [`فعل يحمل معنى القول ولا يتعدى بحرف جر مقدّر`, `أنْ تفسيرية لا مصدرية`, `فعل مضارع مجزوم بأنْ`, `أنْ مخففة من الثقيلة`, `حرف تفسير`, `الجملة المفسِّرة`],
        },
        {
          ...
          distractors: [`جملة تامة فيها معنى القول تسبق أنْ التفسيرية`, `جملة فيها معنى القول (العهد)`, `أنْ مصدرية`, `حرف تفسير`, `الجملة المفسِّرة`, `مبتدأ وخبر مكتملان`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because it is a normal معرب منصرف noun — the category depends on what the noun IS grammatically, not merely on being indefinite`, `Because every نكرة noun automatically takes تنوين التمكين, regardless of whether it is معرب or مبني`, `Because بَيْتٌ never appears with أل, and تنوين التمكين is reserved for nouns that never take أل`, `Because تنوين التمكين only attaches to proper nouns, never to an ordinary نكرة like بَيْتٌ`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It shifts سيبويه from a specific معرفة (the one famous grammarian) to a generic نكرة (any grammarian of that caliber)`, `It shifts سيبويه from a فعل to an اسم, the way تنوين normally marks a noun`, `It has no effect on the word's meaning at all — تنوين here is purely decorative`, `It marks سيبويه as منصرف رغم بنائه, overriding its status as a مبني proper noun`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A dropped word, أَحَدٍ`, `A dropped letter, like غَوَاشٍ's own dropped ي`, `A dropped entire sentence`, `Nothing — this تنوين is تنوين التمكين`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `What is أصل التنوين, and why is التنوين treated as a حرف despite being written as a diacritic?`, options: [`A نون ساكنة folded into the end of a word — it is fundamentally that نون, not a separate mark`, `A همزة folded into the start of a word — the mirror-image position, not where تنوين actually sits`, `A دال ساكنة, unrelated to نون — a different letter's sound folded in instead`, `A written نون that is simply never pronounced — the opposite of what وصل actually does with it`], correct: 0 },
        { q: `بَيْتٌ is نكرة, yet its تنوين is تنوين التمكين, not تنوين التنكير. What decides the category?`, options: [`Whether the noun is معرب منصرف, not merely whether it is indefinite`, `Whether the noun begins with أل, the usual mark of definiteness`, `Whether the noun is مذكر or مؤنث, the way تاء التأنيث would mark it instead`, `Whether the noun has more than three letters`], correct: 0 },
        { q: `هَذَا سِيبَوَيْهٍ جَدِيدٌ adds تنوين to a proper name normally without one. What shift does that produce?`, options: [`From a specific معرفة (the famous grammarian) to a generic نكرة (any grammarian of that caliber)`, `From مبني to معرب only, without touching سيبويه's definiteness at all`, `From مذكر to مؤنث, the way تاء التأنيث would mark it instead`, `No shift — تنوين never changes سيبويه's meaning, only its pronunciation in وصل`], correct: 0 },
      ...
      bank: [
        ...
        { title: `تنوين التنكير: what it attaches to`, kind: 'mcq', prompt: `تنوين التنكير attaches to أسماء الأفعال and to which other category؟`, options: [`Certain مبني proper nouns ending in ويه`, `جمع المؤنث السالم, تنوين المقابلة's class instead`, `Every معرب منصرف noun, تنوين التمكين's class instead`, `Every فعل مضارع, though تنوين never attaches to a فعل`], correct: 0 },
        { title: `صه vs صهٍ: the meaning shift`, kind: 'mcq', prompt: `صَهْ, without تنوين, means "stop talking about the specific thing." What does صَهٍ, with تنوين, mean instead؟`, options: [`"Be quiet altogether, about everything" — a shift to a fully general reference`, `Exactly the same thing as صَهْ — تنوين adds no meaning here at all`, `"Speak up," the opposite meaning — تنوين here reverses the command entirely`, `Nothing — صهٍ is not a real word, despite appearing in the lesson's own example`], correct: 0 },
        { title: `تنوين التنكير: definite to indefinite`, kind: 'mcq', prompt: `What shift in meaning does تنوين التنكير typically mark, as shown by صَهْ vs صَهٍ and سيبويه vs سيبويهٍ؟`, options: [`A shift from a definite, specific reference to a fully indefinite, general one`, `A shift from مذكر to مؤنث, the way تاء التأنيث would mark it instead`, `A shift from مفرد to جمع, the way a plural ending would mark it instead`, `A shift from فعل to اسم, the same category change ordinary تنوين is said to mark`], correct: 0 },
        ...
        { title: `كتاب vs كتابُ: تامّ or مضاف`, kind: 'mcq', prompt: `كِتَابٌ, with تنوين, is تامّ; كِتَابُ, without تنوين, signals what instead؟`, options: [`An إضافة is expected, as in كِتَابُ زَيْدٍ`, `A نداء is expected, the way a vocative would drop its own تنوين`, `A فعل أمر is expected, since a dropped تنوين often marks a command`, `Nothing changes at all — كِتَابٌ and كِتَابُ mean exactly the same thing`], correct: 0 },
        { title: `تنوين التعويض: what it stands in for`, kind: 'mcq', prompt: `تنوين التعويض substitutes for which kinds of dropped elements؟`, options: [`A letter, a word, or an entire sentence`, `Only a dropped letter, the one job غَوَاشٍ's تنوين alone performs`, `Only a dropped حرف جر, a case تنوين التعويض never actually covers`, `Only a dropped حركة, never a letter, a word, or a sentence`], correct: 0 },
        ...
        { title: `العتابن وأصابن: attaching beyond اسم`, kind: 'mcq', prompt: `تنوين الترنم attaches to العِتَابَ (a noun) and أَصَابَ (a فعل ماضٍ) alike in one line of poetry. What does that show about تنوين الترنم compared to the other four types؟`, options: [`Unlike them, it can attach to اسم, فعل, or حرف alike`, `Like them, it only ever attaches to a اسم`, `It only ever attaches to a فعل, never to an اسم or حرف`, `It cannot attach to a فعل ماضٍ, exactly like ordinary تنوين`], correct: 0 },
        {
          ...
          distractors: [`مبتدأ يحمل تنوين تعويض عن جملة (يَوْمَ إِذْ كَانَ كَذَا) محذوفة`, `تنوين تمكين`, `تنوين مقابلة`, `مضاف إليه`, `فاعل`, `خبر مرفوع`],
        },
        {
          ...
          distractors: [`مبتدأ يحمل تنوين تعويض عن كلمة (أَحَدٍ) محذوفة`, `تنوين مقابلة`, `تنوين تمكين`, `مضاف إليه`, `مبتدأ`, `فعل ماضٍ`],
        },
      ],
    },
  ],
