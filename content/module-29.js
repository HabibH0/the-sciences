  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `"Muhammad is nothing but a messenger" — i.e. مُحَمَّدٌ رَسُولٌ فَقَطْ. رسولٌ is مرفوع as خبر, exactly as it would be with إلا removed altogether.`, list: false },
            { box: { title: 'Example', lines: [`لَا نَعْبُدُ إِلَّا اللَّهَ`] } },
            { html: `"We worship none but Allah" — الله is منصوب as مفعول به of نعبد, again exactly the إعراب it would carry with إلا removed.`, list: false },
          ],
          exercise: {
      ...
      bank: [
        ...
        { title: `لا نعبد إلا الله: إعراب الله`, kind: 'mcq', prompt: `In لَا نَعْبُدُ إِلَّا اللَّهَ, why is اللهَ منصوب?`, options: [`Because it takes the إعراب it would have as مفعول به of نعبد if إلا were removed — إلا itself does no عمل here`, `Because إلا governs it into النصب as مستثنى`, `Because كل اسم بعد إلا يكون منصوبًا دائمًا`, `Because الله is always منصوب`], correct: 0 },
        ...
        },
        {
          ...
          distractors: [`مستثنى منصوب`, `أداة استثناء تعمل النصب`],
        },
        {
          ...
          distractors: [`مستثنى منصوب بإلا`, `حرف جر`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مستثنى منه`],
        },
        {
          ...
          distractors: [`بدل من المستثنى منه`, `مستثنى منه`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      bank: [
        ...
        { title: `أدوات الاستثناء: تصنيف عام`, kind: 'mcq', prompt: `Which of these three classifications does خلا belong to, when it is parsed as أداة استثناء?`, options: [`فعل`, `حرف`, `اسم`, `ظرف`], correct: 0 },
        {
          ...
          distractors: [`مضاف إليه`, `بدل مرفوع`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مضاف إليه`],
        },
        {
        ...
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مفعول به`],
        },
        {
          ...
          distractors: [`مستثنى منصوب`, `مستثنى منه`],
        },
        {
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        {
          ...
          lines: [
            ...
            { html: `"Indeed everything, save Allah, is vanity." ما here is ما مصدرية, and خلا is فعل ماضٍ; اللهَ is its مفعول به, منصوب — exactly as any ordinary فعل متعدٍ would put its مفعول به in النصب.`, list: false },
          ],
          exercise: {
            prompt: `In أَلَا كُلُّ شَيْءٍ مَا خَلَا اللَّهَ بَاطِلٌ, اللهَ is منصوب following the فعل خلا. What kind of النصب is this?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `لا إله إلا الله admits two possible إعراب readings: either إلا اللهُ is وصف with the meaning of غير (the sense is "no god other than Allah exists"), or it is استثناء غير تام (مفرَّغ), with an implied تقدير of لا إله موجودٌ إلا اللهُ — the خبر (موجود) dropped because context already supplies it. This shows how the fine detail of إعراب can admit more than one valid analysis without the doctrinal meaning changing at all.`, list: false },
          ],
          exercise: {
      ...
      bank: [
        ...
        { title: `ألا كل شيء ما خلا الله باطل: إعراب الله`, kind: 'mcq', prompt: `In أَلَا كُلُّ شَيْءٍ مَا خَلَا اللَّهَ بَاطِلٌ, why is اللهَ منصوبة (in the accusative)؟`, options: [`Because it is the مفعول به of the verb خلا, a transitive exception-verb`, `Because it is مستثنى with إلا`, `Because it is بدل from كل`, `Because it is a منصوب حال`], correct: 0 },
        ...
        { title: `لا إله إلا الله: القراءتان`, kind: 'mcq', prompt: `لا إله إلا الله admits two possible إعراب readings. Which pairing correctly names both?`, options: [`إلا الله كوصف بمعنى غير، أو استثناء غير تام بتقدير خبر محذوف (موجود)`, `إلا الله دائمًا استثناء تام لا غير`, `إلا الله دائمًا وصف فقط، ولا احتمال آخر`, `لا إله إلا الله لا تحتمل أي تحليل نحوي مختلف`], correct: 0 },
        ...
        { title: `تصنيف عام: حاشا كأداة استثناء`, kind: 'mcq', prompt: `Across this module, حاشا has consistently been treated as which grammatical category of أداة الاستثناء?`, options: [`حرف`, `فعل`, `اسم`, `ظرف`], correct: 0 },
        {
          ...
          distractors: [`مستثنى مجرور بحاشا`, `أداة حصر لا عمل لها`],
        },
        {
          ...
          distractors: [`مستثنى مجرور`, `أداة حصر`],
        },
        {
          ...
          distractors: [`مستثنى منصوب`, `بدل مرفوع`],
        },
      ],
    },
  ],
