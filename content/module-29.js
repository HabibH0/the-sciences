  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`None — إلا is a mere أداة حصر here and does no grammatical work; رسولٌ is مرفوع as خبر just as it would be without إلا`, `إلا forces رسولٌ into النصب, but the ن of تنوين hides it`, `إلا forces رسولٌ into الجر, treating إلا as though it were an ordinary حرف جر`, `رسولٌ is مرفوع only because it begins with ر`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `In مَا مُحَمَّدٌ إِلَّا رَسُولٌ, what role does إلا play, and what does that make of رسولٌ's النصب by إلا?`, options: [`إلا is a mere أداة حصر with no عمل; رسولٌ is مرفوع as خبر, not منصوب by إلا at all`, `إلا governs رسولٌ into النصب as مستثنى`, `إلا governs رسولٌ into الجر, treating إلا as though it were an ordinary حرف جر`, `إلا has no meaning here at all`], correct: 0 },
      ...
      bank: [
        ...
        { title: `غير التام: عمل إلا`, kind: 'mcq', prompt: `In الاستثناء غير التام, what happens to إلا's grammatical عمل?`, options: [`It becomes a mere أداة حصر and does no عمل at all`, `It governs المستثنى into النصب as usual`, `It governs المستثنى into الجر, the way a حرف جر normally would`, `It turns المستثنى into مبني, as though المستثنى had lost its إعراب altogether`], correct: 0 },
        { title: `ما محمد إلا رسول: إعراب رسول`, kind: 'mcq', prompt: `In مَا مُحَمَّدٌ إِلَّا رَسُولٌ, why is رسولٌ مرفوع rather than منصوب?`, options: [`Because إلا here is غير تام and does no عمل; رسولٌ takes the إعراب it would have as خبر without إلا at all`, `Because رسولٌ is a اسم علم, and أسماء الأعلام always stay مرفوع regardless of موقعها`, `Because إلا always leaves its noun مرفوع`, `Because محمدٌ is مبني, and its بناء carries over to رسولٌ as well`], correct: 0 },
        ...
        { title: `توليتم إلا قليلا منكم: متصل`, kind: 'mcq', prompt: `﴿ثُمَّ تَوَلَّيْتُمْ إِلَّا قَلِيلًا مِّنكُمْ﴾ excludes a few people from among those who turned away. Why is this المتصل rather than المنقطع?`, options: [`Because قليلًا منكم are of the very same جنس — people addressed by the verse — as those who turned away`, `Because قليلًا is نكرة مفيدة — the same fact that separates التام from غير التام, not المتصل from المنقطع`, `Because this الاستثناء is غير تام — the same fact that separates it from a تام استثناء, not from المنقطع`, `Because إلا here means لكن, the sense it carries only in المنقطع, not المتصل`], correct: 0 },
        ...
        { title: `فسجدوا إلا إبليس: منقطع`, kind: 'mcq', prompt: `﴿فَسَجَدُوا إِلَّا إِبْلِيسَ﴾ singles out إبليس, who never prostrated. Why is this المنقطع rather than المتصل?`, options: [`Because إبليس is not of the same جنس as those who prostrated`, `Because إبليس is معرفة — the same fact that separates التام from غير التام, not المتصل from المنقطع`, `Because سجدوا is جمع — a fact about مطابقة الفعل لفاعله, not المتصل from المنقطع`, `Because إلا here means حصر only`, ], correct: 0 },
        { title: `لماذا يقع المنقطع أصلًا`, kind: 'mcq', prompt: `المنقطع only arises under one specific condition. What is it?`, options: [`When the surrounding speech would otherwise give the false impression that المستثنى shares the ruling of what precedes it, requiring a corrective استدراك`, `Whenever المستثنى منه is not mentioned, since that is what defines غير التام, not المنقطع`, `Whenever إلا is preceded by كلام موجب — the fact that decides whether البدل is available, not what makes المنقطع arise`, `Whenever the sentence has no فعل at all`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`قومٌ is a نكرة غير مفيدة — it conveys no specific information — and المستثنى منه must be معرفة or نكرة مفيدة`, `Because قومٌ needs a قرينة to narrow it down, the same مخصوصة requirement a bare نكرة مستثنى like رَجُلًا needs`, `Because قومٌ needs أل التعريف specifically, since only معرفة — not نكرة مفيدة — can serve as المستثنى منه`, `Because قومٌ needs إضافة إلى معرفة before الاستثناء can work at all`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`نصب وجوبًا — النصب is the only option, with no alternative reading`, `الرفع فقط, the same إعراب البدل would give in غير موجَب speech`, `الجر فقط, as though إلا were a حرف جر governing what follows it`, `نصب أو بدل, exactly as in negated speech`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        ...
        { title: `جاء قوم إلا خالدًا: لماذا لا يصح`, kind: 'mcq', prompt: `جَاءَ قَوْمٌ إِلَّا خَالِدًا is invalid in this form. What is قومٌ, and why does that make it invalid as المستثنى منه?`, options: [`قومٌ is a نكرة غير مفيدة — it conveys no specific information — and غير مفيدة نكرة cannot serve as المستثنى منه`, `قومٌ is معرفة, and معرفة cannot serve as المستثنى منه`, `قومٌ lacks a قرينة narrowing it, the same نكرة مخصوصة requirement a bare نكرة مستثنى like رَجُلًا needs`, `خالدًا is مبني, which invalidates the whole sentence`], correct: 0 },
        ...
        { title: `خلا وعدا: رأي الأكثر`, kind: 'mcq', prompt: `According to الأكثر من النحاة, what are خلا and عدا always classified as?`, options: [`أفعال, putting what follows them in النصب`, `حرفا جر, putting what follows them in الجر`, `أسماء, مبنية على الفتح`, `ظرفا زمان, taking المستثنى as مضاف إليه rather than مفعول`], correct: 0 },
        { title: `ما خلا وما عدا: اتفاق النحاة`, kind: 'mcq', prompt: `Once خلا or عدا is preceded by ما, all النحاة agree they are أفعال. What role does ما play that produces this unanimous agreement?`, options: [`It is ما مصدرية, and مصدرية ما attaches only to verbs — never to nouns or particles`, `It negates خلا and عدا, the way لا or ما ordinarily negate a فعل`, `It turns خلا and عدا into حروف جر`, `It has no grammatical role, only rhetorical emphasis`], correct: 0 },
        ...
        { title: `مستثنى: نكرة مخصوصة`, kind: 'mcq', prompt: `In جَاءَ القَوْمُ إِلَّا رَجُلًا مَرِيضًا, رجلًا مريضًا is a valid المستثنى even though رجلًا alone is a نكرة. What made it valid?`, options: [`مريضًا qualifies رجلًا, turning it into a نكرة مخصوصة`, `مريضًا removes رجلًا's تنوين, the way إضافة would`, `مريضًا changes رجلًا's إعراب to الرفع`, `Nothing — رجلًا alone was already valid`], correct: 0 },
        { title: `جاء القوم إلا رجلًا: لماذا لا يصح`, kind: 'mcq', prompt: `جَاءَ القَوْمُ إِلَّا رَجُلًا, with no further qualification on رجلًا, is invalid. Why?`, options: [`رجلًا is نكرة غير مخصوصة — nothing in the wording narrows down which رجل is meant`, `رجلًا is معرفة, which cannot serve as المستثنى`, `رجلًا must be إضافة to become valid as المستثنى, the same way مريضًا's qualification made it نكرة مخصوصة`, `القومُ must be نكرة for الاستثناء to work`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`منصوب على المفعولية — the same ordinary النصب any فعل متعدٍ gives its مفعول به`, `منصوب على أنه مستثنى بإلا, exactly as it would be after إلا rather than after a فعل`, `منصوب على الحال, describing the state of الفاعل at the time of الفعل`, `منصوب على أنه بدل من كل شيء`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`إلا بمعنى غير — used للصفة rather than for الاستثناء`, `غير بمعنى إلا — used للاستثناء rather than للوصف`, `إلا في الاستثناء المنقطع, where إلا carries the meaning of لكن instead`, `إلا في الاستثناء غير التام, where إلا becomes a mere أداة حصر with no عمل`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        ...
        { title: `ألا كل شيء ما خلا الله باطل: إعراب الله`, kind: 'mcq', prompt: `In أَلَا كُلُّ شَيْءٍ مَا خَلَا اللَّهَ بَاطِلٌ, why is لَفْظَ الجَلالَةِ منصوبة (in the accusative)؟`, options: [`Because it is the مفعول به of the verb خلا, a transitive exception-verb`, `Because it is مستثنى with إلا, and كل مستثنى بإلا is منصوب regardless of the أداة actually used`, `Because it is بدل from كل, not a true مفعول به of the فعل`, `Because it is a منصوب حال, describing كل شيء's state rather than serving as its مفعول به`], correct: 0 },
        ...
        { title: `ما بعد غير: الإضافة`, kind: 'mcq', prompt: `In جَاءَ الأَوْلَادُ غَيْرَ زَيْدٍ, what is زيدٍ's إعراب, and why?`, options: [`مجرور بالإضافة — whatever follows غير is always مجرور`, `منصوب, matching غير's own إعراب`, `مرفوع على البدلية, treating زيدٍ as بدل from الأولاد`, `مبني على الفتح, as though زيدٍ were a اسم مبني rather than معرب`], correct: 0 },
        ...
        { title: `حاشا: معناها`, kind: 'mcq', prompt: `حاشا is set aside for الاستثناء together with which additional sense?`, options: [`تنزيه المستثنى — explicitly clearing it from what applies to everything else`, `تعليل المستثنى, explaining why the ruling was excluded in the first place`, `تأكيد المستثنى منه, reinforcing the very noun المستثنى was excluded from`, `توكيد الفعل, emphasizing the verb rather than the noun excluded`], correct: 0 },
        ...
        { title: `لا تدخلوا بيوتًا غير بيوتكم: غير للوصف`, kind: 'mcq', prompt: `In ﴿لَا تَدْخُلُوا بُيُوتًا غَيْرَ بُيُوتِكُمْ﴾, غيرَ is used in its original sense. What is that sense?`, options: [`للوصف — a descriptive adjective, not الاستثناء`, `للاستثناء, exactly as in جاء الأولاد غير زيد`, `للحصر فقط, exactly as إلا behaves in الاستثناء غير التام`, `للتوكيد, reinforcing بيوتًا rather than describing it`], correct: 0 },
        { title: `الناس هلكى إلا العالمون: إلا للصفة`, kind: 'mcq', prompt: `In الناس هلكى إلا العالمون، والعالمون هلكى إلا العاملون، والعاملون هلكى إلا المخلصون, إلا is repeated across a chain of general statements. What sense does إلا carry in each link of that chain?`, options: [`للصفة, with the meaning of غير, not its ordinary excluding sense`, `Its ordinary excluding sense, unchanged`, `للحصر فقط, with no meaning of its own`, `الاستثناء المنقطع فقط, since العالمون would not share the same جنس as الناس`], correct: 0 },
