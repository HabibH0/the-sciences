    ...
    // ---------------------------------------------------------------- L1
    {
      ...
      bank: [
        ...
        { title: `أقسام التام`, kind: 'mcq', prompt: `الاستثناء التام itself splits further into which two kinds?`, options: [`المتصل والمنقطع`, `المعرفة والنكرة`, `الموجب وغير الموجب`, `الحرف والفعل`], correct: 0 },
        {
          ...
          distractors: [`مفعول به`, `نعت`, `بدل مرفوع`, `حرف عطف`],
        },
        {
          ...
          distractors: [`مستثنى منصوب`, `أداة استثناء تعمل النصب`, `ما مصدرية`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`مستثنى منصوب بإلا`, `حرف جر`, `لا الناهية`, `فعل ماضٍ`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مستثنى منه`, `أداة حصر لا عمل لها`, `نعت منصوب`],
        },
        {
          ...
          distractors: [`بدل من المستثنى منه`, `مستثنى منه`, `أداة استثناء`, `نعت منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      bank: [
        ...
        { title: `أدوات الاستثناء: تصنيف عام`, kind: 'mcq', prompt: `Which of these three classifications does خلا belong to, when it is parsed as أداة استثناء?`, options: [`فعل`, `حرف`, `اسم`, `ظرف`], correct: 0 },
        {
          ...
          distractors: [`مضاف إليه`, `بدل مرفوع`, `ما مصدرية`, `أداة حصر لا عمل لها`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مضاف إليه`, `حال منصوب`, `أداة حصر لا عمل لها`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مستثنى منه`, `مستثنى منصوب أو بدل`, `أداة حصر لا عمل لها`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مفعول به`, `فعل مضارع`],
        },
        {
          ...
          distractors: [`مستثنى منصوب`, `مستثنى منه`, `ما مصدرية`],
        },
        {
          ...
          distractors: [`بدل مرفوع`, `مستثنى منه`, `مستثنى منصوب أو بدل`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      bank: [
        ...
        { title: `تصنيف عام: حاشا كأداة استثناء`, kind: 'mcq', prompt: `Across this module, حاشا has consistently been treated as which grammatical category of أداة الاستثناء?`, options: [`حرف`, `فعل`, `اسم`, `ظرف`], correct: 0 },
        {
          ...
          distractors: [`مستثنى مجرور بحاشا`, `أداة حصر لا عمل لها`, `مستثنى منصوب`, `ما نافية`],
        },
        {
          ...
          distractors: [`مستثنى مجرور`, `أداة حصر`, `نعت منصوب`, `بدل مرفوع`],
        },
        {
          ...
          distractors: [`مستثنى منصوب`, `بدل مرفوع`, `فعل ماضٍ`, `أداة حصر لا عمل لها`],
        },
      ],
    },
  ],
