  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`الشرط is "had You willed" (شِئْتَ); الجواب is "You would have destroyed them" (أَهْلَكْتَهُمْ) — neither occurred`, `الشرط is "You would have destroyed them"; الجواب is "had You willed"`, `الشرط and الجواب both refer to the same clause, أَهْلَكْتَهُمْ`, `This ayah has a جواب but no شرط — as if أَهْلَكْتَهُمْ merely described a fact, not a hypothetical outcome`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`That الجواب itself is impossible without الشرط — الجواب might still have another cause`, `That الشرط did not occur — dropped because of تَعَدُّد الأسباب, the same multiple-causes problem driving the whole correction`, `That لَوْ always requires a فعل after it — dropped because the corrected definition still lets a اسم مؤول stand in for one`, `That لَوْ can carry the meaning of تمني — dropped because Ibn Hishām's correction is about تَعَدُّد الأسباب, not about any secondary meaning of لَوْ`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`That the man was never forgiven — Allah may still forgive him through sheer mercy, without any repentance at all`, `That repentance brings forgiveness — the very link this example is built to demonstrate`, `That the man did not repent — the one fact this example and its جواب both rest on`, `That لَوْ marks a hypothetical, not a fact — the same past-tense force لَوْ imposes on a following مضارع`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because it is genuinely unclear whether "he would not disobey" depends only on "he did not fear Allah," or rests on some other cause, such as love of Allah`, `Because Ṣuhayb is not a real historical figure — a mistake that would make the whole example moot regardless of شرط or جواب`, `Because لَوْ cannot introduce a negated شرط — as if لَمْ يَخَفِ could not follow لَوْ the way it plainly does here`, `Because ʿUmar's statement contains no جواب at all — as if لَمْ يَعْصِهِ were not really answering the hypothetical`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`تَمَنٍّ (wishing) — لَوْ functions much like لَيْتَ, "if only..."`, `اسْتِفْهام (a question) — genuinely asking for information, not expressing regret over the past`, `تَحْضيض (urging someone to act) — a push toward future action, not a wish about a missed past`, `نَفْي (negation) — flatly denying a fact, without any wishful "if only" sense`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`زَيْدًا is the object of a hidden earlier verb, "explained" by رَأَيْتُهُ afterward — the familiar باب الاشتغال pattern, not a bare noun subject`, `زَيْدًا is actually the فاعل of لَوْ itself, since لَوْ can act as a عامل`, `لَوْ never governs a اسم مؤول, only a اسم صريح — as if باب الاشتغال did not already prove otherwise`, `رَأَيْتُهُ is مبني, so زَيْدًا must be its topic — as if a مبني فعل could not still take a hidden verb's مفعول به before it`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `ʿUmar said of Ṣuhayb: نِعْمَ العَبْدُ صُهَيْبٌ، لَوْ لَمْ يَخَفِ اللهَ لَمْ يَعْصِهِ. Why does the source leave this example's truth open, unlike the repentance example؟`, options: [`Because whether "he would not disobey" traces back only to the missing fear, or to some independent cause like love of Allah, simply isn't settled by the wording`, `Because Ṣuhayb is a fictional character — which would make the whole example moot regardless of شرط or جواب`, `Because the sentence has no جواب at all — as if لَمْ يَعْصِهِ were not really answering the hypothetical`, `Because a شرط can never itself be negated — treating لَمْ يَخَفِ as though it could not legally follow لَوْ here`], correct: 0 },
        { q: `﴿لَوْ نَشاءُ لَجَعَلْناهُ حُطامًا﴾ uses نَشاءُ, a فعل مضارع in form. What tense does لَوْ give it in meaning؟`, options: [`Past/hypothetical — لَوْ flips a مضارع after it into a past-tense meaning`, `Future — treating نَشاءُ as an ordinary مضارع pointing ahead, not flipped by لَوْ`, `Ongoing present — reading نَشاءُ at face value, as an action still in progress`, `Imperative — mistaking the hypothetical مضارع for a command form`], correct: 0 },
        { q: `Comparing ﴿وَلَوْ نَشاءُ لَجَعَلْنا مِنْكُمْ مَلائِكَةً في الأرْضِ يَخْلُفونَ﴾ (with لام) against ﴿لَوْ نَشاءُ أَصَبْناهُمْ بِذُنوبِهِمْ﴾ (without لام), what governs whether لَوْ's affirmative جواب takes the لام؟`, options: [`It tends to appear when الجواب describes a far-fetched outcome, adding emphasis; an ordinary, expected outcome usually goes without it`, `It appears only when الشرط is negated — as if a negated شرط, not a far-fetched جواب, were what triggers the لام`, `It appears only in Qur'anic Arabic, never elsewhere`, `It is required whenever the فعل after لَوْ is مضارع`], correct: 0 },
        { q: `In لَوْ زَيْدًا رَأَيْتُهُ لَأَكْرَمْتُهُ, what is زَيْدًا's actual grammatical role, despite sitting right after لَوْ؟`, options: [`مفعول به for a hidden verb, explained by رَأَيْتُهُ afterward (باب الاشتغال)`, `فاعل لِـ لَوْ — as if لَوْ itself could take a subject the way a verb does`, `مبتدأ لجملة اسمية — as if زَيْدًا simply opened a new nominal sentence on its own`, `توكيد لفظي لِـ لَوْ — as if زَيْدًا just repeated لَوْ's meaning for emphasis`], correct: 0 },
      ...
      bank: [
        ...
        { title: `مثال موسى عليه السلام`, kind: 'mcq', prompt: `In ﴿لَوْ شِئْتَ أَهْلَكْتَهُمْ مِنْ قَبْلُ وَإِيّايَ﴾, what does الشرط (شِئْتَ) tell us happened؟`, options: [`It did not happen — Allah did not will their destruction`, `It happened, and so did الجواب — reading شِئْتَ as a real, completed event rather than a hypothetical`, `It happened, but الجواب did not — as if Allah's willing occurred yet the destruction it implies never followed`, `Neither شرط nor جواب can be identified in this ayah`], correct: 0 },
        { title: `لماذا التعريف الشائع منتقد؟`, kind: 'mcq', prompt: `The traditional definition of لَوْ (امتناع الجواب لامتناع الشرط) is criticized for assuming what؟`, options: [`That الشرط is the only possible cause of الجواب`, `That لَوْ always governs a اسم — ignoring that لَوْ ordinarily requires a فعل directly after it`, `That لَوْ never appears with a negated شرط`, `That الجواب must always carry a لام`], correct: 0 },
        { title: `ابن هشام: ماذا يبقى من التعريف؟`, kind: 'mcq', prompt: `Ibn Hishām's corrected definition keeps two claims about لَوْ. What are they؟`, options: [`الشرط did not occur, and had it occurred الجواب would necessarily have followed`, `الشرط occurred, and الجواب therefore did not`, `Both الشرط and الجواب occurred together — as if لَوْ, like لَوْلا, presupposed الشرط's actual occurrence`, `Neither شرط nor جواب can be determined from لَوْ alone`], correct: 0 },
        ...
        { title: `اللام في جواب لو: متى تكثر؟`, kind: 'mcq', prompt: `The لام that frequently prefixes لَوْ's affirmative جواب tends to appear specifically when؟`, options: [`الجواب describes something far-fetched or unlikely, and the لام adds emphasis`, `الشرط is negated — a negated شرط is unusual enough on its own to justify the extra لام`, `الجواب is a جملة اسمية — a nominal جواب needs the لام to link it back to الشرط`, `لَوْ carries the meaning of تمني — wishing already implies something unlikely, the same flavor the لام marks`], correct: 0 },
        { title: `اللام غائبة: مثال العقاب`, kind: 'mcq', prompt: `﴿لَوْ نَشاءُ أَصَبْناهُمْ بِذُنوبِهِمْ﴾ carries no لام on its جواب. Why not, given that other affirmative جوابات do carry one؟`, options: [`Because punishing wrongdoers for their sins is the expected, unsurprising outcome, needing no special emphasis`, `Because أَصَبْناهُمْ is a فعل أمر — command forms are thought to never combine with the emphatic لام`, `Because الشرط here is negated — a negated شرط is thought to cancel any need for the لام`, `Because this ayah has no جواب at all — with no جواب to attach to, the لام would have nowhere to go`], correct: 0 },
        ...
        { title: `هل للو التمنية جواب؟`, kind: 'mcq', prompt: `Scholars disagree over ﴿فَلَوْ أَنَّ لَنا كَرَّةً فَنَكونَ مِنَ الْمُؤْمِنينَ﴾'s تمني-use of لَوْ. What is the disagreement about؟`, options: [`Whether this لَوْ still needs a جواب, or has become a pure particle of wishing that needs none`, `Whether لَوْ here means "if" or "when" — the two senses would change how the wish is read`, `Whether كَرَّةً is منصوب or مرفوع — its حالة الإعراب shapes what role it plays in the clause`, `Whether the speakers are believers or disbelievers — their identity shapes how sincerely the wish reads`], correct: 0 },
        { title: `لو والاسم بعدها: القاعدة العامة`, kind: 'mcq', prompt: `What does لَوْ ordinarily require directly after it؟`, options: [`فِعْل, not اسم — the ordinary requirement before either exception applies`, `اسم صريح only — never a اسم مؤول standing in its place`, `اسم مؤول only — never a اسم صريح through باب الاشتغال`, `Either a اسم or a فعل, with no preference`], correct: 0 },
        { title: `زيدًا بعد لو: الاشتغال`, kind: 'mcq', prompt: `In لَوْ زَيْدًا رَأَيْتُهُ لَأَكْرَمْتُهُ, زَيْدًا appears right after لَوْ. What is its real grammatical role؟`, options: [`مفعول به for a hidden verb, explained by the visible رَأَيْتُهُ afterward — the باب الاشتغال pattern`, `فاعل مباشر لِـ لَوْ — as if لَوْ itself could govern a following noun the way a verb does`, `مبتدأ لجملة اسمية تامة — as if زَيْدًا opened a full nominal sentence on its own`, `بدل من الفعل رَأَيْتُهُ — as if زَيْدًا simply restated the verb that follows it`], correct: 0 },
        { title: `الاسم المؤول بأنّ بعد لو`, kind: 'mcq', prompt: `In ﴿وَلَوْ أَنَّهُمْ فَعَلوا ما يوعَظونَ بِهِ لَكانَ خَيْرًا لَهُمْ﴾, what is أَنَّهُمْ فَعَلوا ما يوعَظونَ بِهِ analyzed as؟`, options: [`اسم مؤول standing as فاعل for a hidden verb (تقديره: لَوْ ثَبَتَ), مرفوع محلًّا though it shows no visible إعراب marker`, `الجواب of لَوْ — as if أَنَّهُمْ فَعَلوا ما يوعَظونَ بِهِ were the outcome clause, not the trigger`, `فعل الشرط مباشرة — as if the أنّ-clause were simply the ordinary verb لَوْ expects`, `توكيد لفظي لِـ لَوْ — as if the whole أنّ-clause just repeated لَوْ for emphasis`], correct: 0 },
        { title: `الفرق بين الاسم الصريح والمؤول بعد لو`, kind: 'mcq', prompt: `لَوْ زَيْدًا رَأَيْتُهُ لَأَكْرَمْتُهُ places a اسم صريح after لَوْ (via اشتغال); ﴿وَلَوْ أَنَّهُمْ فَعَلوا...﴾ places a اسم مؤول after it. What licenses each one to follow لَوْ, which still requires فعل directly after it؟`, options: [`اسم صريح: object of a hidden verb explained by what follows; اسم مؤول: أنّ + its clause together stand as the فاعل of a hidden verb`, `Both are licensed the exact same way, with no difference`, `اسم صريح is always مرفوع, while اسم مؤول is always منصوب`, `اسم مؤول can only appear with كي, never with لَوْ`], correct: 0 },
        {
          ...
          distractors: [`جواب الشرط غير مقترن باللام`, `فعل الشرط (ماضٍ)`, `حرف شرط جازم`, `فاعل مرفوع`, `مفعول به أول`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`جواب الشرط مقترن باللام`, `فعل الشرط (مضارع بمعنى الماضي)`, `حرف شرط جازم`, `جار ومجرور متعلقان بـِ"جعل"`, `مفعول به منصوب`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`اسم مؤول (أنّ واسمها وخبرها) في محل رفع فاعل لفعل محذوف تقديره ثَبَتَ`, `مفعول به لفعل محذوف`, `فاعل لفعل محذوف يفسره ما بعده`, `حرف شرط جازم`, `اسم مؤول`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`اسم مؤول (أنّ واسمها وخبرها) في محل نصب مفعول به لفعل محذوف تقديره ثَبَتَ`, `مفعول به لفعل محذوف يفسره ما بعده`, `فعل الشرط مباشرة`, `حرف شرط جازم`, `توكيد لفظي`, `خبر مرفوع`],
        },
        {
          ...
          distractors: [`جواب الشرط مقترن باللام`, `فعل الشرط (منفي بما) وفاعله ومفعوله`, `جواب الشرط (غير منفي)`, `حرف شرط جازم`, `فعل الشرط (مضارع بمعنى الماضي)`, `مفعول به منصوب`],
        },
        {
          ...
          distractors: [`جواب الشرط مقترن باللام`, `حرف شرط جازم`, `بدل من الضمير المتصل في "أهلكتهم"`, `ظرف مكان متعلق بـِ"أهلك"`, `تمييز`, `فعل الشرط (مضارع بمعنى الماضي)`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`شرط positive (it did happen) → جواب negative (it was thereby blocked)`, `شرط negative → جواب positive (as if لَوْلا simply mirrored لَوْ's already-negative شرط)`, `Both شرط and جواب positive (as if لَوْلا required nothing to have actually failed)`, `لَوْلا carries no polarity at all (ignoring that امتناع is built into its own name)`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Its خبر, understood as مَوْجود ("exists/is present")`, `Its مبتدأ — without a stated subject, the clause would have nothing for خبر to describe`, `Its فاعل — mistaking the اسمية clause for a فعلية one, which would have a stated فاعل instead`, `The whole clause is omitted, not just one part — as if لَوْلا left no مبتدأ for a خبر to even describe`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مبتدأ of the first, اسمية clause, with its خبر omitted (تقديره موجود)`, `فاعل of زَكٰى — as if فَضْلُ were the one doing the purifying, not the thing preventing its absence`, `جواب الشرط — as if فَضْلُ اللهِ عَلَيْكُمْ were itself the outcome clause, not the trigger for it`, `مفعول به لِـ زَكٰى — as if فَضْلُ were the object زَكٰى acts upon, rather than its subject`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `لَوْلا's polarity is the mirror image of لَوْ's. Which pairing correctly describes لَوْلا؟`, options: [`الشرط is positive (it did happen); الجواب is negative (blocked by that occurrence)`, `الشرط is negative; الجواب is negative — treating لَوْلا exactly like لَوْ`, `الشرط is positive; الجواب is positive — as if الشرط's occurrence only reinforced الجواب, never blocked it`, `Neither شرط nor جواب can be positive or negative with لَوْلا`], correct: 0 },
        ...
        { q: `In ﴿وَلَوْلا فَضْلُ اللهِ عَلَيْكُمْ وَرَحْمَتُهُ ما زَكٰى مِنْكُمْ مِنْ أَحَدٍ أَبَدًا﴾, what is the omitted خبر of the first clause understood to be؟`, options: [`مَوْجود ("exists/is present")`, `كَبيرٌ ("great/considerable")`, `مَعْدومٌ ("nonexistent")`, `مُنْتَفٍ ("negated/absent")`], correct: 0 },
        { q: `How does لَوْما relate to لَوْلا؟`, options: [`It is a less common variant carrying the exact same meaning and two-clause structure`, `It is لَوْلا's negation — as if adding ما reversed the particle's meaning entirely`, `It only applies to poetry, unlike لَوْلا — as if the Qur'anic لَوْما التَّوْفيقُ example did not already contradict this`, `It governs a single فعلية clause with no اسمية clause`], correct: 0 },
      ...
      bank: [
        ...
        { title: `ما تخبرنا به الآية فعليًّا`, kind: 'mcq', prompt: `Because Allah's فضل ورحمة DID exist in ﴿وَلَوْلا فَضْلُ اللهِ عَلَيْكُمْ وَرَحْمَتُهُ ما زَكٰى مِنْكُمْ مِنْ أَحَدٍ أَبَدًا﴾, what does the negated جواب actually tell us happened؟`, options: [`Purification DID occur for people — it was not blocked, precisely because Allah's favor and mercy existed`, `Purification never occurred for anyone — reading الجواب's negation as blocking it outright, favor or no favor`, `Nothing can be concluded about purification — as if the ayah settled only the شرط, not its outcome`, `Purification occurred only for one person — reading أَحَدٍ as naming a specific individual rather than "anyone" in general`], correct: 0 },
        ...
        { title: `لوما: التركيب`, kind: 'mcq', prompt: `لَوْما's two-clause structure matches لَوْلا's exactly. What is that structure؟`, options: [`اسمية بخبر محذوف تقديره موجود، تليها فعلية كجواب الشرط`, `فعلية فقط، بلا جملة اسمية — as if لَوْما dropped the same اسمية half لَوْلا itself requires`, `اسمية فقط، بلا جواب شرط — as if لَوْما's اسمية clause never needed a فعلية جواب to follow it`, `شرط بلا جواب على الإطلاق — as if لَوْما could trigger امتناع with no response clause at all`], correct: 0 },
        { title: `التوفيق: المبتدأ`, kind: 'mcq', prompt: `In لَوْما التَّوْفيقُ لَما عَمِلْنا الصّالِحاتِ, what role does التَّوْفيقُ play؟`, options: [`مبتدأ, with its خبر omitted (تقديره موجود)`, `جواب الشرط — as if التَّوْفيقُ itself named the outcome, not the thing that produced it`, `مفعول به — as if a hidden verb elsewhere in the sentence took التَّوْفيقُ as its object`, `نعت — as if التَّوْفيقُ merely described a preceding noun rather than standing as one`], correct: 0 },
        { title: `التوفيق: ما تعنيه لما عملنا الصالحات`, kind: 'mcq', prompt: `لَما عَمِلْنا الصّالِحاتِ is the negated جواب in لَوْما التَّوْفيقُ لَما عَمِلْنا الصّالِحاتِ. Given التوفيق existed, what does that negated جواب actually mean happened؟`, options: [`They DID do righteous deeds, thanks to التوفيق`, `They did not do any righteous deeds, ever`, `التوفيق itself never occurred — as if the very مبتدأ of the sentence named something absent`, `The sentence cannot be resolved either way`], correct: 0 },
        { title: `تمييز لو عن لولا`, kind: 'mcq', prompt: `Before assigning polarity to شرط and جواب in a sentence, what is the first thing to check؟`, options: [`Which particle is actually being used — لَوْ and لَوْلا carry opposite polarities`, `Whether the sentence is Qur'anic — as if the sentence's source, not the particle itself, decided its polarity`, `Whether the verb is transitive — as if تعدي had any bearing on choosing between لَوْ and لَوْلا`, `Whether the sentence contains a اسم مؤول — a distinction that matters for what follows لَوْ, not for telling لَوْ apart from لَوْلا`], correct: 0 },
        ...
        { title: `لولا مقابل إحدى أخواتها في المعنى`, kind: 'mcq', prompt: `Of the four أحرف الشرط covered across this module (لَوْ، لَوْلا، لَوْما، أَمّا), which two share the identical meaning امتناع الجواب لوجود الشرط؟`, options: [`لَوْلا and لَوْما`, `لَوْ and لَوْلا`, `لَوْ and أَمّا`, `لَوْما and أَمّا`], correct: 0 },
        {
          ...
          distractors: [`حرف امتناع لامتناع الشرط`, `مبتدأ (خبره محذوف تقديره ثابت)`, `معطوف على الخبر`, `جواب الشرط مقترن باللام`, `فاعل مرفوع`, `خبر مرفوع`],
        },
        {
          ...
          distractors: [`حرف امتناع لامتناع الشرط`, `حرف امتناع لوجود الشرط`, `حرف امتناع لوجود الشرط (بمعنى لو)`, `مبتدأ (خبره محذوف تقديره ثابت)`, `بدل`, `جواب الشرط مقترن باللام`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Why أَمّا is analyzed as حَرْفُ تَوْكيد — it compresses a whole "whatever else may be true" clause into one word, adding a layer of certainty`, `Why أَمّا always requires تكرار — repetition is what compresses مَهْما's full background clause into a single word`, `Why أَمّا can never appear with a اسم موصول — pairing with الَّذين would repeat the same compression effect twice over`, `Why أَمّا is classified as حرف جر — the same substitution logic that lets a single particle stand in for a longer phrase`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`خبر مُقَدَّم, with زَيْدٌ as المبتدأ following the فاء`, `مبتدأ, with زَيْدٌ as its خبر — as if في الْبَيْتِ itself named the topic rather than described where زَيْدٌ is`, `جملة شرط بذاتها — as if في الْبَيْتِ itself set up a full conditional clause on its own`, `توكيد لفظي لأمّا — as if في الْبَيْتِ merely repeated أَمّا's own meaning for emphasis`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`تَقْهَرْ — the very verb in الجواب clause after the فاء, making الْيَتيمَ its fronted مفعول به`, `أَمّا itself, which is a عامل نصب — the same حرف already carrying شرط, تفصيل, and توكيد at once`, `فَ, the linking particle — as if the connector itself could assign نصب the way a real عامل does`, `A hidden فعل مضارع, unrelated to تَقْهَرْ — as if the visible نهي verb played no governing role here at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`زَيْدٌ فَمُنْطَلِقٌ: تَوْكيد (not repeated); ثَمود/عاد: تَفْصيل (repeated)`, `زَيْدٌ فَمُنْطَلِقٌ: تَفْصيل; ثَمود/عاد: تَوْكيد`, `Both sentences show تَفْصيل equally — ignoring that only the repeated ثَمود/عاد pairing actually spells out separate detail`, `Both sentences show تَوْكيد equally — ignoring that repetition is what shifts أَمّا toward تَفْصيل instead`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `Sībawayh traces أَمّا زَيْدٌ فَمُنْطَلِقٌ back to مَهْما يَكُنْ مِنْ شَيْءٍ فَزَيْدٌ مُنْطَلِقٌ. What does this analysis explain؟`, options: [`Why أَمّا is analyzed as حَرْفُ تَوْكيد, since it compresses a whole background clause into one word`, `Why أَمّا can never be repeated — repetition would break the single-word compression that creates the emphasis`, `Why زَيْدٌ must always be مرفوع after أَمّا — as if the compressed background clause forced a fixed إعراب on what follows`, `Why أَمّا only appears in poetry — as if Sībawayh's compression were a poetic device rather than ordinary prose grammar`], correct: 0 },
        ...
        { q: `In ﴿فَأَمَّا الْيَتيمَ فَلا تَقْهَرْ﴾, الْيَتيمَ is منصوب even though it sits before the verb that governs it. What governs it؟`, options: [`تَقْهَرْ, the verb inside جواب الشرط after the فاء`, `أَمّا itself — as if the شرط particle could also assign نصب the way a verb does`, `الفاء — as if the linking connector were itself capable of governing case`, `A hidden noun, unrelated to تَقْهَرْ — as if الْيَتيمَ's نصب came from nowhere the sentence actually supplies`], correct: 0 },
        { q: `Given the rule that repetition favors تَفْصيل while a single occurrence favors تَوْكيد, which sense dominates in the single, non-repeated أَمّا زَيْدٌ فَمُنْطَلِقٌ؟`, options: [`تَوْكيد — the sense a single, non-repeated أَمّا is said to favor`, `تَفْصيل — the sense repetition is said to favor instead`, `Both equally, with no dominant sense`, `Neither — a single أَمّا carries no meaning at all`], correct: 0 },
      ],
      bank: [
        ...
        { title: `أمّا الذين آمنوا: المبتدأ`, kind: 'mcq', prompt: `In ﴿أَمَّا الَّذينَ آمَنوا وَعَمِلوا الصّالِحاتِ فَلَهُمْ جَنّاتُ الْمَأْوٰى﴾, what role does الَّذينَ آمَنوا وَعَمِلوا الصّالِحاتِ play؟`, options: [`مبتدأ, with جَنّاتُ الْمَأْوٰى as its خبر after الفاء`, `جواب الشرط بذاته — as if الَّذينَ آمَنوا وَعَمِلوا الصّالِحاتِ were the outcome clause itself, not its subject`, `خبر مقدم — as if the predicate had been fronted ahead of a still-missing subject`, `مفعول به لفعل محذوف — as if some hidden verb governed this phrase as its object`], correct: 0 },
        { title: `أمّا في البيت: الخبر المقدم`, kind: 'mcq', prompt: `In أَمَّا في الْبَيْتِ فَزَيْدٌ, what role does في الْبَيْتِ play, sitting between أَمّا and الفاء؟`, options: [`خبر مقدم, with زَيْدٌ as المبتدأ following الفاء`, `مبتدأ, with زَيْدٌ as its خبر — as if في الْبَيْتِ named the topic rather than described where زَيْدٌ is`, `جملة شرط بذاتها — as if في الْبَيْتِ set up its own conditional clause rather than describing where زَيْدٌ is`, `اسم مؤول بأنّ — as if a hidden أنّ turned the phrase into a noun clause the way it does elsewhere in this lesson`], correct: 0 },
        ...
        { title: `اليتيم: العامل الظاهر`, kind: 'mcq', prompt: `﴿فَأَمَّا الْيَتيمَ فَلا تَقْهَرْ﴾ places a منصوب noun between أَمّا and الفاء. What licenses that نصب؟`, options: [`تَقْهَرْ, the verb inside جواب الشرط, governing الْيَتيمَ as its fronted مفعول به`, `أَمّا itself acting as عامل نصب — the same حرف already carrying شرط, تفصيل, and توكيد at once`, `الفاء acting as عامل نصب — the same رابطة that links أَمّا to its response elsewhere in this lesson`, `A حرف جر hidden before الْيَتيمَ — as if the orphan were the object of a preposition, not a fronted مفعول به`], correct: 0 },
        ...
        { title: `عدم التكرار يرجح التوكيد`, kind: 'mcq', prompt: `أَمّا زَيْدٌ فَمُنْطَلِقٌ uses أَمّا only once. Which meaning does the rule of thumb say should dominate here؟`, options: [`توكيد, while تفصيل fades`, `تفصيل, while توكيد fades`, `Both meanings vanish entirely when أَمّا is not repeated`, `نَفْي, since أَمّا always negates a single occurrence`], correct: 0 },
        {
          ...
          distractors: [`حرف شرط وتوكيد (غير مكررة)`, `حرف شرط مكرر يفيد التفصيل`, `خبر مقدم (شبه جملة)، وهو جواب الشرط`, `فاعل`, `جملة شرط واقعة بين أمّا والفاء`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`حرف شرط وتفصيل وتوكيد`, `حرف شرط مكرر يفيد التفصيل`, `مبتدأ مرفوع`, `خبر مقدم`, `فاعل`, `توكيد لفظي`],
        },
        {
          ...
          distractors: [`حرف شرط وتوكيد (غير مكررة)`, `خبر (جملة فعلية)، وهو جواب الشرط`, `مبتدأ مرفوع`, `نائب فاعل مستقل`, `خبر (جملة فعلية مبنية للمعلوم)، وهو جواب الشرط`, `مضاف إليه`],
        },
        {
          ...
          distractors: [`اسم منصوب بعامل محذوف في الجواب (مفعول به مقدَّم لفعل مقدّر)`, `اسم مرفوع بعامل ظاهر في الجواب (مبتدأ)`, `مبتدأ`, `خبر مقدم`, `جواب الشرط (فعل أمر وفاعله)`, `مضاف إليه`],
        },
        {
          ...
          distractors: [`اسم منصوب بعامل ظاهر في الجواب`, `مبتدأ`, `خبر مقدم (جملة فعلية)`, `مبتدأ مرفوع`, `جواب الشرط منفردًا`, `حال`],
        },
        {
          ...
          distractors: [`اسم منصوب بعامل ظاهر في الجواب`, `خبر مقدم (شبه جملة)`, `مبتدأ`, `خبر لمبتدأ محذوف، وهو جواب الشرط`, `نعت`, `مفعول به`],
        },
      ],
    },
  ],
