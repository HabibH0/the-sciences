  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`إسناد — something judged about something else`, `At least three كلمات — reaching that count alone would make it a جملة`, `تنوين on its last word — the ending mark alone would signal completeness`, `A حرف جر somewhere in it — a single function word would tie the parts together`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Attributing something to it — إسناد, here كبير to البيت`, `Adding تنوين to it — marking it indefinite would already complete the meaning`, `Adding أل to it — turning it into a معرفة would already complete the meaning`, `Repeating the word twice — mere repetition would supply the missing إسناد`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`إياك is مفعول به مقدم, a فضلة; the true عمدة is the فعل نعبد with its فاعل مستتر`, `إياك is itself a فعل — it carries the meaning of نعبد's action`, `نعبد is فضلة, not إياك — the true عمدة is إياك alone`, `The جملة is actually اسمية here — إياك, an اسم, still opens and governs it`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `إِنَّ اللهَ غَفُورٌ رَحِيمٌ has a ناسخ, إنّ, entering upon it. Is the جملة still جملة اسمية?`, options: [`Yes — its underlying core الله غفور رحيم is اسمي, and على الأصح a ناسخ does not decide the classification`, `No — any جملة with a ناسخ is جملة فعلية, since a ناسخ always overrides the underlying core`, `No — إنّ turns it into جملة شرطية, the way other حروف مشبهة بالفعل do`, `Yes, but only because إنّ carries تنوين`], correct: 0 },
        { q: `In إِيَّاكَ نَعْبُدُ, why is the جملة classified as فعلية even though إياك, an اسم, opens it?`, options: [`إياك is a فضلة (مفعول به مقدم); the true عمدة is the فعل نعبد with its فاعل مستتر`, `إياك itself is a فعل — it carries the meaning of نعبد's action`, `نعبد is فضلة, not إياك — the true عمدة is إياك alone`, `إياك carries تنوين, which forces فعلية`], correct: 0 },
      ],
      bank: [
        ...
        { title: `فضلة لا تعني عديمة الفائدة`, kind: 'mcq', prompt: `فضلة is sometimes misunderstood as meaning "useless." What does it actually mean?`, options: [`Anything outside العمدة — it may matter for meaning, but is not part of the minimum جملة structure`, `A word that has no meaning at all — فضلة would then be pure filler, contributing nothing`, `A word that cannot be مجرور — a restriction on its إعراب, not on its role`, `Any حرف in the جملة — every حرف would count as فضلة regardless of its function`], correct: 0 },
        { title: `حذف أحد الركنين`, kind: 'mcq', prompt: `Someone asks هَلْ أَكَلْتَ؟ and the answer is simply لا. Does that mean the answer has no مسند?`, options: [`No — the fuller meaning لَمْ آكُلْ is understood; the مسند is supplied by context, not removed as a requirement`, `Yes — لا alone is a complete جملة with no مسند needed anywhere`, `No — لا is itself the مسند, standing in for the whole dropped clause`, `Yes, because الجملة never needs a مسند`], correct: 0 },
        { title: `بيت وحده`, kind: 'mcq', prompt: `بَيْتٌ, said alone, names a thing but makes no judgement about it. What does it need to become a full جملة?`, options: [`إسناد — something attributed to it, as in البيت كبير`, `تنوين — an ending mark, not a judgment made about the word`, `أل التعريف — definiteness alone, without anything predicated of it`, `النداء — calling out to it, not attributing anything to it`], correct: 0 },
        ...
        { title: `لماذا تُسمى نواسخ`, kind: 'mcq', prompt: `إنّ, كان, and similar words are called نواسخ. Why?`, options: [`Because they enter upon a جملة اسمية and affect its grammatical state`, `Because they always open a جملة فعلية`, `Because they cannot enter upon a جملة اسمية`, `Because they carry تنوين, a mark other حروف مبنية never take`], correct: 0 },
        ...
        { title: `ما هذا بشرا: التصنيف`, kind: 'mcq', prompt: `In مَا هَذَا بَشَرًا, ما acts like a ناسخ resembling ليس, yet the core جملة begins with هذا. How is the جملة classified?`, options: [`جملة اسمية — the underlying core opens with an اسم`, `جملة فعلية — ما counts as the opening element`, `جملة شرطية — ما is read here as أداة شرط`, `Neither — ما هذا بشرا has no إسناد at all`], correct: 0 },
        { title: `وكان الله عليما حكيما: التصنيف`, kind: 'mcq', prompt: `In وَكَانَ اللهُ عَلِيمًا حَكِيمًا, كان is a فعل and a ناسخ, yet the جملة is treated as اسمية. Why?`, options: [`The underlying core الله عليم حكيم is اسمي, and a ناسخ does not decide the classification`, `Because كان never opens a real جملة`, `Because عليما carries تنوين, the mark that decides اسمية regardless of كان`, `Because حكيما is فضلة, and a فضلة never counts toward the classification`], correct: 0 },
        { title: `إياك نعبد: لماذا فعلية رغم افتتاحها باسم`, kind: 'mcq', prompt: `إِيَّاكَ نَعْبُدُ opens with the اسم إياك, yet it is classified as جملة فعلية. What is إياك's actual role?`, options: [`مفعول به مقدم — a fronted فضلة, not العمدة`, `مسند إليه — a plain اسم, since it opens the جملة`, `ناسخ — a governing word entering upon the جملة`, `مسند — the judgment made about إياك`], correct: 0 },
        ...
        { title: `وإن أحد من المشركين استجارك: العامل المحذوف`, kind: 'mcq', prompt: `In وَإِنْ أَحَدٌ مِنَ المُشْرِكِينَ اسْتَجَارَكَ, أحد appears right after إن, yet the جملة is still فعلية. What explains this?`, options: [`A فعل محذوف (وَإِنِ اسْتَجَارَكَ أَحَدٌ) is understood right after إن`, `أحد itself functions as a فعل here`, `إن is not really an أداة شرط in this آية`, `استجارك is فضلة and does not count`], correct: 0 },
        {
          ...
          distractors: [`مسند إليه / فاعل`, `مسند / فعل`, `فضلة / مفعول به`, `مفعول به مقدم / فضلة`, `اسم إن`, `خبر إن`],
        },
        {
          ...
          distractors: [`مسند إليه / مبتدأ`, `مسند / خبر`, `مفعول به مقدم / فضلة`, `فعل + فاعل مستتر`, `فاعل مرفوع`, `فاعل`],
        },
        {
          ...
          distractors: [`مسند إليه / مبتدأ`, `مسند / خبر`, `مفعول به مقدم / فضلة`, `فعل + فاعل مستتر`, `اسم إن`, `خبر إن`],
        },
        {
          ...
          labels: [`مسند إليه / مبتدأ`, `مسند / خبر`],
          distractors: [`مسند / فعل`, `مسند إليه / فاعل`, `فعل + فاعل مستتر`, `اسم إن`, `خبر إن`, `نعت`],
        },
        {
          ...
          distractors: [`مبتدأ`, `خبر`, `مسند إليه / مبتدأ`, `مسند / خبر`, `حرف مشبّه بالفعل`, `اسم إن منصوب`],
        },
        {
          ...
          distractors: [`مسند إليه / مبتدأ`, `مسند / خبر`, `فضلة / مفعول به منصوب`, `مسند إليه / فاعل`, `اسم إن`, `خبر إن`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — خبرية only requires the statement to be the kind that can be judged صدقا أو كذبا, not that its truth be in doubt`, `Yes — a statement that is certainly true is إنشائية, not خبرية, since nothing remains to be judged`, `Yes — only false statements count as خبرية, since a true one needs no judging`, `No, because الله واحد contains no إسناد`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`إنشائية — استفهام, asking a question rather than making a report`, `خبرية — it can still be judged صادقة`, `إنشائية — نداء, calling out to someone rather than reporting anything`, `خبرية — استفهام is a kind of إخبار`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`خبرية — it now reports something, even though the report is كاذبة`, `It stays إنشائية, since the words are almost the same`, `It becomes a جملة شرطية — the dropped همزة is read as an implied إن`, `It becomes a جملة صغرى — it now sits inside a larger جملة`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`خبر شديد — whoever deliberately lies against the Messenger will take his place in the Fire`, `A genuine أمر inviting the listener to sit in the Fire, extended by لام الأمر`, `استفهام about who among them deserves to sit in the Fire`, `دعاء asking Allah to spare the speaker from the Fire`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`يعلم is جملة صغرى; والله يعلم is جملة كبرى`, `يعلم is جملة كبرى; والله يعلم is جملة صغرى`, `Both are جملة كبرى — as though neither ever stood inside the other`, `Both are جملة صغرى — as though والله يعلم itself filled a single word's position`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `الله واحد is certainly true. Does that remove it from الجملة الخبرية?`, options: [`No — خبرية only requires the statement to be the kind judged صدقا أو كذبا`, `Yes — certain truths are إنشائية, since nothing remains to be judged`, `Yes — only false statements are خبرية, since a true one needs no judging`, `No, because الله واحد lacks إسناد`], correct: 0 },
        { q: `أَإِلَهٌ مَعَ اللهِ performs استفهام. Which category of الجملة is that?`, options: [`إنشائية`, `خبرية`, `شرطية`, `كبرى`], correct: 0 },
        { q: `فَلْيَتَبَوَّأْ مَقْعَدَهُ مِنَ النَّارِ is إنشاء in its wording (لام الأمر) but خبر in meaning. What does it actually communicate?`, options: [`A stern warning — whoever lies against the Messenger will take his place in the Fire`, `A genuine invitation to sit in the Fire, extended by لام الأمر`, `A question about who among them deserves to sit in the Fire`, `A supplication asking that he be spared the Fire`], correct: 0 },
      ...
      bank: [
        ...
        { title: `خبرية لا تعني صادقة`, kind: 'mcq', prompt: `A false mathematical statement still gives إخبارا that can be judged. What category does that make it, despite being false?`, options: [`خبرية — it still gives إخبارا that can be judged, whether true or false`, `إنشائية — as if false statements no longer report anything at all`, `لا شيء — false statements have no category`, `صغرى — as if it were tucked inside a larger جملة`], correct: 0 },
        ...
        { title: `إلغاء الهمزة يغيّر التصنيف`, kind: 'mcq', prompt: `أَإِلَهٌ مَعَ اللهِ is إنشائية. Drop only its همزة الاستفهام — what does the resulting جملة إِلَهٌ مَعَ اللهِ become?`, options: [`خبرية — it now reports something, even though the report is كاذبة`, `It stays إنشائية — dropping one حرف does not change what the speaker is doing`, `It becomes شرطية — إِلَهٌ مَعَ اللهِ now reads as a condition`, `It becomes صغرى — it now sits inside a larger جملة`], correct: 0 },
        { title: `إياك نعبد: خبرية رغم التقديم`, kind: 'mcq', prompt: `إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ fronts إياك for emphasis. Does that fronting make the جملة إنشائية?`, options: [`No — it still gives information (worship and help belong to Allah alone), so it stays خبرية`, `Yes — fronting always makes a جملة إنشائية, since it shifts focus onto the fronted word`, `Yes — إياك is itself an إنشاء particle, marking emphasis rather than report`, `No, because إياك نعبد has no مسند`], correct: 0 },
        { title: `اللفظ والمعنى قد يختلفان`, kind: 'mcq', prompt: `الحَمْدُ لِلَّهِ is خبر in its wording. What can it also perform in meaning?`, options: [`إنشاء — by expressing praise`, `نهي — by forbidding رفع الصوت instead of praising`, `استفهام — by questioning God's right to praise instead of stating it`, `قسم — by swearing on الحمد instead of reporting it`], correct: 0 },
        { title: `فليتبوأ: اللفظ إنشاء والمعنى خبر`, kind: 'mcq', prompt: `فَلْيَتَبَوَّأْ مَقْعَدَهُ مِنَ النَّارِ carries لام الأمر, marking إنشاء in its wording. What is its meaning instead?`, options: [`خبر — a stern report that he will take his place in the Fire`, `A literal command to sit in the Fire`, `استفهام about who among them deserves to sit in the Fire`, `تمني asking that the Fire be spared for him`], correct: 0 },
        ...
        { title: `تصنيف مستقل عن الاسمية/الفعلية والخبرية/الإنشائية`, kind: 'mcq', prompt: `Classifying a جملة as كبرى or صغرى asks a different question than classifying it as اسمية/فعلية or خبرية/إنشائية. What question does كبرى/صغرى ask instead?`, options: [`Whether one جملة is contained inside another`, `Whether the جملة opens with an اسم or a فعل`, `Whether the speaker can be judged truthful or false`, `Whether a ناسخ has entered the جملة`], correct: 0 },
        {
          ...
          distractors: [`جملة اسمية في محل رفع خبر`, `جملة فعلية في محل نصب خبر`, `خبر`, `حرف عطف`, `مسند إليه / مبتدأ`, `اسم إن`],
        },
        {
          ...
          words: [`اللهُ`, `عَلِيمٌ`],
          labels: [`مبتدأ`, `خبر`],
          distractors: [`جملة فعلية في محل رفع خبر`, `مسند إليه / مبتدأ`, `مسند / خبر`, `اسم إن`, `خبر إن`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`مسند إليه / مبتدأ`, `مسند / خبر`, `مسند إليه / فاعل`, `فضلة / مفعول به منصوب`, `حرف`, `اسم إن`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`تغليب — the name was extended from عند/فوق and في/على to the whole جار ومجرور class`, `لام, كاف, and رب are themselves originally ظروف — the extension runs the other way`, `The term ظرف only ever applied to حروف جر — عند and فوق never carried the name`, `It is a scribal error repeated across grammar books — not a deliberate تغليب at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A جار ومجرور needs a متعلَّق the way a ظرف needs a مظروف — a shared structural need`, `A جار ومجرور always denotes زمان — time, specifically, not mere attachment`, `A جار ومجرور can never appear without a ظرف beside it — the two must always co-occur`, `الجار والمجرور is historically the older term — ظرف was borrowed from it, not the reverse`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `عِنْدَ, فَوْقَ, تَحْتَ, and خَلْفَ are used as ظروف. What are they grammatically?`, options: [`أسماء, and what follows them is مضاف إليه`, `حروف جر, and what follows them is مجرور`, `أفعال — words that themselves carry a زمان`, `حروف عطف — links joining one word to another`], correct: 0 },
        { q: `Why is a جار ومجرور loosely called ظرف, even though لام, كاف, and رُبَّ carry no ظرفية at all؟`, options: [`تغليب — the name عند/فوق's ظرفية was extended to the whole class once في/على showed the same sense`, `Because ظرف is the only term grammar has for any حرف جر`, `Because لام, كاف, and رب are themselves ظروف — the extension runs the other way`, `Because a جار ومجرور always denotes مكان, the core sense of ظرفية`], correct: 0 },
        { q: `What second reason is given for naming جار ومجرور a ظرف؟`, options: [`It needs a متعلَّق the way a ظرف needs a مظروف`, `It always denotes زمان — time alone, never a structural need for a متعلَّق`, `It cannot appear without a real ظرف nearby`, `It shares the same حروف as النداء`], correct: 0 },
      ...
      bank: [
        ...
        { title: `الذي عندك: الصلة`, kind: 'mcq', prompt: `الَّذِي عِنْدَكَ needs a صلة for اسم الموصول الذي. What does عندك supply, given it is not a full جملة in outward form؟`, options: [`A شبه الجملة standing in the position الصلة requires`, `A جملة فعلية عادية — a normal verbal جملة, opening with a فعل`, `A جملة اسمية منسوخة — a nominal جملة with a ناسخ entered upon it`, `A مسند إليه فقط — only half of الإسناد, with nothing predicated of it`], correct: 0 },
        ...
        { title: `عند وفوق وتحت وخلف: ليست حروف جر`, kind: 'mcq', prompt: `عند, فوق, تحت, and خلف behave as ظروف. Grammatically, what are they؟`, options: [`أسماء, taking a مضاف إليه after them`, `حروف جر, taking a مجرور after them`, `أفعال — words that themselves carry a زمان`, `حروف عطف — links joining one word to another`], correct: 0 },
        ...
        { title: `المتعلَّق: التفسير الثاني`, kind: 'mcq', prompt: `What second reason, besides تغليب, is offered for calling جار ومجرور a ظرف؟`, options: [`It needs a متعلَّق, just as a ظرف needs a مظروف`, `It is always مبني — its case never actually changes`, `It can only appear after a فعل تام`, `It shares the same إعراب as النداء`], correct: 0 },
        { title: `شبه الجملة ليست جملة كاملة`, kind: 'mcq', prompt: `Is شبه الجملة itself a complete جملة, in the sense defined in the previous lesson (containing مسند ومسند إليه)؟`, options: [`No — it is not a full جملة, though it may stand where a جملة-like meaning is needed`, `Yes — every شبه الجملة is itself a complete جملة, since it still names something happening`, `Yes, but only when it contains a ناسخ`, `No — it is always the same as الجملة الصغرى, since both sit inside a larger structure`], correct: 0 },
        ...
        { title: `الكعبة: مضاف إليه لا مجرور بحرف`, kind: 'mcq', prompt: `In عِنْدَ الكَعْبَةِ, why is الكَعْبَةِ مجرورة, given that عند is not a حرف جر؟`, options: [`Because it is مضاف إليه to الظرف عند, not مجرورة by a حرف جر`, `Because عند secretly functions as حرف جر here, despite behaving like a ظرف`, `Because الكعبة always carries كسرة regardless of context, the way a diptote never would`, `Because الكعبة is مبني, so its case never changes regardless of what governs it`], correct: 0 },
        { title: `تمييز شبه الجملة عن العمدة`, kind: 'mcq', prompt: `Is شبه الجملة itself normally part of العمدة (مسند/مسند إليه) of a جملة؟`, options: [`Not necessarily — it commonly appears as فضلة, attached to a governing element elsewhere in the جملة`, `Yes — شبه الجملة is always the مسند, since it supplies the judgment made about the subject`, `Yes — شبه الجملة is always the مسند إليه, since it is what the judgment is about`, `شبه الجملة never appears inside a جملة at all — it only ever stands alone`], correct: 0 },
        { title: `مقارنة النوعين بالبنية`, kind: 'mcq', prompt: `فِي مَكَّةَ uses a حرف جر; عِنْدَ الكَعْبَةِ uses an اسم ظرف. What is the key structural difference between the two types of شبه الجملة؟`, options: [`One begins with a حرف جر and ends in مجرور بالحرف; the other begins with an اسم ظرف and ends in مضاف إليه`, `Both always begin with a فعل — the difference lies only in what follows it`, `One is إنشائية and the other is خبرية — a difference of meaning, not of structure`, `One is اسمية and the other فعلية — a difference that belongs to الجملة, not شبه الجملة`], correct: 0 },
        {
          ...
          words: [`فِي`, `مَكَّةَ`],
          labels: [`جار`, `مجرور`],
          distractors: [`ظرف`, `مضاف إليه`, `جار ومجرور`, `حرف جر`, `مجرور بحرف الجر`, `فضلة`],
        },
        {
          ...
          distractors: [`جار`, `مجرور`, `ظرف ومضاف إليه`, `حرف جر`, `مجرور بحرف الجر`, `فضلة`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — the meaning demands the one particular verb أرسلنا, so الظرف still counts as لغو`, `Yes — any general word can replace it without changing the meaning`, `No — the شبه الجملة becomes ظرف مستقر once the عامل is omitted`, `Yes, because عامل محذوف is always general, never tied to one specific verb`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A ضمير مستتر returning to a مبتدأ, صاحب حال, منعوت, or موصول`, `A تنوين attached to the شبه الجملة, marking it definite`, `A حرف جر attached to the شبه الجملة`, `A فعل مذكور before it, governing the شبه الجملة directly`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A specific, omitted عامل such as أقسم — still ظرف لغو`, `A general omitted عامل such as ثبت — ظرف مستقر`, `No عامل at all is needed for a قسم — القسم requires no governing element`, `الفعل تفتأ itself is the عامل of تَلَفْظِ الجَلالَةِ — the visible verb governs it directly`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`ظرف مستقر, working as حال — describing the state he was in`, `ظرف لغو, like على قومه — attached to the mentioned فعل خرج`, `Neither — في زينته has no عامل at all`, `اسم مؤول — a noun clause reinterpreted from إن and its جملة`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `الظرف اللغو is described as free of a certain hidden element. What is it؟`, options: [`A ضمير مستتر returning to a مبتدأ, صاحب حال, منعوت, or موصول`, `A تنوين — an ending mark, not a hidden pronoun`, `A حرف عطف — a linking word, not something returning to a noun`, `A ناسخ — a governing word, not a pronoun tucked inside`], correct: 0 },
      ...
      bank: [
        ...
        { title: `الظرف اللغو: العامل مذكور`, kind: 'mcq', prompt: `الظرف اللغو is defined by what kind of عامل؟`, options: [`An عامل that is mentioned, or omitted but specific enough to be understood`, `An عامل that is always omitted and general, never mentioned at all`, `No عامل at all — الظرف اللغو would then need nothing to attach to`, `An عامل that is always an اسم, never a فعل or حرف`], correct: 0 },
        { title: `وإلى عاد أخاهم هودا: العامل المحذوف المخصوص`, kind: 'mcq', prompt: `In وَإِلَى عَادٍ أَخَاهُمْ هُودًا, the عامل of إلى عاد is omitted. Is it general or specific؟`, options: [`Specific — understood as أرسلنا, the one particular verb the meaning demands`, `General — any verb of وجود could replace it`, `There is no omitted عامل here at all — nothing needs to be understood`, `It is مذكور, not محذوف — the verb أرسلنا is actually stated in the آية`], correct: 0 },
        ...
        { title: `معنى لغو هنا`, kind: 'mcq', prompt: `لغو in الظرف اللغو does not mean "useless." What does it mean instead؟`, options: [`Free of the hidden ضمير مستتر found with الظرف المستقر`, `Free of any عامل whatsoever, mentioned or understood`, `Grammatically incorrect — a mistake grammarians tolerate for convenience`, `Limited to poetry only — a usage never found in ordinary speech`], correct: 0 },
        ...
        { title: `الظرف المستقر: العامل عام ومحذوف دائما`, kind: 'mcq', prompt: `How does الظرف المستقر فيه differ from الظرف اللغو in terms of its عامل؟`, options: [`Its عامل is always omitted and general, never mentioned like الظرف اللغو can be`, `Its عامل is always mentioned explicitly — never left for the listener to supply`, `It has no عامل at all — the شبه الجملة stands with nothing governing it`, `Its عامل is always specific, like الظرف اللغو's, and can be stated outright`], correct: 0 },
        ...
        { title: `الضمير داخل الظرف المستقر`, kind: 'mcq', prompt: `The omitted general عامل of الظرف المستقر contains an understood ضمير. What does that ضمير refer back to؟`, options: [`The relevant اسم الشبه الجملة is connected to`, `A ناسخ mentioned earlier in the جملة`, `الحرف الجر itself — the preposition supplies its own referent`, `Nothing — العامل has no ضمير`], correct: 0 },
        { title: `وهو على صراط مستقيم: أين الخبر بالضبط`, kind: 'mcq', prompt: `In وَهُوَ عَلَى صِرَاطٍ مُسْتَقِيمٍ, saying loosely "the جار ومجرور is الخبر" skips a step. What is the more precise account؟`, options: [`الجار والمجرور attaches to an omitted عامل such as ثابت, and the whole understood structure fills الخبر position`, `هو is not really المبتدأ here — the شبه الجملة itself opens the جملة`, `على صراط مستقيم is actually المبتدأ — it names what the جملة is about`, `There is no خبر at all in this جملة — هو alone would leave the meaning incomplete`], correct: 0 },
        ...
        { title: `فخرج على قومه في زينته: نوعان في آية واحدة`, kind: 'mcq', prompt: `فَخَرَجَ عَلَى قَوْمِهِ فِي زِينَتِهِ contains two شبه جملة, and على قومه attaches to the mentioned فعل خرج. What type is في زينته instead, describing his state؟`, options: [`ظرف مستقر, working as حال — describing the state he was in`, `ظرف لغو, exactly like على قومه — attached to the mentioned فعل خرج`, `Neither — في زينته has no عامل governing it at all`, `اسم مؤول — a noun clause reinterpreted from إن and its جملة`], correct: 0 },
        { title: `لا يكفي القول متعلق`, kind: 'mcq', prompt: `According to the lesson's caution, what is missing if someone only says "الجار والمجرور متعلق" without going further؟`, options: [`The specific grammatical role — خبر, نعت, حال, صلة, مفعول فيه, or another function`, `Nothing — that description is already complete on its own`, `The vowel ending of the مجرور, not its grammatical role`, `Whether الشبه الجملة is جار ومجرور or ظرف ومضاف إليه`], correct: 0 },
        {
          ...
          distractors: [`ظرف مستقر متعلق بعامل عام محذوف`, `عامل محذوف مخصوص`, `ظرف مستقر`, `فاعل`, `مضاف إليه`, `جار ومجرور`],
        },
        {
          ...
          distractors: [`ظرف لغو متعلق بعامل عام محذوف`, `ظرف لغو متعلق بالفعل`, `عامل مذكور`, `خبر إن`, `ظرف لغو`, `مفعول به`],
        },
      ],
    },
    // ---------------------------------------------------------------- L5
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Speech such that the listener is not left waiting for more meaning`, `Speech that is grammatically صحيح — free of any إعراب mistake`, `Speech containing a ناسخ — a إنّ or كان entering upon it`, `Speech that is صادقة — a report that happens to be true`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — it only becomes complete كلام once الجواب is added, as in إِنْ تَصْدُقْ تَنْجُ`, `Yes — إن تصدق is already complete كلام on its own, since تصدق already names an action`, `Yes, because تصدق is a فعل مضارع, and مضارع already names an ongoing action`, `No, because إن تصدق contains no مسند إليه at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — a جملة may have إسناد yet still fail to give a complete benefit, so it does not always meet the stricter condition كلام adds`, `Yes — الكلام and الجملة name exactly the same thing, since both require إسناد`, `No — every جملة is كلام except when it starts with a فعل`, `Yes, as long as the جملة contains a ناسخ, which supplies the missing completeness`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `مفيد is defined as ما يحسن السكوت عليه. What does that mean؟`, options: [`The listener is not left waiting for the rest of the meaning`, `The speech must be صادقة — a report that happens to be true`, `The speech must contain a ناسخ — a إنّ or كان entering upon it`, `The speech must be الجملة الفعلية — opening with a فعل rather than an اسم`], correct: 0 },
        { q: `إِنْ تَصْدُقْ alone leaves the listener waiting for جواب الشرط. Is it complete كلام?`, options: [`No — it becomes complete only once الجواب is added, as in إِنْ تَصْدُقْ تَنْجُ`, `Yes, it is already complete كلام, since تصدق already names an action`, `Yes, because تصدق is مضارع, and مضارع already names an ongoing action`, `No, because it lacks a مسند إليه of its own to complete the judgment`], correct: 0 },
        { q: `Is every جملة also كلام؟`, options: [`No — a جملة may have إسناد and still fail to give a complete benefit`, `Yes — الجملة and الكلام mean exactly the same thing, since both require إسناد`, `No — الكلام is always broader than الجملة, covering every جملة and more besides`, `Yes, as long as the جملة contains a فعل`], correct: 0 },
      ...
      bank: [
        ...
        { title: `صدقت: كلام تام`, kind: 'mcq', prompt: `صَدَقْتَ is a single word, and the speaker can stop there with the meaning fully understood. Is it complete كلام؟`, options: [`Yes — the listener is not left waiting for anything more`, `No — a single word can never be كلام, however clear the context`, `No — it needs a جواب to be complete, the way a شرط does`, `Yes, but only in poetry, where a single word can carry a whole line's meaning`], correct: 0 },
        ...
        { title: `ليس كل جملة كلاما`, kind: 'mcq', prompt: `إِنْ تَصْدُقْ contains إسناد (تصدق implies a فاعل), so it counts as جملة. Is it also كلام by itself؟`, options: [`No — it has إسناد but does not give a complete benefit, so it fails to be كلام on its own`, `Yes — anything with إسناد is automatically كلام, since إسناد is the only thing كلام requires`, `No, because it has no إسناد at all, so nothing is even predicated`, `Yes, because تصدق is فعل مضارع, and every فعل مضارع already completes the meaning`], correct: 0 },
        { title: `الكلام أخص من الجملة`, kind: 'mcq', prompt: `What is the relationship between الكلام and الجملة؟`, options: [`الكلام has a stricter condition than الجملة — it must be structured and complete in meaning`, `الكلام and الجملة are unrelated terms — two separate classifications with no overlap`, `الجملة has a stricter condition than الكلام — the reverse of the actual relationship`, `They apply only to الجملة الفعلية — neither term reaches الجملة الاسمية`], correct: 0 },
        ...
        { title: `صدقت: كلمة واحدة تكفي`, kind: 'mcq', prompt: `صَدَقْتَ is complete كلام in a single word. What does that show about the relationship between length and إفادة؟`, options: [`A single word can already be مفيد if the listener needs nothing further`, `إفادة always requires at least two كلمات — one word alone is never enough`, `إفادة requires a مسند إليه separate from الفعل — the hidden فاعل inside صدقت would not count`, `صدقت is not really a single كلمة — it is understood as a hidden phrase`], correct: 0 },
        { title: `مراجعة: الكلام مقابل الجملة`, kind: 'mcq', prompt: `صَدَقْتَ and إِنْ تَصْدُقْ both contain إسناد, so both count as جملة. Which one also counts as كلام؟`, options: [`صَدَقْتَ only — its meaning is complete; إِنْ تَصْدُقْ still waits for جواب الشرط`, `Both count equally as كلام — completeness never actually enters the test`, `إِنْ تَصْدُقْ only — its شرط structure alone marks it complete`, `Neither counts as كلام — إسناد alone is never enough for either`], correct: 0 },
        {
          ...
          distractors: [`لا النافية`, `فعل مضارع مرفوع`, `فعل ماضٍ`, `ظرف لغو متعلق بالفعل`, `لا الزائدة`, `مضاف إليه`],
        },
      ],
    },
  ],
