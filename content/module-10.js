...
export default {
  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مكان — الدنيا والآخرة name the two settings حسنة is asked for in`, `زمان — الدنيا والآخرة name two points in time`, `Neither — the phrase carries no مفعول فيه at all`, `Both at once, indistinguishably — في never actually splits between the two`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          heading: 'في للمقايسة',
          lines: [
            { html: `A further use of في marks neither مكان, زمان, nor any of the roles above.`, list: false },
      ...
      quiz: [
        { q: `في is the seventh of the thirteen حروف الجر. What is its root meaning?`, options: [`الظرفية — one thing settling inside another`, `الإلصاق — one thing attached to another`, `التشبيه — drawing a likeness`, `انتهاء الغاية — reaching an endpoint`], correct: 0 },
        ...
        { q: `﴿شَهْرُ رَمَضَانَ الَّذِي أُنْزِلَ فِيهِ الْقُرْآنُ﴾: is فِيهِ here مفعول فيه للمكان or للزمان؟`, options: [`للزمان — it names the time within which الإنزال took place`, `للمكان — it names where the Qur'an was revealed`, `Neither — فيه here carries تعليل`, `Both at once, with no way to tell which is meant`], correct: 0 },
        ...
        { q: `في للمقايسة keeps a fixed word order — مَفْضُول before في, فَاضِل after. In ﴿فَمَا مَتَاعُ الْحَيَاةِ الدُّنْيَا فِي الْآخِرَةِ إِلَّا قَلِيلٌ﴾, which word is the مفضول؟`, options: [`متاع الحياة الدنيا — the lesser of the two, coming before في`, `الآخرة — the lesser of the two, though it actually comes after في`, `قليل — the lesser of the two, though it only appears after إلا`, `Neither word is مفضول here, since both name the same thing`], correct: 0 },
      ],
      bank: [
        { title: `في: المعنى الأصلي`, kind: 'mcq', prompt: `What is the root meaning shared by every use of في?`, options: [`الظرفية — حلول الشيء في غيره`, `الإلصاق — one thing attached to another`, `المجاوزة — passing beyond something, the sense carried by عن`, `ابتداء الغاية — marking the starting point of a journey`], correct: 0 },
        ...
        { title: `دخلت امرأة النار في هرة: نفس الدور`, kind: 'mcq', prompt: `دَخَلَتِ امْرَأَةٌ النَّارَ فِي هِرَّةٍ, "a woman entered the Fire because of a cat." What role does في هرة play?`, options: [`مفعول له غير صريح — it gives the reason for her punishment, not its location`, `مفعول فيه للمكان — it names where she was punished`, `مفعول به — it names the direct object of دخلت`, `حال — it describes the woman's state while entering`], correct: 0 },
        { title: `فادخلي في عبادي: مفعول معه`, kind: 'mcq', prompt: `﴿فَادْخُلِي فِي عِبَادِي﴾, addressed to النفس المطمئنة, is read by some with في carrying the sense of مَعَ. What does that reading picture?`, options: [`The entry into Paradise happening alongside the company of the righteous, not merely into a place among them`, `A location distinct from where the righteous are, entered separately rather than together`, `A reason for the entry, explaining why النفس is granted the reward`, `A comparison between the النفس and العباد, likening one's arrival to theirs`], correct: 0 },
        ...
        { title: `متاع الدنيا في الآخرة: مفضول وفاضل`, kind: 'mcq', prompt: `﴿فَمَا مَتَاعُ الْحَيَاةِ الدُّنْيَا فِي الْآخِرَةِ إِلَّا قَلِيلٌ﴾: which word is فاضل, the greater of the two things compared?`, options: [`الآخرة — the greater of the two, coming after في`, `متاع الحياة الدنيا — the greater of the two, though it actually comes before في`, `قليل — the greater of the two, though it only appears after إلا`, `Neither — both are مفضول`], correct: 0 },
        { title: `حديث القطرة والبحر: نفس البنية`, kind: 'mcq', prompt: `A حديث compares all human knowledge to a single drop a bird carries from the ocean, measured against Allah's knowledge. What kind of في use does this illustrate?`, options: [`في للمقايسة, the same مفضول/فاضل pattern as متاع الدنيا في الآخرة`, `في للظرفية المكانية — placing the comparison at a literal location`, `في للمصاحبة — describing something happening alongside another`, `في للتعليل — giving the reason for the comparison`], correct: 0 },
        ...
        { title: `في vs إلى: لماذا لا تتبادلان دائما`, kind: 'mcq', prompt: `يُسَارِعُونَ فِي الْخَيْرَاتِ and يُسَارِعُونَ إِلَى الْخَيْرَاتِ are both grammatical, yet the choice between في and إلى is not arbitrary. Why?`, options: [`Each particle pictures a different starting position for the subjects — already inside vs. still approaching`, `إلى is ungrammatical after يسارع, forcing في as the only valid choice`, `في can never be followed by a plural noun`, `The two particles are always fully interchangeable with no difference at all`], correct: 0 },
        ...
        { title: `في: خلاصة الأدوار الستة`, kind: 'mcq', prompt: `Across its uses, في ومجرورها can stand for مفعول به, مفعول فيه (مكان أو زمان), مفعول له, مفعول معه, or المقايسة. What determines which role applies in a given sentence?`, options: [`The surrounding context and the meaning of the verb or expression في attaches to`, `The number of letters in في's مجرور`, `Whether في is written with or without تنوين`, `Whether the sentence is قرآن or حديث`], correct: 0 },
        {
          ...
          distractors: [`في ومجرورها: مفعول فيه للمكان`, `في ومجرورها: مفعول فيه للزمان`, `في ومجرورها: مفعول له`, `في ومجرورها: مفعول معه`, `في ومجرورها: للمقايسة`, `فعل ماضٍ وفاعله`],
        },
        {
          ...
          distractors: [`في ومجرورها: مفعول فيه للزمان`, `في ومجرورها: مفعول له`, `في ومجرورها: مفعول معه`, `فعل أمر وفاعله المستتر ومفعوله الأول`, `فعل دعاء وفاعله المستتر ومفعوله الثاني`, `مفعول به أول`],
        },
        {
          ...
          distractors: [`فعل ماضٍ مبني للمجهول والجار والمجرور: مفعول فيه للمكان`, `خبر مرفوع`, `فاعل مرفوع`, `مفعول به`, `اسم موصول: بدل`, `مضاف إليه مجرور`],
        },
        {
          ...
          distractors: [`في ومجرورها: مفعول به`, `في ومجرورها: مفعول فيه للمكان`, `في ومجرورها: مفعول له`, `في ومجرورها: للمقايسة`, `فعل دعاء وفاعله المستتر`, `فعل مضارع وفاعله المستتر`],
        },
        {
          ...
          distractors: [`في ومجرورها: مفعول به`, `في ومجرورها: مفعول فيه للمكان`, `في ومجرورها: مفعول له`, `مبتدأ ومضاف إليه`, `خبر مرفوع`, `حرف استفهام`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مفعول مطلق غير صريح للنوع, describing the manner of the mercy asked for`, `مفعول به, a second direct object`, `حال, describing the state of the parents`, `مفعول فيه للزمان, marking when the mercy takes place`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مفعول له, giving the reason for the remembrance, or كاف تشبيه, describing its manner`, `مفعول به فقط, with no second reading`, `حال فقط, with no second reading`, `فاعل, or مبتدأ, with no second reading either`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مِثْل — مِثْلِي، مِثْلُهُ، وما شابه`, `نَفْس — نفسي، نفسه، وما شابه`, `ذَات — ذاتي، ذاته، وما شابه`, `عَيْن — عيني، عينه، وما شابه`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`نصفه falls in the middle of الليل — neither its true last part nor something adjoining that last part`, `نصفه is مذكر while الليل requires مؤنث`, `نصفه cannot take تنوين, unlike the زمان nouns حتى ordinarily governs`, `حتى can never be followed by a مضاف إليه`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `قُمْتُ اللَّيْلَ حَتَّى نِصْفِهِ fails حتى's condition on what follows it. Why?`, options: [`نصفه falls in the middle of الليل, neither its true endpoint nor adjoining it`, `نصفه is معرفة while حتى requires نكرة`, `الليل cannot be مفعول فيه, since it already stands as the sentence's own object of time`, `حتى never governs a مضاف إليه`], correct: 0 },
      ],
      bank: [
        ...
        { title: `واذكروه كما هداكم: الوجهان`, kind: 'mcq', prompt: `﴿وَاذْكُرُوهُ كَمَا هَدَاكُمْ﴾ can be read two ways. What are they?`, options: [`مفعول له, giving the reason for remembrance, or كاف تشبيه, describing its manner`, `فاعل, or مبتدأ, with no second reading either`, `مفعول به, or حال فقط, with no second reading either`, `توكيد, or بدل, with no second reading either`], correct: 0 },
        { title: `تحديد الوجه المقصود`, kind: 'mcq', prompt: `Deciding whether كَمَا in ﴿وَاذْكُرُوهُ كَمَا هَدَاكُمْ﴾ is مفعول له or كاف تشبيه is not always obvious. What kind of analysis does the lesson say is needed?`, options: [`بلاغة work — the surface translation barely shifts between the two readings`, `No analysis is needed; the two readings are simply the same thing`, `Only a poetic meter check — بلاغة distinctions rarely affect scansion`, `Only counting the letters of الكاف — length alone decides its role`], correct: 0 },
        { title: `الكاف: مجرورها اسم ظاهر فقط`, kind: 'mcq', prompt: `Which of the following pronoun-attached forms of الكاف actually occurs in Arabic — كَي، كَهُ، or كَنَا؟`, options: [`None of them — الكاف never attaches to a pronoun at all`, `كَي only — the vowel pattern of الكاف works with a single ي`, `كَهُ only — the masculine pronoun attaches but not others`, `All three occur freely — الكاف behaves just like any other حرف جر`], correct: 0 },
        { title: `مثل: بديل الكاف مع الضمير`, kind: 'mcq', prompt: `Where تشبيه is needed with a pronoun rather than an اسم ظاهر, what word is used instead of الكاف?`, options: [`مِثْل — مثلي، مثله`, `شَبَه — شبهي، شبهه`, `نَظِير — نظيري، نظيره`, `عَيْن — عيني، عينه`], correct: 0 },
        ...
        { title: `شرط التعظيم والتحقير: مفرد لا زمان ولا مكان`, kind: 'mcq', prompt: `The rule إِذَا كَانَ مَجْرُورُهَا مُفْرَدًا غَيْرَ زَمَانٍ وَلَا مَكَانٍ يَكُونُ مَجْرُورُهَا غَايَةً فِي الرُّتْبَةِ applies to حتى's مجرور under what condition?`, options: [`When it is a single word, not itself a place or a time`, `Only when it is معرفة, never a نكرة noun`, `Only when it is a pronoun, never an اسم ظاهر`, `Only when it follows a فعل مضارع, never a فعل ماضٍ`], correct: 0 },
        ...
        { title: `قمت الليل حتى الصباح: اتصال بالآخر`, kind: 'mcq', prompt: `قُمْتُ اللَّيْلَ حَتَّى الصَّبَاحِ satisfies حتى's condition even though الصباح is not literally part of الليل. Why?`, options: [`الصباح is مُتَّصِل بآخر الليل, picking up exactly where the night ends`, `الصباح is the exact middle of الليل`, `الصباح is a صفة of الليل`, `The sentence does not actually satisfy the condition`], correct: 0 },
        {
          ...
          distractors: [`مفعول له`, `كاف تشبيه`, `تمييز`, `مفعول به`, `الكاف ومجرورها المؤول: مفعول له غير صريح`, `منادى مفرد العلم`],
        },
        {
          ...
          distractors: [`حرف جر للتحقير`, `مفعول فيه للمكان`, `مفعول فيه للزمان`, `مفعول له`, `بدل مرفوع`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`حرف جر للتعظيم`, `مفعول فيه للمكان`, `مفعول فيه للزمان`, `مفعول له`, `بدل منصوب`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`حتى ومجرورها: مفعول فيه للزمان`, `حتى ومجرورها: مفعول له`, `حرف جر للتعظيم`, `حرف جر للتحقير`, `فعل مضارع وفاعله`, `مفعول فيه للمكان`],
        },
        {
          ...
          distractors: [`حتى ومجرورها: غاية متصلة بآخر الليل`, `حتى ومجرورها: نصف الليل`, `مفعول فيه للمكان`, `فعل مضارع وفاعله`, `تمييز`, `مفعول به`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`باء القسم — reused from الباء, already met as the first of the thirteen`, `واو القسم — a newly dedicated oath particle, not reused from elsewhere`, `تاء القسم — a newly dedicated oath particle, not reused from elsewhere`, `None — all three are entirely new particles`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — واو and تاء are both restricted entirely to an اسم ظاهر; only الباء attaches to a pronoun`, `Yes — all three particles attach to pronouns equally, with no exceptions`, `Only تاء can attach to a pronoun — واو remains restricted to الاسم الظاهر`, `Only واو can attach to a pronoun — تاء remains restricted to لفظ الجلالة`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `وَلَفْظِ الجَلالَةِ and تَلَفْظِ الجَلالَةِ both carry a dropped verb أُقْسِمُ. Is stating أقسم alongside either particle ever acceptable?`, options: [`No — أقسم is never spoken alongside واو or تاء القسم`, `Yes, it is the standard form`, `Only alongside واو — تاء still requires it stay unspoken`, `Only alongside تاء — واو still requires it stay unspoken`], correct: 0 },
      ...
      bank: [
        ...
        { title: `واو القسم: القيد على مجرورها`, kind: 'mcq', prompt: `Can واو القسم attach to a pronoun, as in a form like وَهُ?`, options: [`No — واو القسم never attaches to a pronoun, only an اسم ظاهر`, `Yes — وَهُ is a standard form`, `Yes, but only in poetry`, `Only with لفظ الجلالة, never other divine names`], correct: 0 },
        ...
        { title: `تالرحمن: هل تصح؟`, kind: 'mcq', prompt: `تَلَفْظِ الجَلالَةِ is valid Arabic. Is تَالرَّحْمَنِ equally valid?`, options: [`No — تاء القسم is restricted to لفظ الجلالة اللّٰه specifically, not any divine name`, `Yes — both are equally valid`, `Yes, but only in formal registers`, `Neither form is valid — both تَالرَّحْمَنِ and تَالْعَصْرِ are rejected`], correct: 0 },
        { title: `تالعصر: هل تصح؟`, kind: 'mcq', prompt: `واو القسم can attach to العصر, giving وَالْعَصْرِ. Can تاء القسم do the same, giving تَالْعَصْرِ؟`, options: [`No — تاء القسم attaches only to لفظ الجلالة`, `Yes — تاء القسم is as flexible as واو here`, `Only if العصر is مرفوع`, `Only in poetry, and even then treated as شاذّ`], correct: 0 },
        ...
        { title: `لا يذكر فعل القسم: القيد`, kind: 'mcq', prompt: `Is it ever acceptable to say أُقْسِمُ وَاللَّهِ, stating the verb of oath alongside واو القسم?`, options: [`No — the verb of oath is never spoken with either واو or تاء القسم`, `Yes — this is the more formal form, preferred in careful speech`, `Yes, but only in Qur'anic Arabic, never in ordinary speech`, `Only when swearing by لفظ الجلالة, never by other divine names`], correct: 0 },
        { title: `باء القسم: الأصل`, kind: 'mcq', prompt: `Of the three particles القسم, which is treated as the أصل that the other two derive from?`, options: [`باء القسم — the original, from which واو and تاء are treated as derived`, `واو القسم — treated as الأصل, with باء and تاء derived from it`, `تاء القسم — treated as الأصل, with باء and واو derived from it`, `None — all three are equally original`], correct: 0 },
        { title: `الفرق بين باء وواو/تاء: ما تجره`, kind: 'mcq', prompt: `واو and تاء القسم each govern only an اسم ظاهر. What can باء القسم govern that they cannot?`, options: [`Both an اسم ظاهر and a pronoun`, `Only a pronoun, never an اسم ظاهر`, `Neither a pronoun nor an اسم ظاهر`, `Only a جملة, never a single noun or pronoun`], correct: 0 },
        ...
        { title: `فبعزتك لأغوينهم أجمعين: الفعل محذوف`, kind: 'mcq', prompt: `In ﴿فَبِعِزَّتِكَ لَأُغْوِيَنَّهُمْ أَجْمَعِينَ﴾, is أُقْسِمُ stated or dropped?`, options: [`Dropped — إبليس swears بِعِزَّتِكَ with أقسم left unspoken`, `Stated directly before بِعِزَّتِكَ, exactly as it is in ﴿لَا أُقْسِمُ بِيَوْمِ الْقِيَامَةِ﴾`, `Stated at the end of the آية`, `Neither — this is not an oath at all`], correct: 0 },
        { title: `بعزتك: باء تدخل على المضمر`, kind: 'mcq', prompt: `بِعِزَّتِكَ has باء القسم attaching to الكاف, a pronoun. What does that confirm about الباء compared to واو and تاء؟`, options: [`الباء attaches to a pronoun as freely as to a noun; واو and تاء cannot`, `All three particles attach to pronouns equally, with no restriction among them`, `الباء never attaches to a pronoun either, exactly like واو and تاء`, `Only تاء can attach to a pronoun, while واو and الباء cannot`], correct: 0 },
        { title: `بك لأفعلن: توضيح القاعدة`, kind: 'mcq', prompt: `بِكَ لَأَفْعَلَنَّ, "by you, I will surely do [it]," has باء القسم attaching directly to a pronoun. Could واو or تاء القسم replace الباء here?`, options: [`No — both واو and تاء are restricted entirely to an اسم ظاهر`, `Yes — واو could replace الباء with no change`, `Yes — تاء could replace الباء with no change`, `Both واو and تاء could replace الباء here with no change in meaning`], correct: 0 },
        { title: `أحرف القسم: خلاصة الفروق`, kind: 'mcq', prompt: `Comparing all three particles القسم on what they govern, which correctly ranks them from most to least flexible?`, options: [`باء (noun or pronoun) > واو (noun only) > تاء (noun only, restricted to اللّٰه)`, `تاء (noun only, restricted to اللّٰه) > واو (noun only) > باء (noun or pronoun)`, `واو (noun only) > تاء (noun only, restricted to اللّٰه) > باء (noun or pronoun)`, `All three are equally flexible, each governing both nouns and pronouns alike`], correct: 0 },
        {
          ...
          distractors: [`باء القسم ومجرورها: مفعول به لفعل محذوف تقديره أقسم`, `واو القسم ومجرورها: مفعول به لفعل محذوف تقديره أقسم`, `فعل مضارع تام وفاعله المستتر`, `فعل مضارع ومفعوله: مفعول به`, `حال`, `مفعول له`],
        },
        {
          ...
          distractors: [`واو القسم ومجرورها`, `تاء القسم ومجرورها`, `فعل مضارع ناقص وفاعله المستتر`, `مفعول به`, `تمييز`, `حرف نهي`],
        },
        {
          ...
          distractors: [`اللام واقعة في جواب الشرط وفعل مضارع مؤكد بالنون وفاعله ومفعوله`, `تاء القسم ومجرورها: مفعول به لفعل محذوف تقديره أقسم`, `واو القسم ومجرورها: مفعول به لفعل محذوف تقديره أقسم`, `مفعول له`, `حال`, `بدل منصوب`],
        },
        {
          ...
          distractors: [`باء القسم ومجرورها: اسم ظاهر`, `واو القسم ومجرورها: اسم ظاهر`, `تاء القسم ومجرورها: اسم ظاهر`, `اللام واقعة في جواب الشرط وفعل مضارع مؤكد بالنون`, `مفعول به`, `مفعول له`],
        },
        {
          ...
          distractors: [`باء القسم ومجرورها: مفعول به لفعل محذوف تقديره أقسم`, `تاء القسم ومجرورها: مفعول به لفعل محذوف تقديره أقسم`, `اللام واقعة في جواب الشرط وجار ومجرور: خبر إنّ`, `مبتدأ مرفوع`, `مفعول له`, `حال منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`المفعول فيه — the ظرف of time`, `المفعول به — the direct object of the verb`, `المفعول له — the reason behind the verb`, `المفعول المطلق — the verb's own مصدر repeated for emphasis`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Falling is a momentary event, not a state that extends across the whole named span, and مثبت ممتد requires exactly that`, `سقط is not actually مَاضٍ, despite its ت ending looking that way`, `الشمس cannot follow منذ at all, since it never denotes الزمان`, `منذ requires a منفي verb in every case, with no مثبت option`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`اليوم names the current unit of time the speaker occupies, regardless of the verb's own tense`, `اليوم is always understood as future, never as the present moment`, `اليوم is treated as a pronoun, not an اسم ظاهر`, `مذ ومنذ can never precede a زمان word at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`إِلَى — measuring a span of duration ("for")`, `مِنْ — picking out a fixed starting point ("since")`, `فِي — locating the event within a present moment ("at/on")`, `عَلَى — marking استعلاء, a sense منذ never actually carries`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A dropped كَانَ or مَضَى behind the surface phrase, with الجمعة as its اسم or فاعل rather than a literal مجرور`, `مذ can never govern جر at all, unlike منذ which always can`, `الجمعة is مبني, not معرب, after مذ, fixed regardless of context`, `منذ and مذ are simply two spellings with no إعراب difference`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`As an اسم مضاف, with the following جملة standing in the place of its مضاف إليه`, `As a فعل ماضٍ, absorbing the جملة as its own مقول القول`, `As a حرف عطف, linking the جملة to what came before`, `As a ظرف زمان لا محل له من الإعراب أصلًا`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `سَقَطْتُ مُنْذُ طُلُوعِ الشَّمْسِ is rejected even though سقط is مَاضٍ and مُثْبَت. Why?`, options: [`Falling is a momentary event, not a state extending across the whole named span`, `سقط cannot be مَاضٍ, despite its surface form looking that way`, `الشمس cannot follow منذ, since it never denotes الزمان`, `منذ always requires a منفي verb`], correct: 0 },
        { q: `In مَا رَأَيْتُهُ مُنْذُ اليَوْمِ, why is اليوم counted as دالّ على الحال despite the ماضٍ verb رأيته؟`, options: [`اليوم names the current unit of time the speaker occupies, regardless of the verb's tense`, `اليوم is future, never the present moment`, `اليوم is a pronoun, not an اسم ظاهر`, `مذ ومنذ reject زمان nouns entirely`], correct: 0 },
        { q: `مَا رَأَيْتُهُ مُنْذُ يَوْمَيْنِ has a نكرة past-time مجرور. Which meaning does منذ carry?`, options: [`إِلَى — "for," measuring a span`, `مِنْ — "since," a fixed starting point`, `فِي — "at/on," a present moment`, `عَلَى — استعلاء, a sense never carried by منذ`], correct: 0 },
        { q: `مُذِ الجُمُعَةُ shows رفع while مُنْذُ الجُمُعَةِ shows جر, for the same ماضٍ-معرفة meaning. What explains مُذ's رفع؟`, options: [`A dropped كَانَ or مَضَى, with الجمعة as its اسم or فاعل rather than a literal مجرور`, `مذ can never govern جر, unlike منذ which always can`, `الجمعة is مبني after مذ, fixed regardless of context`, `مذ ومنذ never differ in إعراب, despite this one apparent contrast`], correct: 0 },
        { q: `مَا اغْتَبْتُ أَحَدًا مُذْ عَلِمْتُ الغِيبَةَ مُحَرَّمَةً has a full جملة after مُذ. Since a حرف جر can never govern a جملة, how is مُذ reclassified here?`, options: [`As an اسم مضاف, with the following جملة as its مضاف إليه`, `As a حرف عطف, linking the جملة to what came before it`, `As a فعل, governing the جملة as its own مفعول به`, `As لا محل له من الإعراب`], correct: 0 },
      ],
      bank: [
        ...
        { title: `مذ غدا: لماذا لا تصح`, kind: 'mcq', prompt: `Why is مُذ غَدًا, "since tomorrow," rejected?`, options: [`مذ ومنذ's مجرور must denote past or present time, never future`, `غدا is a pronoun, not an اسم ظاهر`, `مذ can never precede a زمان word`, `غدا would need أل التعريف to serve as مذ's مجرور, which it lacks here`], correct: 0 },
        { title: `اليوم والليلة: لماذا حال لا ماض`, kind: 'mcq', prompt: `اليوم, الليلة, الشهر, and السنة are read as دالّ على الحال even after a ماضٍ verb. Why?`, options: [`They denote the current unit of time the speaker occupies, not a fixed point receding into the past`, `They are always مبني, regardless of what follows مذ or منذ`, `They can never follow a حرف جر`, `They are treated as أفعال, not أسماء`], correct: 0 },
        ...
        { title: `معنى مذ ومنذ مع الماضي المعرفة`, kind: 'mcq', prompt: `مَا رَأَيْتُهُ مُنْذُ الجُمُعَةِ has الجمعة as معرفة دالّة على الماضي. What meaning does منذ carry?`, options: [`مِنْ — "since," picking out a fixed starting point`, `فِي — "at/on," locating a present moment`, `إِلَى — "for," measuring a span`, `عَلَى — استعلاء, a sense منذ never carries`], correct: 0 },
        { title: `since و for: انعكاس في الإنجليزية`, kind: 'mcq', prompt: `English uses "since" for a معرفة past-time مجرور and "for" for a نكرة past-time مجرور after مذ/منذ. What does the lesson say this split mirrors?`, options: [`The same معرفة/نكرة split that decides between مِن and إِلَى in Arabic`, `A split that has no Arabic equivalent at all`, `The حاضر/ماضي split only, with no reference to معرفة or نكرة`, `Nothing — English "since" and "for" are simply synonyms`], correct: 0 },
        ...
        { title: `مذ يومان: تقدير مضى`, kind: 'mcq', prompt: `The second proposed تقدير for مَا رَأَيْتُهُ مُذْ يَوْمَانِ treats يومان as the فاعل of a dropped verb مَضَى. What does مضى mean here?`, options: [`"passed" — "since two days have passed"`, `"remained" — "since two days have remained"`, `"began" — "since two days have begun"`, `"ended" — "since two days have ended"`], correct: 0 },
        { title: `مذ كظرف مبتدأ بجملة رفع`, kind: 'mcq', prompt: `Once مُذ's رفع is traced to a dropped كَانَ or مَضَى, what does مُذ effectively become in that reading?`, options: [`A ظرف مبتدأ بجملة رفع, not a plain حرف جر`, `A فعل ماضٍ, absorbing يومان as its own فاعل`, `An اسم موصول, requiring a صلة to follow it`, `A ضمير مستتر, with يومان as its تمييز`], correct: 0 },
        { title: `مذ ومنذ مع الجملة: إعادة تصنيف`, kind: 'mcq', prompt: `مَا اغْتَبْتُ أَحَدًا مُذْ عَلِمْتُ الغِيبَةَ مُحَرَّمَةً has a full جملة after مُذ. Since حرف الجر لا يدخل على الجملة, how must مُذ and منذ be reclassified whenever this happens?`, options: [`As اسمان مضافان, not حرفا جر`, `As فعلان ماضيان, absorbing the جملة as their own مفعول به`, `As حرفا عطف, linking the جملة to what came before`, `As they remain حرفا جر regardless`], correct: 0 },
        { title: `مذ ومنذ: القاسم المشترك مع الكاف وحتى`, kind: 'mcq', prompt: `مذ ومنذ share one restriction with الكاف, حتى, and واو/تاء القسم. What is it?`, options: [`None of them ever attach to a pronoun — all require an اسم ظاهر`, `All of them require a معرفة مجرور, never a نكرة`, `All of them are restricted to poetry, never ordinary prose`, `None of them can be preceded by نفي, only by واو or فاء`], correct: 0 },
        { title: `مذ ومنذ: نقطة الافتراق الوحيدة`, kind: 'mcq', prompt: `مذ ومنذ are described as behaving almost identically. What is the one point where they diverge?`, options: [`The إعراب of their مجرور in the ماضي use — مرفوع for مذ, مجرور for منذ`, `Their basic meaning, which the lesson treats as nearly identical for both`, `The condition on the verb before them`, `Whether they can be followed by a جملة`], correct: 0 },
        {
          ...
          distractors: [`اسم مضاف بمعنى منذ الزمانية`, `مرفوع بمذ ومضاف إليه`, `فعل ماضٍ وفاعله`, `مفعول فيه للزمان`, `حال`, `تمييز`],
        },
        {
          ...
          distractors: [`اسم مضاف بمعنى منذ الزمانية`, `مرفوع بمنذ ومضاف إليه`, `حرف نفي وفعل مضارع وفاعله ومفعوله`, `مفعول فيه للزمان`, `تمييز`, `حال`],
        },
        {
          ...
          distractors: [`منذ ومجرورها: بمعنى مِن، مجرور راجحا`, `منذ ومجرورها: بمعنى إلى، مجرور`, `مذ ومجرورها: بمعنى في، مجرور وجوبا`, `حرف نفي وفعل مضارع وفاعله ومفعوله`, `مفعول له`, `حال`],
        },
        {
          ...
          distractors: [`منذ ومجرورها: بمعنى في، مجرور وجوبا`, `منذ ومجرورها: بمعنى إلى، مجرور`, `مذ ومجرورها: بمعنى مِن، مرفوع راجحا`, `حرف نفي وفعل مضارع وفاعله ومفعوله`, `مفعول له`, `تمييز`],
        },
        {
          ...
          distractors: [`منذ ومجرورها: بمعنى في، مجرور وجوبا`, `منذ ومجرورها: بمعنى مِن، مجرور راجحا`, `مذ ومجرورها: بمعنى إلى، مرفوع`, `حرف نفي وفعل مضارع وفاعله ومفعوله`, `مفعول له`, `حال`],
        },
        {
          ...
          distractors: [`حرف جر`, `مجرور بمذ`, `منذ ومجرورها: بمعنى في، مجرور وجوبا`, `مفعول فيه للزمان`, `تمييز`, `مفعول له`],
        },
      ],
    },
    // ---------------------------------------------------------------- L5
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Like الأصلي, it carries a real meaning; like الزائد, its مجرور need not be عملا لفعل أو شبه الفعل`, `Like الأصلي, it never carries meaning; like الزائد, its مجرور is always عمل`, `It shares nothing with either type, standing as a wholly separate third category`, `It is identical to حرف الجر الأصلي in every respect`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — it is حرف تنبيه adding a sense of تحسر, lament; there is no addressee being summoned`, `Yes — it calls the كاسيات directly, addressing the women being described`, `Yes — رُبَّ itself is being addressed, since particles can receive نداء too`, `No — يا here is حرف عطف, joining رُبَّ to a previous clause`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It functions as تمييز, spelling out what the ضمير مبهم actually meant`, `It functions as بدل, replacing the ضمير entirely`, `It functions as نعت للضمير, describing it without replacing it`, `It has no relation to the ضمير at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`رُبَّ stops requiring عمل on a following noun, and its تكثير/تقليل meaning shifts to how often an action happens`, `رُبَّ becomes أصلي, and its مجرور becomes معرفة only`, `رُبَّ can no longer open a sentence, and loses its meaning entirely`, `Nothing changes — مَا الكَافَّة is purely decorative, adding no grammatical effect at all`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`رُبَّ has been dropped after the واو while its عمل, the جر, stays behind`, `رُبَّ has been replaced permanently by الكاف, which now carries its جر`, `ليل is actually مرفوع, not مجرور, despite how the phrase reads`, `The واو has become a واو القسم, swearing by the night itself`],
            correct: 0,
          },
        },
      ],
      quiz: [
        { q: `حرف الجر الشبيه بالزائد shares one trait with حرف الجر الأصلي and one with حرف الجر الزائد. What are they?`, options: [`Real meaning like الأصلي; مجرور need not be عملا لفعل like الزائد`, `No meaning like الأصلي; مجرور always عمل like الزائد`, `It shares nothing with either, forming a wholly separate category`, `It is a third name for the same particle type as الأصلي`], correct: 0 },
        { q: `رُبَّ شَهْوَةٍ تُورِثُ حُزْنًا طَوِيلًا leans toward which of رُبَّ's two meanings?`, options: [`تكثير — many desires end in lasting grief`, `تقليل — only a few desires end in grief`, `Neither — تنبيه only`, `Both equally, with no lean at all`], correct: 0 },
        { q: `يَا رُبَّ كَاسِيَاتٍ فِي الدُّنْيَا عَارِيَاتٍ فِي الآخِرَةِ opens with يا before رُبَّ. Is that يا a genuine نداء?`, options: [`No — it is حرف تنبيه, adding تحسر, with no addressee being called`, `Yes — كاسيات is being addressed, exactly as an ordinary نداء would be`, `Yes — رُبَّ itself is being called`, `No — it is a زائدة with no function at all`], correct: 0 },
        ...
        { q: `What two things change when مَا الكَافَّة attaches to رُبَّ?`, options: [`رُبَّ stops requiring عمل, and its تكثير/تقليل target shifts to how often an action happens`, `رُبَّ becomes أصلي and its مجرور must be معرفة`, `رُبَّ can no longer appear in صدر الكلام`, `Nothing changes at all — مَا الكَافَّة is purely decorative here too`], correct: 0 },
        { q: `In وَلَيْلٍ كَمَوْجِ الْبَحْرِ, لَيْلٍ is مجرور with no visible حرف جر. What has happened to رُبَّ?`, options: [`It has been dropped after الواو while its عمل, the جر, stays behind`, `It has been replaced by الكاف, which now carries its جر`, `ليل is actually مرفوع, despite how the phrase looks on the surface`, `رُبَّ was never present in this construction at all`], correct: 0 },
      ],
      bank: [
        { title: `حرف الجر الشبيه بالزائد: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines حرف الجر الشبيه بالزائد؟`, options: [`It carries a specific meaning of its own, but its مجرور is not the معمول of a فعل or شبه الفعل`, `It carries no meaning, and its مجرور is the معمول of a فعل`, `It carries a specific meaning, and its مجرور is always the معمول of a فعل`, `It only ever enters upon a definite noun, never a نكرة`], correct: 0 },
        ...
        { title: `رُبَّ شهوة: أي المعنيين`, kind: 'mcq', prompt: `رُبَّ شَهْوَةٍ تُورِثُ حُزْنًا طَوِيلًا leans toward which meaning?`, options: [`تكثير — many desires end in lasting grief`, `تقليل — only a few desires end in grief`, `Neither meaning applies here — the آية carries only تنبيه`, `Both meanings equally, with the آية giving no lean`], correct: 0 },
        ...
        { title: `ربه رجلا كريما لقيته: الضمير المبهم`, kind: 'mcq', prompt: `In رُبَّهُ رَجُلًا كَرِيمًا لَقِيتُهُ, what kind of pronoun is the هُ attached to رُبَّ?`, options: [`ضمير مبهم — no مرجع at all, clarified by the following تمييز`, `ضمير عائد على شهوة — referring back to a noun mentioned earlier`, `ضمير الشأن — introducing a following جملة with no other referent`, `ضمير الفصل — separating المبتدأ from الخبر`], correct: 0 },
        { title: `البصريون والكوفيون: خلافهما`, kind: 'mcq', prompt: `البصريون and الكوفيون disagree about the ضمير مبهم after رُبَّ. What is their disagreement?`, options: [`Whether the ضمير changes form to match its تمييز in number and gender, or stays مفرد مذكر regardless`, `Whether the ضمير is مرفوع or منصوب, unrelated to the تمييز debate`, `Whether رُبَّ can carry a ضمير at all, a point both schools actually agree on`, `Whether the تمييز must be مفرد or جملة, a separate question from agreement`], correct: 0 },
        { title: `الكوفيون: ربهم رجالا`, kind: 'mcq', prompt: `According to الكوفيون, how would the pronoun after رُبَّ appear if the تمييز is رِجَالًا (plural men)?`, options: [`رُبَّهُمْ رِجَالًا — the ضمير matches the تمييز`, `رُبَّهُ رِجَالًا — the ضمير stays مفرد مذكر`, `رُبَّهَا رِجَالًا — the ضمير matches a feminine singular تمييز`, `رُبَّهُنَّ رِجَالًا — the ضمير matches a feminine plural تمييز`], correct: 0 },
        { title: `البصريون: ربه رجالا`, kind: 'mcq', prompt: `According to البصريون, how would the pronoun after رُبَّ appear if the تمييز is رِجَالًا؟`, options: [`رُبَّهُ رِجَالًا — the ضمير stays مفرد مذكر regardless of the تمييز`, `رُبَّهُمْ رِجَالًا — the ضمير matches the تمييز`, `رُبَّهَا رِجَالًا — the ضمير matches a feminine singular تمييز`, `رُبَّهُنَّ رِجَالًا — the ضمير matches a feminine plural تمييز`], correct: 0 },
        { title: `الغالب في مجرور رُبَّ: موصوف`, kind: 'mcq', prompt: `What is most commonly true of the نكرة following رُبَّ?`, options: [`It is مَوصوف, carrying a صفة of its own`, `It is دائما معرفة, never نكرة at all`, `It never takes a صفة`, `It is always a ضمير مبهم`], correct: 0 },
        { title: `رب رجل يفعل الخير: الصفة جملة`, kind: 'mcq', prompt: `In رُبَّ رَجُلٍ يَفْعَلُ الخَيْرَ لَقِيتُهُ, what serves as the صفة of رَجُلٍ؟`, options: [`The جملة يَفْعَلُ الخَيْرَ`, `The word الخير alone`, `لَقِيتُهُ alone, mistaken for the صفة`, `There is no صفة in this example`], correct: 0 },
        ...
        { title: `مما يحرك شفتيه: مِمّا بمعنى رُبَّ`, kind: 'mcq', prompt: `كَانَ ﷺ مِمَّا يُحَرِّكُ شَفَتَيْهِ uses مِمَّا with a shifted meaning. What does مِمَّا mean here?`, options: [`"Often" — carrying the meaning of رُبَّ`, `"From that which," its ordinary sense`, `"Because," carrying تعليل`, `"Together with," carrying مصاحبة`], correct: 0 },
        {
          ...
          distractors: [`حرف جر شبيه بالزائد، للتقليل`, `رُبَّ وضمير مبهم مجرور بها`, `تمييز يفسر الضمير`, `فعل مضارع، والجملة صفة لرجل`, `مفعول له`, `حال`],
        },
        {
          ...
          distractors: [`مجرور برُبَّ، نكرة`, `حرف جر شبيه بالزائد، للتكثير`, `فعل مضارع، والجملة صفة لرجل`, `مفعول له`, `حال`, `مفعول به`],
        },
        {
          ...
          distractors: [`حرف جر شبيه بالزائد، للتكثير`, `حرف جر شبيه بالزائد، للتقليل`, `فعل مضارع، والجملة صفة لشهوة`, `رُبَّ وضمير مبهم مجرور بها`, `تمييز`, `نعت`],
        },
        {
          ...
          distractors: [`مبتدأ مرفوع`, `خبر: جملة فعلية`, `حرف جر شبيه بالزائد`, `مفعول به`, `فاعل مرفوع`, `فعل ماضٍ`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `فعل مضارع`, `مجرور برُبَّ، نكرة`, `مفعول به`, `حرف جر شبيه بالزائد`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`نائبة عن مِن التبعيضية (أو عاطفة على تقدير حذف مِن)`, `الكاف ومجرورها: مفعول مطلق للنوع`, `حرف جر شبيه بالزائد`, `مجرور بالواو، معرفة`, `مضاف إليه`, `حال`],
        },
      ],
    },
    // ---------------------------------------------------------------- L6
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`That only part of the thing is meant — some water, not water in general`, `That the speaker has none of the water at all`, `The starting point of a journey, ابتداء الغاية`, `A comparison between two things, the sense carried by الكاف`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It declares the excluded item free of the very fault attributed to everyone else, not merely absent from the group`, `It makes the exclusion optional rather than certain, unlike إلا's fixed exclusion`, `It reverses the meaning, including the person instead of excluding them`, `Nothing — حاشا and إلا are functionally identical, both marking a bare exception`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`"To set at a distance" — exactly what حاشا does by exempting its مستثنى from the fault attributed to the group`, `"To join together" — حاشا merges the مستثنى back into the group it was excluded from`, `"To repeat" — حاشا doubles the meaning of the verb that precedes it`, `Nothing — the root sense has no connection to its grammatical use`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`متعلق بظرف مستقر محذوف (الكاف أصلي), or في محل خبر مباشرة (الكاف شبيه بالزائد بمعنى مثل)`, `فاعل, or نائب فاعل — treating النور as if the sentence were passive`, `مبتدأ, or بدل — treating النور as a second subject or replacement`, `Only one reading is possible; there is no real disagreement`],
            correct: 0,
          },
        },
      ],
      quiz: [
        { q: `﴿وَلَقَدْ جَاءَكَ مِنْ نَبَإِ الْمُرْسَلِينَ﴾ uses مِنْ التبعيضية. What does it mark?`, options: [`That only some of the news of the messengers is meant, not all of it`, `The starting point of a journey, ابتداء الغاية`, `A comparison between two things, the sense carried by الكاف`, `A reason or cause, the sense carried by اللام`], correct: 0 },
        ...
        { q: `هَلَكَ النَّاسُ حَاشَا العَالِمَ uses حَاشَا rather than إِلَّا. What does حَاشَا add beyond a plain exception?`, options: [`It declares the excluded item free of the very fault attributed to the group`, `It makes the exception optional, rather than a fixed grammatical requirement`, `It reverses the exclusion, including the person instead`, `Nothing — the two particles mean exactly the same thing`], correct: 0 },
        { q: `In هَلَكَ النَّاسُ حَاشَا العَالِمَ, does هَلَكَ describe literal physical death?`, options: [`No — it describes spiritual ruin, through lacking true معرفة of الله`, `Yes — it describes literal death`, `Yes, but only for العالم, who alone is exempted from it`, `Neither — the sentence has no real meaning`], correct: 0 },
        { q: `حَاشَا's root sense comes from حَاشِيَة, "the margin, the edge of a page." What does that root sense capture?`, options: [`"To set at a distance" — matching حاشا's grammatical job of exempting its مستثنى`, `"To join together" — merging the مستثنى back into the excluded group`, `"To repeat an action" — doubling the verb's meaning`, `Nothing relevant to its grammatical use`], correct: 0 },
        { q: `الْعِلْمُ كَالنُّورِ admits two إعراب readings for النور. What are they?`, options: [`متعلق بظرف مستقر محذوف (الكاف أصلي), or في محل خبر مباشرة (الكاف شبيه بالزائد بمعنى مثل)`, `فاعل, or مفعول به — treating النور as doing or receiving the action`, `مضاف إليه, or بدل — treating النور as possessed by or replacing العلم`, `Only one reading is possible, with no real grammatical disagreement here`], correct: 0 },
      ],
      bank: [
        { title: `مِن التبعيضية: التعريف`, kind: 'mcq', prompt: `What does مِن التبعيضية mark, as distinct from مِن's أصلي senses like ابتداء الغاية?`, options: [`That only part of something is meant, not the whole`, `The starting point of a journey, ابتداء الغاية's own sense`, `A comparison between two things, الكاف's own sense`, `The instrument used to perform an action`], correct: 0 },
        { title: `جاءك من نبإ المرسلين: بعض لا كل`, kind: 'mcq', prompt: `﴿وَلَقَدْ جَاءَكَ مِنْ نَبَإِ الْمُرْسَلِينَ﴾ does not mean that all the news of the messengers came. What does مِنْ mark instead?`, options: [`That only some of the news came, not the whole of it`, `That none of the news came, contradicting جَاءَكَ outright`, `That the news came from a specific place`, `That the news came before a specific time`], correct: 0 },
        ...
        { title: `حاشا: التعريف كأداة استثناء`, kind: 'mcq', prompt: `Which of the following best describes حَاشَا's grammatical function?`, options: [`أداة استثناء تنزه المستثنى من العيب المنسوب إلى ما قبلها`, `أداة استثناء بلا أي معنى إضافي`, `أداة تعليل تبين سبب ما قبلها`, `أداة تشبيه تقارن بين شيئين`], correct: 0 },
        { title: `جاء الناس إلا زيدا: بلا حكم`, kind: 'mcq', prompt: `جَاءَ النَّاسُ إِلَّا زَيْدًا excludes زيد with plain إلا. Does this imply any judgment about زيد?`, options: [`No — إلا only says Zayd didn't come, with no judgment implied`, `Yes — it implies زيد was praised, exactly as حاشا would suggest`, `Yes — it implies زيد was blamed, unlike what حاشا would suggest`, `It implies زيد came anyway, contradicting the sentence's own verb`], correct: 0 },
        ...
        { title: `هلك: معنوي لا حسي`, kind: 'mcq', prompt: `In هَلَكَ النَّاسُ حَاشَا العَالِمَ, what does هَلَكَ actually mean?`, options: [`Spiritual ruin, through lacking true معرفة of الله`, `Literal physical death, the ordinary sense of the word`, `Financial loss, from losing one's wealth entirely`, `Military defeat, from losing a battle outright`], correct: 0 },
        ...
        { title: `العلم كالنور: الوجه الأول`, kind: 'mcq', prompt: `On the first reading of الْعِلْمُ كَالنُّورِ, الكاف is treated as حرف جر أصلي. How is النور's إعراب explained on that reading?`, options: [`متعلق بظرف مستقر محذوف, as if العلمُ ثابتٌ كالنور`, `في محل خبر مباشرة`, `مبتدأ ثانٍ, treating النور as a second subject entirely`, `بدل من العلم, replacing العلم outright`], correct: 0 },
        ...
        { title: `العلم كالنور: نفس المعنى، آليتان مختلفتان`, kind: 'mcq', prompt: `The two readings of الْعِلْمُ كَالنُّورِ differ in mechanism but not in outcome. What do they agree on?`, options: [`Both readings reach the same overall meaning`, `They reach entirely different meanings`, `Only one reading is grammatically valid at all`, `They differ in the meaning of العلم itself`], correct: 0 },
        {
          ...
          distractors: [`حرف جر شبيه بالزائد`, `فاعل مجرور لفظا بمن`, `مبتدأ مؤخر مجرور لفظا بمن`, `واو عطف ولام توطئة وحرف تحقيق`, `فعل ماضٍ وفاعله`, `مفعول به`],
        },
        {
          ...
          distractors: [`ظرف زمان وهو خبر مقدم، والياء مضاف إليه`, `فاعل مجرور لفظا بمن ومضاف إليه`, `حرف جر شبيه بالزائد`, `مبتدأ مؤخر مرفوع`, `خبر مقدم`, `فاعل`],
        },
        {
          ...
          distractors: [`حرف جر للتبعيض`, `أداة استثناء بلا أي معنى إضافي`, `فعل مضارع`, `فاعل مرفوع`, `بدل منصوب`, `مضاف إليه`],
        },
      ],
    },
  ],
