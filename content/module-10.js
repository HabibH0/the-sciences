  ...
  lessons: [
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `Both وَاللَّهِ and تَاللَّهِ carry a dropped verb behind them — the full sentence would be أُقْسِمُ بِاللَّهِ, "I swear by Allah" — but أُقْسِمُ is never actually spoken alongside either particle. وَاللَّهِ and تَاللَّهِ each function as مفعول به of that unspoken فعل.`, list: false },
            { box: { title: 'Rule', lines: [`وَلَا يُذْكَرُ فِعْلُ الْقَسَمِ بِالتَّاءِ أَوِ الْوَاوِ`] } },
            { html: `This omission is not optional — the verb of oath is never spoken with either particle. One says وَاللَّهِ or تَاللَّهِ, never أُقْسِمُ وَاللَّهِ.`, list: false },
          ],
          exercise: {
            prompt: `وَاللَّهِ and تَاللَّهِ each carry a dropped verb أُقْسِمُ behind them. Can a speaker say أُقْسِمُ وَاللَّهِ, stating the verb alongside واو القسم?`,
            kind: 'mcq',
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `"By Your might, I will surely mislead them all." Here إبليس swears بِعِزَّتِكَ with أُقْسِمُ left unspoken, exactly as وَاللَّهِ or تَاللَّهِ would require — showing that even where الباء could carry a stated verb, it does not have to.`, list: false },
      ...
      quiz: [
        ...
        { q: `وَاللَّهِ and تَاللَّهِ both carry a dropped verb أُقْسِمُ. Is stating أقسم alongside either particle ever acceptable?`, options: [`No — أقسم is never spoken alongside واو or تاء القسم`, `Yes, it is the standard form`, `Only alongside واو`, `Only alongside تاء`], correct: 0 },
      ...
      bank: [
        ...
        { title: `تالرحمن: هل تصح؟`, kind: 'mcq', prompt: `تَاللَّهِ is valid Arabic. Is تَالرَّحْمَنِ equally valid?`, options: [`No — تاء القسم is restricted to لفظ الجلالة اللّٰه specifically, not any divine name`, `Yes — both are equally valid`, `Yes, but only in formal registers`, `Neither form is valid`], correct: 0 },
        ...
        { title: `المفعول به لفعل محذوف: التقدير`, kind: 'mcq', prompt: `وَاللَّهِ and تَاللَّهِ each carry a dropped verb. What is that verb, and what role do وَاللَّهِ/تَاللَّهِ play for it?`, options: [`أُقْسِمُ — وَاللَّهِ/تَاللَّهِ function as its مفعول به`, `أُؤَكِّدُ — they function as its فاعل`, `أَحْلِفُ — they function as its مبتدأ`, `No verb is implied at all`], correct: 0 },
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `A word like اليَوْم, "today," or اللَّيْلَة, "tonight," looks like it names the present moment — but it is still counted as <bdi>دالّ على الحال</bdi> even when the verb before it is مَاضٍ. ما رَأَيْتُهُ مُنْذُ اليَوْمِ is understood as "I have not seen him today," with اليوم referring to the very day the speaker is in, regardless of the verb's tense. اليوم, الليلة, الشهر, السنة and similar words are read this way precisely because they denote the current unit of time the speaker occupies, not a fixed point receding into the past.`, list: false },
          ],
          exercise: {
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `هَلَكَ النَّاسُ حَاشَا العَالِمَ does not describe physical death — هَلَكَ here means "ruined," spiritually and otherwise, through lacking true <bdi>مَعْرِفَة</bdi> of الله. حَاشَا العَالِمَ does not just exclude the عالم from the group; it affirms the عالم is untouched by the very fault — the lack of معرفة — attributed to everyone else.`, list: false },
