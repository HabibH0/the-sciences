  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`رَسولُ اللهِ — the خبر itself`, `مُحَمَّدٌ — the topic being spoken about`, `اللهِ alone — treating the مضاف إليه as if it alone were الخبر`, `Neither word — the sentence has no single خبر`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Merely permitted — جواب الاستفهام makes it recoverable, but doesn't force the drop`, `Obligatory — جواب الاستفهام always forces حذف الخبر`, `There is no dropped خبر here — اللهُ already functions as the sentence's own خبر`, `Obligatory, the same way لولا forces it`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `وَلَوْلا رَهْطُكَ لَرَجَمْناكَ leaves رَهْطُكَ's خبر (مَوْجودٌ) unwritten. Is that drop obligatory or optional؟`, options: [`Obligatory — لولا's own grammar always drops it`, `Optional — a speaker may include it if they wish`, `There is no dropped خبر here — رَهْطُكَ already gets its meaning from لَرَجَمْناكَ`, `Obligatory only in Qur'anic Arabic`], correct: 0 },
        { q: `﴿...لَيَقولُنَّ اللهُ﴾ drops لَفْظِ الجَلالَةِ's خبر (خَلَقَهُنَّ). Is that drop obligatory or merely permitted؟`, options: [`Merely permitted — recoverable from جواب الاستفهام, but not forced`, `Obligatory, the same way لولا forces it`, `There is no dropped خبر here — the جملة already states its خبر in full`, `Obligatory only in poetry`], correct: 0 },
      ...
      bank: [
        ...
        { title: `جواز حذف الخبر: متى؟`, kind: 'mcq', prompt: `Beyond the three obligatory cases, when may الخبر be dropped (يجوز, not يجب)؟`, options: [`Wherever context makes it recoverable (عِنْدَ القَرينَةِ)`, `Only in poetry — prose always keeps الخبر spelled out in full`, `Only after حروف النداء`, `Never — جواز الحذف does not apply to الخبر`], correct: 0 },
        ...
        { title: `خبر مقدم بلام الابتداء`, kind: 'mcq', prompt: `In لَكاذِبٌ أَنْتَ, لَكاذِبٌ is strengthened by لام الابتداء and comes first. What role does it play relative to أَنْتَ؟`, options: [`خبر مقدم`, `مبتدأ مؤخر`, `مفعول به`, `حال`], correct: 0 },
        {
          ...
          distractors: [`خبر مقدم (جار ومجرور)`, `مبتدأ مؤخر`, `خبر أول`, `خبر ثانٍ`, `فاعل مرفوع`, `مضاف إليه مرفوع`],
        },
        {
          ...
          distractors: [`خبر مقدم (جار ومجرور)`, `مبتدأ مؤخر`, `خبر مرفوع`, `مضاف إليه مجرور`, `فاعل مرفوع`, `نعت مرفوع`],
        },
        {
          ...
          distractors: [`خبر مقدم`, `خبر مقدم (شبه جملة)`, `مبتدأ`, `مضاف إليه مجرور`, `حرف جر`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`مبتدأ خبره محذوف جوازا`, `خبر`, `مفعول به`, `حرف شرط`, `فاعل`, `مبتدأ مرفوع`],
        },
        {
          ...
          distractors: [`حرف عطف`, `معطوف على المبتدأ`, `خبر (والواو بمعنى مع)`, `مفعول معه (والخبر محذوف تقديره: موجود)`, `مضاف إليه مجرور`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`مبتدأ خبره محذوف وجوبا`, `فعل مضارع وفاعله ضمير مستتر`, `حرف شرط`, `مفعول به`, `خبر مقدم`, `فاعل`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      quiz: [
        ...
        { q: `المُفْسِدونَ in ﴿اِنَّهُمْ هُمُ الْمُفْسِدونَ﴾ is plural. What inside المُفْسِدونَ forces that agreement؟`, options: [`A ضمير مستتر هم that must match اسم إنّ`, `A تنوين — indefiniteness always forces الخبر to match its مبتدأ`, `A لام التعريف — the definite article is what triggers agreement here`, `A تاء التأنيث — that's what forces الخبر into agreement`], correct: 0 },
        ...
        { q: `الَّذينَ خَسِرُوا اَنْفُسَهُمْ فَهُمْ لا يُؤْمِنونَ places فَ on الخبر. What in المبتدأ licenses that فَ؟`, options: [`الَّذينَ, an اسم موصول unspecific about who exactly, behaves like "whoever"`, `الَّذينَ being معرفة بأل — and every معرفة noun licenses فَ on its خبر`, `The verb خَسِرُوا itself — a فعل ماضٍ always licenses فَ on what follows it`, `The absence of a real مبتدأ — with no مبتدأ, الفاء steps in by default`], correct: 0 },
        { q: `كُلُّ يَتيمٍ فَلَهُ في قَلْبي رَاْفَةٌ licenses فَ with no further description of يَتيمٍ needed. What alone triggers that؟`, options: [`كُلُّ itself, مضاف to a bare نكرة, carrying a distributive "whoever" sense`, `يَتيمٍ being مثنى — dual nouns always carry a شرط-like sense`, `رَاْفَةٌ being مقدم — a fronted خبر is what licenses الفاء here`, `The absence of أل — every indefinite نكرة alone licenses الفاء on its خبر`], correct: 0 },
      ],
      bank: [
        ...
        { title: `الفاء الداخلة على الخبر: وظيفتها`, kind: 'mcq', prompt: `When المبتدأ carries معنى الشرط, what can فَ legitimately do؟`, options: [`Enter on الخبر, exactly the way it marks جواب الشرط in an ordinary conditional`, `Turn الخبر into مبتدأ — reversing their roles is فَ's real function here`, `Force حذف الخبر — the same way it forces حذف elsewhere in الجملة`, `Convert الجملة الاسمية into جملة فعلية`], correct: 0 },
        ...
        { title: `مطابقة أم تضمن شرط: التمييز`, kind: 'mcq', prompt: `اِنَّهُمْ هُمُ الْمُفْسِدونَ illustrates مطابقة الخبر; الَّذينَ خَسِرُوا اَنْفُسَهُمْ فَهُمْ لا يُؤْمِنونَ illustrates a different phenomenon. What is that second phenomenon؟`, options: [`تضمن المبتدأ معنى الشرط, licensing فَ on الخبر`, `وجوب حذف الخبر — a خبر forced out of the sentence entirely, not marked by فَ`, `تعدد الخبر — more than one خبر stacked onto the same topic`, `تقديم الخبر على المبتدأ — الخبر fronted ahead of its مبتدأ`], correct: 0 },
        {
          ...
          distractors: [`مبتدأ`, `خبر مقدم`, `فاعل`, `ضمير مستتر`, `اسم إنّ منصوب`, `خبر إنّ مرفوع بالضمة`],
        },
        {
          ...
          labels: [`مبتدأ`, `خبر`],
          distractors: [`خبر مرفوع`, `مبتدأ مرفوع`, `خبر إنّ`, `فاعل مرفوع`, `مضاف إليه`, `خبر مقدم`],
        },
        {
          ...
          distractors: [`مبتدأ`, `خبر`, `خبر مرفوع بالواو`, `مضاف إليه`, `فاعل مرفوع`, `حرف عطف`],
        },
        {
          ...
          distractors: [`حرف شرط`, `مضاف إليه`, `فاعل`, `مبتدأ (نكرة مجردة)`, `رابطة داخلة على خبر المبتدأ لتقديمه على مبتدئه`, `مبتدأ مؤخر مرفوع`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A مصدر from a synonymous فعل (مَصْدَر فِعْل بِمَعْناه) — not, strictly, تَبَتَّلْ's own literal مصدر`, `The literal مصدر of تَبَتَّلْ itself — sharing the exact same root letters and pattern`, `Neither — تَبْتِيلًا is not a مصدر at all here`, `A مفعول به, not a مفعول مطلق — it is the direct object the فعل is acting upon`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`ما يدل على عدد الفعل — it states how many times the فعل occurred`, `ما يدل على نوع الفعل — it names the manner the فعل occurred, not its count`, `اسم المصدر — a separate noun standing in for the فعل's own مصدر`, `ضمير المصدر — a pronoun referring back to a مصدر already named`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        ...
        { title: `واذكر ربك كثيرا: الصفة نائبة`, kind: 'mcq', prompt: `كَثِيرًا in ﴿وَاذْكُرْ رَبَّكَ كَثِيرًا﴾ stands in for a dropped مصدر (أَيْ ذِكْرًا كَثِيرًا). What kind of substitute is كَثِيرًا؟`, options: [`صِفَتُهُ — a صفة standing in for the مصدر`, `اِسْمُ المَصْدَرِ — a separate noun standing in for the فعل's own مصدر`, `ضَميرُهُ — a pronoun referring back to a مصدر already named`, `ما يدل على عدده — it states how many times the فعل occurred`], correct: 0 },
        ...
        { title: `اجتهد ذلك الاجتهاد: الإشارة نائبة`, kind: 'mcq', prompt: `ذَلِكَ in اِجْتَهَدَ ذَلِكَ الِاجْتِهادَ points back to a specific, known اجتهاد. What is ذَلِكَ standing in for؟`, options: [`اِسْمُ الإِشارَةِ نائبًا عن المصدر`, `صِفَتُهُ — a صفة standing in for the مصدر`, `ضَميرُهُ — a pronoun referring back to a مصدر already named`, `ما يدل على نوعه — it names the manner the فعل occurred`], correct: 0 },
        ...
        { title: `نيابة المفعول المطلق: الفئات الستة`, kind: 'mcq', prompt: `When the عامل of المفعول المطلق is dropped entirely, the dropped فعل falls into one of six categories. Which category does صَبْرًا لا جَزْعًا (اِصْبِرْ ولا تَجْزَعْ) belong to؟`, options: [`نَهْيًا — a prohibition`, `أَمْرًا — a command`, `دُعاءً — a supplication`, `مَصادِرُ مَسْموعَةٌ`], correct: 0 },
        {
          ...
          distractors: [`مفعول مطلق من مصدر فعل بمعناه`, `مفعول مطلق (يدل على نوع)`, `مفعول مطلق للعدد`, `حال`, `تمييز`, `اسم مصدر`],
        },
        {
          ...
          distractors: [`مفعول مطلق مؤكد لعامله`, `مفعول مطلق (اسم مصدر) نائب عن المصدر`, `مفعول به`, `حال`, `تمييز`, `جار ومجرور متعلق بالمفعول المطلق`],
        },
        {
          ...
          distractors: [`مفعول مطلق مؤكد لعامله`, `مفعول مطلق (يدل على عدد) نائب عن المصدر`, `مفعول به`, `حال`, `مضاف`, `فعل أمر وفاعله ضمير مستتر`],
        },
        {
          ...
          distractors: [`مفعول مطلق (يدل على نوع) نائب عن المصدر`, `مفعول مطلق (اسم مصدر) نائب عن المصدر`, `مفعول مطلق مؤكد لعامله`, `مفعول به`, `تمييز`, `مضاف`],
        },
        {
          ...
          distractors: [`مفعول مطلق (اسم مصدر) نائب عن المصدر`, `مفعول مطلق (يدل على عدد) نائب عن المصدر`, `مفعول مطلق مؤكد لعامله`, `حال`, `تمييز`, `اسم مصدر`],
        },
        {
          ...
          distractors: [`مفعول مطلق نائب عن فعله المحذوف وجوبا (لا تُسيئوا)`, `مفعول مطلق مؤكد لمضمون الجملة قبله`, `مفعول مطلق مؤكد لعامله`, `مفعول به`, `حال`, `حرف جر`],
        },
      ],
    },
  ],
