  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because no single letter of it separately carries part of the meaning "man"`, `Because it begins with أل, and taking أل is mistakenly thought to make a word مفرد`, `Because it is only three letters long, and short words are assumed to always count as مفرد`, `Because it names something tangible, and concrete nouns are assumed to always be مفرد`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`As a proper name it now functions as one combined unit — a تركيب مزج`, `Because it has fewer than four letters`, `Because it accepts تنوين, and any word that takes تنوين is treated as مفرد`, `Because both of its parts point to the same meaning`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `كِتَابُ الوَلَدِ is مركب because:`, options: [`Each of its two words, كتاب and الولد, carries its own meaning`, `It has more than three letters`, `It ends in a كسرة on الوَلَدِ, mistaken for the real reason`, `It cannot take أل as one connected phrase, unlike a true مفرد word`], correct: 0 },
        { q: `Discussing رِجَالٌ as one word versus a construction — not as a matter of count — رِجَالٌ is:`, options: [`مركب, since it names more than one man`, `مفرد, since it is one word, not a joined construction`, `مثنى, since رجال looks like it names exactly two`, `جمع, since more than one رجل is meant`], correct: 1 },
      ...
      bank: [
        ...
        { title: `مركب: definition`, kind: 'mcq', prompt: `Which of the following is the correct definition of المركب؟`, options: [`ما تدل أجزاؤه على معنى`, `ما لا تدل أجزاؤه على معنى`, `كل ما خرج من فم الإنسان من صوت`, `قول مفرد — that's actually الكلمة's definition, not المركب's`], correct: 0 },
        { title: `رجل: مفرد or مركب؟`, kind: 'mcq', prompt: `رَجُلٌ is one word. Is it مفرد or مركب, and why?`, options: [`مفرد — its letters do not separately carry parts of its meaning`, `مركب — three letters is mistakenly assumed to always mean a compound word`, `مركب — each of its letters carries part of the meaning`, `مفرد — تنوين is mistakenly assumed to be what makes a word مفرد`], correct: 0 },
        ...
        { title: `مضاف and مضاف إليه`, kind: 'mcq', prompt: `In كِتَابُ الوَلَدِ, what role does each word play?`, options: [`كتاب is مضاف, الولد is مضاف إليه`, `كتاب is مضاف إليه, الولد is مضاف`, `Both words are مضاف, with neither one مضاف إليه`, `Neither word is مضاف, since both stand independently`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`تنوين الترنم — it marks the rhyme, and it can attach even to a فعل or a حرف`, `تنوين التمكين — it marks الاسم مباشرة, unlike تنوين الترنم which only marks rhyme`, `نون التوكيد — it is a sign of الفعل, not الاسم`, `ياء المخاطبة — it marks الأمر, not the rhyme of a poetic line`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — الفعل never becomes مجرور; the لام enters upon the whole اسم مؤول instead`, `Yes — any فعل preceded by a حرف جر becomes مجرور`, `No — يكون is مرفوع regardless of what precedes it`, `Yes, but only because it is مضارع — a ماضٍ فعل would supposedly stay immune`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `In لِيَكُونَ لِلْعَالَمِينَ نَذِيرًا, the لام sits before the فعل يَكُونَ. What does the rule الفعل والحرف لا يكونان مجرورين tell us about يَكُونَ here؟`, options: [`It is not مجرور — it is منصوب by أن مقدرة, and the لام enters upon the whole اسم مؤول`, `It is مجرور, since a حرف جر directly precedes it, the same way it would with any اسم`, `It is مبني, since all أفعال المضارع after لام are مبنية, never مرفوع or منصوب`, `It is مرفوع, since لام never affects a فعل, only ever an اسم`], correct: 0 },
      ...
      bank: [
        ...
        { title: `بسم الله: recognising الجر`, kind: 'mcq', prompt: `In بِسْمِ اللهِ, اسم is مجرور by بـ. What does that show about اسم?`, options: [`It carries the علامة الجر, a sign of الاسم`, `It carries النداء, since a حرف comes right before it`, `It is a فعل, since it follows a حرف`, `It is مبني, since it follows بـ`], correct: 0 },
        { title: `The sign is on the word itself`, kind: 'mcq', prompt: `A حرف جر appears next to a word, but the word itself is not مجرور. Does الجر still count as a sign of الاسم there?`, options: [`No — the sign requires the word itself to be مجرور, not merely a nearby حرف جر`, `Yes — any nearby حرف جر is enough, even without the word itself changing`, `Yes, but only for indefinite nouns, which are assumed to behave differently`, `No — الجر is never a sign of الاسم, only أل and تنوين are`], correct: 0 },
        { title: `رب العالمين: الإضافة`, kind: 'mcq', prompt: `In رَبِّ العَالَمِينَ, رب stands as the first part of an إضافة. What does that show about رب؟`, options: [`It is an اسم, since it can be مضاف`, `It is a فعل, since it precedes another اسم`, `It is a حرف, since it has no تنوين`, `It is مبني على الفتح, the way many indeclinable particles are`], correct: 0 },
        { title: `مضاف vs مضاف إليه`, kind: 'mcq', prompt: `In رَبِّ العَالَمِينَ, which word is المضاف and which is المضاف إليه؟`, options: [`رَبِّ is المضاف, العَالَمِينَ is المضاف إليه`, `العَالَمِينَ is المضاف, رَبِّ is المضاف إليه`, `Both are المضاف, with neither serving as المضاف إليه`, `Neither is المضاف, since both stand as separate words`], correct: 0 },
        ...
        { title: `Picking out the recognised اسم among the six signs`, kind: 'mcq', prompt: `Which of these is one of the six recognised علامات الاسم described here?`, options: [`الإسناد إليه`, `التصريف إلى الماضي والمضارع`, `نون التوكيد`, `قبول ياء المخاطبة`], correct: 0 },
        {
          ...
          distractors: [`حرف عطف`, `اسم مجرور`, `مضاف إليه مجرور بالباء`, `مضاف`, `اسم مرفوع`, `فاعل مرفوع`],
        },
        {
          ...
          distractors: [`مضاف إليه مجرور`, `اسم مجرور`, `موصوف`, `نعت`, `خبر مرفوع`, `مبتدأ مرفوع`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Whether it occupies the grammatical position of an اسم, not whether it looks like one simple word`, `How many letters the expression has, as though longer expressions were more likely مركب`, `Whether the expression begins with أل, since definiteness is assumed to signal الصريح`, `Whether the expression is مذكر or مؤنث, a distinction assumed to affect this instead`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because الاسم المؤول is made of the حرف مصدر together with the جملة after it, interpreted together as a مصدر`, `Because أَنْ alone is already an اسم صريح, with no need for تَصُومُوا at all`, `Because تَصُومُوا alone already carries تنوين, which is assumed to be enough on its own`, `Because المبتدأ must always be two words, and أَنْ تَصُومُوا simply happens to be two`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `Which of the following correctly defines الاسم المؤول؟`, options: [`A حرف مصدر together with the جملة after it, interpreted together as one مصدر`, `The اسم by itself, with no حرف مصدر or جملة needed at all`, `Something that points to a ذات capable of taking a صفة`, `Something that points to the description of a موصوف`], correct: 0 },
      ...
      bank: [
        { title: `الصريح vs المؤول: what settles it`, kind: 'mcq', prompt: `An اسم may appear as one word, or a whole تركيب may take the place of an اسم in the جملة. What decides whether the expression is treated as الاسم الصريح or الاسم المؤول؟`, options: [`Whether it occupies the grammatical position of an اسم`, `Whether it has three letters or more`, `Whether it takes تنوين, treated here as the deciding mark`, `Whether it appears at the start of the جملة`], correct: 0 },
        { title: `تعريف الاسم الصريح`, kind: 'mcq', prompt: `Which of the following correctly defines الاسم الصريح؟`, options: [`The اسم by itself, with no reinterpretation needed since it's already an اسم`, `A حرف مصدر together with the جملة after it`, `A word that carries meaning in itself and is not tied to tense`, `Something whose parts do not indicate a meaning`], correct: 0 },
        ...
        { title: `Two parts of الاسم المؤول`, kind: 'mcq', prompt: `الاسم المؤول is built from two things together. What are they?`, options: [`A حرف مصدر, and the جملة after it`, `An اسم and a صفة`, `A فعل and its فاعل only`, `أل and تنوين, the two most familiar علامات الاسم`], correct: 0 },
        ...
        { title: `Why المؤول can stand as مبتدأ`, kind: 'mcq', prompt: `المبتدأ must be an اسم. Why can أَنْ تَصُومُوا stand as المبتدأ in وَأَنْ تَصُومُوا خَيْرٌ, even though it is built from a حرف and a جملة؟`, options: [`Because the construction is interpreted as a مصدر before the جملة is analysed further`, `Because حرف مصدر always counts as مبتدأ on its own`, `Because تصوموا alone is اسم صريح, with أن playing no real role`, `Because خير is the true مبتدأ instead, with أن تصوموا merely its خبر`], correct: 0 },
        { title: `تعريف الموصوف`, kind: 'mcq', prompt: `Which of the following correctly defines الموصوف؟`, options: [`Something that points to a ذات capable of taking a صفة`, `Something that points to the description of a موصوف`, `The اسم by itself, without any صفة or ذات mentioned`, `A حرف مصدر together with the جملة after it`], correct: 0 },
        ...
        { title: `عين vs معنى: the test`, kind: 'mcq', prompt: `What is the test that separates اسم عين from اسم معنى؟`, options: [`Whether the thing named exists in itself, or only exists in another`, `Whether the word has تنوين, treated here as the deciding mark`, `Whether the word is مذكر or مؤنث, treated as though that settled it`, `Whether the word begins with أل, as though definiteness decided the category`], correct: 0 },
        ...
        { title: `رجل صالح: الموصوف والصفة`, kind: 'mcq', prompt: `In رَجُلٌ صَالِحٌ, رجل is being described. What role does رجل play, and what role does صالح play?`, options: [`رجل is الموصوف, صالح is الصفة`, `رجل is الصفة, صالح is الموصوف`, `Both are الموصوف, with neither serving as الصفة`, `Both are الصفة, with neither serving as الموصوف`], correct: 0 },
        ...
        { title: `Meaning, not إعراب, decides`, kind: 'mcq', prompt: `رجل, علم, and عالم may all behave as أسماء inside a جملة and even share the same إعراب in different sentences. What actually decides whether each is اسم عين, اسم معنى, or اسم صفة؟`, options: [`The kind of meaning each word points to`, `The إعراب each word carries in a given جملة`, `Whether the word carries تنوين`, `The number of letters in the word`], correct: 0 },
        {
          ...
          distractors: [`اسم مؤول في محل رفع مبتدأ`, `خبر`, `اسم صريح`, `فعل ماضٍ`, `فعل أمر`, `فعل مضارع`],
        },
        {
          ...
          distractors: [`مصدر مؤول في محل نصب مفعول به`, `حرف مصدر`, `فعل مضارع مع فاعله`, `اسم صريح`, `مفعول به`, `مبتدأ مرفوع`],
        },
        {
          ...
          labels: [`موصوف`, `صفة`],
          distractors: [`منعوت`, `نعت`, `اسم صفة`, `اسم عين`, `اسم معنى`, `مضاف`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — a فعل is never without a فاعل, even when the doer is only understood`, `Yes — some أفعال, like الأفعال الجامدة, have no فاعل at all`, `Only if the فعل is أمر, since a request needs no doer named`, `Only if the فعل is مبني للمجهول, since its فاعل is hidden`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — their هيئة is هيئة اسم, not a هيئة فعل coined by وضع to indicate زمان`, `Yes — anything indicating زمان in context is a فعل`, `Yes, because غدًا always turns a word into a فعل`, `No, because they carry تنوين, which is mistaken here for a هيئة فعل`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It does not accept ياء المخاطبة — صهي cannot be formed for a woman`, `It does not indicate طلب at all`, `It is مبني للمجهول, which is mistaken for the reason it fails as أمر`, `It only appears in poetry, unlike true أفعال الأمر used in ordinary speech`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`A جار can enter upon them, as in نِعْمَ السَّيْرُ عَلَى بِئْسَ العَيْرِ`, `They both begin with نون, a pattern shared by several unrelated أفعال`, `They both accept ياء المخاطبة, the mark Basrans point to for أفعال الأمر`, `They both carry تنوين, a mark some claim proves they are أفعال`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `أَمس points to زمان, yet it is not classified as a فعل. Why not?`, options: [`It points to زمان through its مادة, not through a هيئة coined by وضع for that purpose`, `It never refers to الماضي, only ever to الحال or الاستقبال`, `It accepts تاء التأنيث, a mark normally reserved for أفعال`, `It accepts ياء المخاطبة, a sign normally reserved for فعل الأمر`], correct: 0 },
        ...
        { q: `اِجْلِسْ shows طلب and accepts ياء المخاطبة, while صَهْ shows طلب but cannot take ياء المخاطبة. What does that difference show?`, options: [`اِجْلِسْ is فعل أمر; صَهْ is not, since its طلب comes from its مادة, not its هيئة`, `Both are فعل أمر equally, since both plainly show طلب`, `Neither is فعل أمر, since neither carries a written نون التوكيد`, `صَهْ is فعل أمر but اِجْلِسْ is not, since only صَهْ resists ياء المخاطبة`], correct: 0 },
      ],
      bank: [
        { title: `تعريف الفعل`, kind: 'mcq', prompt: `Which of the following correctly defines الفعل?`, options: [`A word that carries meaning in itself while tied to tense`, `A word that carries meaning in itself and is not tied to tense`, `Something whose parts do not indicate a meaning`, `The اسم by itself, with no tie to زمان at all`], correct: 0 },
        ...
        { title: `أمس: مادة, not هيئة`, kind: 'mcq', prompt: `أَمس (yesterday) clearly points to زمان. Why is it still classified as an اسم rather than a فعل؟`, options: [`It points to زمان through its مادة, not through a هيئة coined for that purpose`, `It has no meaning at all, unlike a true اسم or فعل`, `It accepts نون التوكيد, a mark normally reserved for المضارع`, `It is مبني للمجهول, a status that has nothing to do with زمان`], correct: 0 },
        ...
        { title: `ليسجننّ vs ليكونًا: heavy or light`, kind: 'mcq', prompt: `لَيُسْجَنَنَّ ends in a written, doubled نون, while لَيَكُونًا ends in the same sign written as تنوين instead. Which is which?`, options: [`لَيُسْجَنَنَّ carries نون التوكيد الثقيلة; لَيَكُونًا carries نون التوكيد الخفيفة`, `لَيُسْجَنَنَّ carries نون التوكيد الخفيفة; لَيَكُونًا carries الثقيلة`, `Both carry the same نون التوكيد, with no heavy/light distinction between them`, `Neither carries نون التوكيد; the ending is something else entirely`], correct: 0 },
        { title: `قد: not tied to one زمن`, kind: 'mcq', prompt: `قَدْ سَمِعَ and قَدْ يَعْلَمُ both use قد, one with a ماضي فعل and one with a مضارع فعل. What does that show about قد as a sign?`, options: [`قد is علامة فعل generally, not a sign limited to one زمن`, `قد only marks الماضي, unlike لم or لن which mark المضارع`, `قد only marks المضارع, the same way لم and لن do`, `قد marks الأمر exclusively, the way ياء المخاطبة does`], correct: 0 },
        ...
        { title: `صه: طلب without فعل أمر`, kind: 'mcq', prompt: `صَهْ means "be quiet" and clearly shows طلب. Why does it fail to qualify as فعل أمر?`, options: [`صهي cannot be formed for a woman — it does not accept ياء المخاطبة`, `صهْ does not show طلب at all`, `صهْ is already مبني للمجهول, which is mistaken for why it fails as أمر`, `صهْ only appears with a مفعول به`], correct: 0 },
        { title: `نعم وبئس: Basran view`, kind: 'mcq', prompt: `Basran grammarians classify نِعْمَ and بِئْسَ as أفعال. What evidence supports that view?`, options: [`تاء التأنيث can enter upon them`, `They accept ياء المخاطبة`, `They accept أل`, `They carry تنوين`], correct: 0 },
        {
          ...
          distractors: [`فعل ماضٍ`, `فعل أمر + ياء المتكلم`, `مفعول به مضاف إلى ياء المخاطبة`, `حرف جر`, `فعل أمر`, `مفعول به`],
        },
      ],
    },
    // ---------------------------------------------------------------- L5
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`As one alphabet letter it is حرف مبنى; as the حرف جر باء it is حرف معنى`, `As حرف مبنى it takes تنوين; as حرف معنى it never does`, `حرف مبنى only appears in poetry, never in ordinary spelling`, `There is no real difference between the two senses`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `فِي indicates ظرفية, but that meaning stays incomplete until something follows it. What does that show about الحرف in general?`, options: [`Its meaning is completed only through something else`, `It always carries تنوين, the way a true اسم does`, `It never appears with an اسم`, `It behaves exactly like a فعل`], correct: 0 },
      ...
      bank: [
        { title: `تعريف الحرف`, kind: 'mcq', prompt: `Which of the following correctly defines الحرف؟`, options: [`A word whose meaning is completed only through something else`, `A word that carries meaning in itself while tied to tense`, `Something whose parts do not indicate a meaning`, `The اسم by itself, needing nothing else to complete its meaning`], correct: 0 },
        ...
        { title: `ب: two senses at once`, kind: 'mcq', prompt: `ب can be discussed as one alphabet letter, or as the حرف جر باء. Which sense applies in each case؟`, options: [`As an alphabet letter it is حرف مبنى; as حرف جر it is حرف معنى`, `Both cases are حرف مبنى, since ب never changes with context`, `Both cases are حرف معنى, since ب always carries grammatical meaning`, `As an alphabet letter it is حرف معنى; as حرف جر it is حرف مبنى`], correct: 0 },
        { title: `حرف مد: the definition`, kind: 'mcq', prompt: `What makes a weak letter a حرف مد؟`, options: [`It is ساكن and preceded by its matching vowel`, `It is متحرك and preceded by a فتحة`, `It always carries تنوين, mistaken here for the defining feature`, `It only appears at the end of a جملة`], correct: 0 },
        ...
        { title: `حرف لين: the definition`, kind: 'mcq', prompt: `What makes a ساكن و or ي a حرف لين rather than a حرف مد؟`, options: [`It is preceded by a فتحة rather than its matching vowel`, `It is preceded by تنوين, mistaken here for the deciding vowel`, `It never appears in a جملة`, `It always ends a word, regardless of what vowel comes before it`], correct: 0 },
        { title: `الخير في التوبة: identifying حروف اللين`, kind: 'mcq', prompt: `In الخَيْرُ فِي التَّوْبَةِ, the ي of الخَيْر follows a فتحة rather than a كسرة. What kind of حرف is that؟`, options: [`حرف لين`, `حرف مد`, `حرف مبنى فقط`, `حرف معنى فقط`], correct: 0 },
        {
          ...
          distractors: [`حرف جر`, `اسم مجرور بالباء`, `اسم مجرور`, `حرف عطف`, `مضاف إليه مجرور يتم به المعنى`, `حرف مبنى`],
        },
      ],
    },
  ],
