  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `When الفاعل moves ahead of its own verb rather than after it — as in زَيْدٌ قامَ — جمهور النحاة (أهل البصرة) read زَيْدٌ as مبتدأ and قامَ with its مستتر ضمير هو as خبر. أهل الكوفة instead keep زَيْدٌ as فاعل, just <bdi>مفصول</bdi> (separated) from its عامل. Both readings agree on the meaning; they differ only in how the الإعراب is structured — a real disagreement between the two great grammatical schools that the matn preserves rather than settles.`, list: false },
          ],
          exercise: {
      ...
      bank: [
        ...
        { title: `وكفى بالله وكيلا: الباء الزائدة`, kind: 'mcq', prompt: `In ﴿وَكَفَى بِاللهِ وَكيلًا﴾, اللهُ appears مجرور بالباء. What is its إعراب محلًّا?`, options: [`فاعل مرفوع محلًّا لِـ كَفَى`, `مفعول به منصوب محلًّا`, `مضاف إليه مجرور محلًّا فقط`, `خبر مرفوع محلًّا`], correct: 0 },
        ...
        { title: `لعنهم الله: ضمير متصل مفعول به`, kind: 'mcq', prompt: `﴿لَعَنَهُمُ اللهُ﴾ cannot become لَعَنَ اللهُ إِيّاهُمْ. Which وجوبًا reason explains why هُمُ must stay attached right after the verb?`, options: [`الفاعل ضمير متصل يلزم اتصاله — mirrored here for المفعول به`, `صدارة الكلام`, `الإضمار قبل الذكر`, `اللهُ is صدر الكلام here`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`لام قسم محذوف — every such sentence is treated as an implicit جواب قسم, as if a dropped وَاللهِ preceded it`, `لام الجر, marking a dropped مجرور`, `لام الأمر, marking a dropped فعل أمر`, `لام التعليل, marking a dropped سبب`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `﴿وَفَوْقَ كُلِّ ذِي عِلْمٍ عَليمٌ﴾ ("and above every possessor of knowledge is one more knowing"): فَوْقَ (شبه جملة) is fronted, letting the نكرة عَليمٌ serve as مبتدأ مؤخّر. From حديث الإسراء والمعراج: «عَلَوْنا السَّماءَ الدُّنْيا، فَإِذا رَجُلٌ قاعِدٌ» ("we ascended to the lowest heaven, and suddenly there was a man sitting") — رَجُلٌ works as مبتدأ purely because of إذا الفجائية. ﴿سَلامٌ عَلَيْكُمْ﴾ ("peace be upon you") and ﴿وَيْلٌ لِكُلِّ هُمَزَةٍ لُمَزَةٍ﴾ ("woe to every scorner and slanderer!") are both نكرة working as مبتدأ because each sentence is itself a دعاء, one a blessing and the other a curse.`, list: false },
      ...
      bank: [
        ...
        { title: `لام قسم محذوف`, kind: 'mcq', prompt: `Some grammarians treat forms like لَقَدْ جاءَتْ رُسُلُ رَبِّنا بِالحَقِّ as carrying a دdropped word before them. What is it?`, options: [`وَاللهِ — every such sentence is an implicit جواب قسم`, `يا — an implicit نداء`, `إنّ — an implicit توكيد حرف`, `لا — an implicit نفي`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `"All praise is for Allah, the Praiseworthy." الحَميدُ, describing اللهِ (مجرور here as مضاف إليه), would normally also be مجرور (الحَميدِ) to match. Instead it's cut loose and made مرفوع — أَيْ هُوَ الحَميدُ — turning the description into its own emphatic little sentence.`, list: false },
          ...
          exercise: {
            prompt: `الحَمْدُ لله الحَميدُ keeps الحَميدُ مرفوعًا, even though it describes اللهِ, which is مجرور as مضاف إليه. What does that مرفوع النعت signal?`,
            kind: 'mcq',
            options: [`قطع (cutting the نعت loose for emphasis) — it stands as خبر of a dropped مبتدأ هو (أَيْ هُوَ الحَميدُ)`, `A simple grammatical error the matn overlooks`, `That الحَميدُ is actually مضاف إليه too, agreeing with اللهِ`, `That the whole phrase is مبني, not معرب`], correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          lines: [
            ...
            { html: `"So, let there be beautiful patience." أَيْ صَبْري أَوْ أَمْري صَبْرٌ جَميلٌ. أَصْلُهُ: اِصْبِرْ صَبْرًا جَميلًا ("be beautifully patient") — the imperative اِصْبِرْ is dropped, its own مصدر (originally منصوب, صَبْرًا) switches to مرفوع (صَبْرٌ), and the shift itself carries meaning: turning a فعل (which suggests a one-off happening) into an اسم/جملة اسمية signals ثبات ودوام — patience not as a single act, but as a settled, lasting state.`, list: false },
          ],
          exercise: {
      ...
      quiz: [
        ...
        { q: `الحَمْدُ لله الحَميدُ keeps الحَميدُ مرفوعًا despite describing the مجرور اللهِ. What grammatical move does that reflect?`, options: [`النعت المقطوع إلى الرفع — cut loose from its منعوت's case, standing as خبر of a dropped مبتدأ هو`, `الخبر مصدر نائب عن فعله المحذوف`, `دلالة جواب القسم عليه`, `الخبر مخصوص بمدح أو ذم`], correct: 0 },
