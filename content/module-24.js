    ...
    // ---------------------------------------------------------------- L1
    {
      ...
      bank: [
        ...
        { title: `الفرق بين تأخير الفاعل جوازًا وتقديم المفعول به وجوبًا`, kind: 'mcq', prompt: `أكل الكمثرى موسى allows المفعول به first only because a قرينة removes الالتباس (جوازًا). لعنهم الله requires it (وجوبًا). What separates the two cases?`, options: [`In لعنهم الله, keeping المفعول به after الفاعل is actually impossible (a ضمير متصل cannot detach); in أكل الكمثرى موسى, either order works and a قرينة merely permits fronting`, `There is no real difference; both are جوازًا`, `لعنهم الله is جوازًا and أكل الكمثرى موسى is وجوبًا`, `The difference is only about الماضي vs المضارع`], correct: 0 },
        {
          ...
          distractors: [`مفعول به منصوب`, `نائب فاعل مرفوع`, `مبتدأ`, `فعل مضارع`],
        },
        {
          ...
          distractors: [`مبتدأ`, `خبر`, `حرف استفهام`, `مضاف إليه`],
        },
        {
          ...
          distractors: [`مفعول به منصوب`, `مبتدأ مرفوع`, `حال منصوبة`, `نائب فاعل مرفوع`],
        },
        {
          ...
          distractors: [`نائب فاعل مرفوع`, `خبر منصوب`, `مبتدأ مرفوع`, `مضاف إليه مجرور`],
        },
        {
          ...
          distractors: [`مبتدأ`, `نائب فاعل`, `فعل مضارع`, `حال منصوبة`],
        },
        {
          ...
          distractors: [`مبتدأ`, `نائب فاعل`, `فعل مضارع`, `خبر`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      bank: [
        ...
        { title: `حذف المبتدأ بعد القول`, kind: 'mcq', prompt: `In ﴿وَقَالُوا اَسَاطِيرُ الْاَوَّلِينَ﴾, what مبتدأ is dropped right after قالوا؟`, options: [`هِيَ`, `هُمْ`, `ذٰلِكَ`, `أَنْتَ`], correct: 0 },
        {
          ...
          distractors: [`فاعل مرفوع`, `مفعول به منصوب`, `مبتدأ مرفوع`, `فعل ماضٍ معلوم`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نائب فاعل مرفوع`, `خبر مقدّم`, `مبتدأ مؤخّر`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `مضاف إليه`, `خبر مقدّم مؤكَّد باللام`, `مبتدأ مؤخّر`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نعت مرفوع`, `نائب فاعل مرفوع`, `خبر لمبتدأ محذوف`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نائب فاعل مرفوع`, `مبتدأ`, `خبر مرفوع`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نائب فاعل مرفوع`, `مبتدأ مرفوع (نكرة مخصوصة بالإضافة)`, `مفعول به منصوب`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      bank: [
        ...
        { title: `تمييز المواضع الأربعة: أيها يقترن بالقسم`, kind: 'mcq', prompt: `Of the four مواضع لوجوب حذف المبتدأ, which one specifically depends on جواب القسم following it?`, options: [`إن دلّ عليه جواب القسم — as in في ذمتي لأقولنّ الصدق`, `النعت المقطوع إلى الرفع`, `الخبر مصدر نائب عن فعله`, `الخبر مخصوص بمدح أو ذم`], correct: 0 },
        {
          ...
          distractors: [`فاعل مرفوع`, `نعت مجرور`, `مخصوص بمدح (خبر لمبتدأ محذوف)`, `مضاف إليه`],
        },
        {
          ...
          distractors: [`مفعول به منصوب`, `مبتدأ مرفوع`, `خبر لمبتدأ محذوف بعد النعت المقطوع`, `مبتدأ مؤخّر`],
        },
        {
          ...
          distractors: [`مفعول به منصوب`, `مبتدأ مرفوع`, `مبتدأ مؤخّر`, `نعت`],
        },
        {
          ...
          distractors: [`مبتدأ مرفوع`, `نعت منصوب`, `مخصوص بمدح (خبر لمبتدأ محذوف)`, `فعل ماضٍ`],
        },
        {
          ...
          distractors: [`مبتدأ مرفوع`, `مفعول به منصوب`, `مخصوص بمدح (خبر لمبتدأ محذوف)`, `خبر لمبتدأ محذوف تقديره عَهْدٌ`],
        },
      ],
    },
  ],
