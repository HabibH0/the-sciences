  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`زَيْدٌ stays فاعل, just مفصول (separated) from its عامل قامَ`, `زَيْدٌ becomes مفعول به مقدّم, fronted ahead of a suppressed فاعل ضمير`, `قامَ becomes مبتدأ and زَيْدٌ becomes خبر`, `Both schools agree زَيْدٌ must be مبتدأ`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`قرينة معنوية — the impossibility of the reverse reading makes the intended فاعل obvious`, `قرينة لفظية — a visible إعراب marker on one of the two nouns settles it`, `Both قرينة معنوية and قرينة لفظية apply here together, each independently removing the ambiguity`, `No قرينة at all; the order here is actually required, not merely permitted`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — nothing forces it; it's purely بلاغة, often for وزن matching the surrounding rhyme`, `Yes — النُّذُرُ is a ضمير متصل that must stay attached`, `Yes — reversing the order here would create الالتباس, since neither noun carries a visible إعراب marker`, `Yes — آلَ فِرْعَوْنَ contains an اسم استفهام that must open the sentence`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`صدارة الكلام — أسماء الاستفهام like أَيّ must always open the sentence`, `الإضمار قبل الذكر — a pronoun inside المفعول به needs its referent mentioned first`, `الفاعل ضمير متصل يلزم اتصاله — the same pronoun-attachment problem, but on the other noun`, `Nothing forces it; the order here is جوازًا, purely for بلاغة`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `نَصَرَتْ موسَى سَلْمَى keeps its meaning clear even with موسَى appearing right after the verb. What resolves the ambiguity here?`, options: [`قرينة لفظية — the feminine ending نَصَرَتْ signals سَلْمَى is الفاعل`, `قرينة معنوية — the reverse reading is impossible`, `صدارة الكلام — سَلْمَى must open the sentence, since it names الفاعل`, `Nothing resolves it; the sentence is genuinely ambiguous`], correct: 0 },
        { q: `In ﴿وَإِذِ ابْتَلَى إِبْراهيمَ رَبُّهُ﴾, إِبْراهيمَ (مفعول به) must precede رَبُّهُ (فاعل). Which وجوبًا reason forces that?`, options: [`الإضمار قبل الذكر — the pronoun هُ inside رَبُّهُ needs إِبْراهيمَ mentioned first`, `الفاعل ضمير متصل يلزم اتصاله — رَبُّهُ contains a pronoun that must stay attached to its عامل`, `صدارة الكلام — إِبْراهيمَ itself is treated as claiming the front of the sentence`, `It is only جوازًا, for بلاغة — nothing here actually forces the order`], correct: 0 },
      ],
      bank: [
        ...
        { title: `كذكركم آباءكم: الإضافة إلى المصدر`, kind: 'mcq', prompt: `In ﴿كَذِكْرِكُمْ آباءَكُمْ﴾, why is كُمْ analysed as فاعل محلًّا despite being مضاف إليه لفظًا؟`, options: [`Because ذِكْر is a مصدر, and a مصدر governs its فاعل the same way a verb does`, `Because كُمْ always carries the فاعل إعراب regardless of context, no matter what governs it`, `Because آباءَكُمْ is itself the true فاعل here, and كُمْ is simply attached to it`, `Because إضافة never affects a pronoun's إعراب, so كُمْ keeps its underlying case regardless`], correct: 0 },
        ...
        { title: `زيد قام عند البصريين`, kind: 'mcq', prompt: `When الفاعل moves ahead of its own فعل, as in زَيْدٌ قامَ, how do جمهور النحاة (أهل البصرة) analyze the sentence?`, options: [`زَيْدٌ becomes مبتدأ, and قامَ with its مستتر ضمير هو becomes خبر`, `زَيْدٌ stays فاعل, simply مفصول from its عامل, exactly as الكوفيون read it`, `زَيْدٌ becomes مفعول به مقدّم, fronted ahead of a dropped فاعل`, `The sentence becomes ungrammatical once الفاعل is moved ahead of its فعل`], correct: 0 },
        { title: `زيد قام عند الكوفيين`, kind: 'mcq', prompt: `أهل الكوفة read the same sentence, زَيْدٌ قامَ, differently from أهل البصرة. How?`, options: [`زَيْدٌ remains فاعل, just فُصِلَ (separated) from its عامل قامَ`, `زَيْدٌ becomes مضاف إليه, governed by a dropped noun placed before it`, `قامَ becomes مبتدأ, with زَيْدٌ demoted to خبر مؤخّر`, `Kufan grammarians reject the sentence entirely, treating fronted الفاعل as ungrammatical`], correct: 0 },
        { title: `زار موسى عيسى: الالتباس`, kind: 'mcq', prompt: `زارَ موسَى عيسَى keeps الفاعل first because reversing it would create genuine ambiguity. What makes the ambiguity possible here?`, options: [`Neither name carries a visible إعراب marker (لا يظهر عليهما إعراب), so word order is the only clue`, `Both names are مؤنث, so تأنيث الفعل gives the listener no way to tell them apart`, `The verb زارَ has no فاعل at all, so word order carries no grammatical weight here`, `عيسَى is مبني على الضم, so its case never shows regardless of position`], correct: 0 },
        { title: `زارت هذه تلك: لماذا لا يكفي التأنيث`, kind: 'mcq', prompt: `زارَتْ هذِهِ تِلْكَ still requires تقديم الفاعل, despite the feminine ending on the verb. Why doesn't that ending resolve the ambiguity?`, options: [`Both هذِهِ and تِلْكَ are already مؤنث, so تأنيث الفعل doesn't distinguish which one is doing the visiting`, `تأنيث never functions as a قرينة in Arabic, so it could never have resolved the ambiguity anyway`, `هذِهِ and تِلْكَ are actually مذكر, not مؤنث, despite how they look`, `The verb here is مبني للمجهول, so it has no true فاعل to identify`], correct: 0 },
        { title: `أكل الكمثرى موسى: قرينة معنوية`, kind: 'mcq', prompt: `أَكَلَ الكُمَّثْرَى موسَى puts المفعول به first, yet stays unambiguous. What kind of قرينة makes that possible?`, options: [`قرينة معنوية — a guava eating a person is impossible, so the intended فاعل is obvious`, `قرينة لفظية — a visible case ending on الكُمَّثْرَى settles it`, `صدارة الكلام — الكُمَّثْرَى is treated as claiming the front of the sentence`, `الإضمار قبل الذكر — a pronoun inside الكُمَّثْرَى needs موسَى mentioned first`], correct: 0 },
        { title: `نصرت موسى سلمى: قرينة لفظية`, kind: 'mcq', prompt: `نَصَرَتْ موسَى سَلْمَى puts المفعول به first without confusion. What kind of قرينة resolves it?`, options: [`قرينة لفظية — the feminine verb ending نَصَرَتْ marks سَلْمَى as الفاعل`, `قرينة معنوية — helping is a one-directional act, so only one reading makes sense`, `صدارة الكلام — سَلْمَى is treated as claiming the front of the sentence`, `There is no قرينة; the sentence is genuinely ambiguous either way`], correct: 0 },
        ...
        { title: `تقديم المفعول به جوازًا`, kind: 'mcq', prompt: `المفعول به can move ahead of الفاعل purely جوازًا. What governs that kind of fronting?`, options: [`بلاغة (style/balance), with no grammatical necessity either way`, `الإضمار قبل الذكر — a pronoun in المفعول به needing its referent mentioned first`, `صدارة الكلام — a word that must always open the sentence`, `ضمير متصل يلزم اتصاله — an attached pronoun that cannot detach`], correct: 0 },
        { title: `ولقد جاء آل فرعون النذر`, kind: 'mcq', prompt: `In ﴿وَلَقَدْ جاءَ آلَ فِرْعَوْنَ النُّذُرُ﴾, آلَ فِرْعَوْنَ (مفعول به) precedes النُّذُرُ (فاعل). Why?`, options: [`Purely للبلاغة, often for وزن matching the surrounding rhyme — nothing forces it`, `الإضمار قبل الذكر — a pronoun inside النُّذُرُ needs آلَ فِرْعَوْنَ mentioned first`, `النُّذُرُ is a ضمير متصل that must stay attached to its عامل`, `آلَ فِرْعَوْنَ contains أداة استفهام, which always claims صدر الكلام`], correct: 0 },
        { title: `وإذ ابتلى إبراهيم ربه: الإضمار قبل الذكر`, kind: 'mcq', prompt: `﴿وَإِذِ ابْتَلَى إِبْراهيمَ رَبُّهُ﴾ requires إِبْراهيمَ (مفعول به) before رَبُّهُ (فاعل). What would go wrong if the order were reversed?`, options: [`The pronoun هُ inside رَبُّهُ would refer to إِبْراهيمَ before إِبْراهيمَ is mentioned — never permitted`, `رَبُّهُ would become مبني, since it could no longer hold its own إعراب position`, `The verb ابْتَلَى would lose its فاعل entirely, leaving the sentence incomplete`, `Nothing — the reversed order is equally correct and just as unambiguous`], correct: 0 },
        { title: `لعنهم الله: ضمير متصل مفعول به`, kind: 'mcq', prompt: `﴿لَعَنَهُمُ اللهُ﴾ cannot become لَعَنَ اللهُ إِيّاهُمْ. Which وجوبًا reason explains why هُمُ must stay attached right after the verb?`, options: [`الفاعل ضمير متصل يلزم اتصاله — mirrored here for المفعول به`, `صدارة الكلام — هُمُ is treated as claiming the front of the sentence`, `الإضمار قبل الذكر — a pronoun inside اللهُ needs هُمُ mentioned first`, `لَفْظُ الجَلالَةِ is صدر الكلام here, and صدر الكلام always fronts`], correct: 0 },
        { title: `فأي آيات الله تنكرون: صدارة الكلام`, kind: 'mcq', prompt: `﴿فَأَيَّ آياتِ اللهِ تُنْكِرونَ﴾ opens with المفعول به أَيَّ آياتِ اللهِ. Why must it come first?`, options: [`أسماء الاستفهام like أَيّ always claim صدر الكلام — they can never appear anywhere but the front`, `أَيَّ آياتِ اللهِ is a ضمير متصل that must stay attached to its عامل`, `تُنْكِرونَ has no فاعل at all, so no fronting rule even applies here`, `It is purely جوازًا, for وزن — nothing in the sentence actually forces this order`], correct: 0 },
        { title: `الفرق بين تأخير الفاعل جوازًا وتقديم المفعول به وجوبًا`, kind: 'mcq', prompt: `أكل الكمثرى موسى allows المفعول به first only because a قرينة removes الالتباس (جوازًا). لعنهم الله requires it (وجوبًا). What separates the two cases?`, options: [`In لعنهم الله, keeping المفعول به after الفاعل is actually impossible (a ضمير متصل cannot detach); in أكل الكمثرى موسى, either order works and a قرينة merely permits fronting`, `There is no real difference between the two cases; both merely permit fronting whenever a قرينة happens to be present`, `The labels are reversed: لعنهم الله is actually جوازًا, purely stylistic, while أكل الكمثرى موسى is the one that is truly وجوبًا`, `The difference is only about tense — لعنهم الله uses الماضي, and the same fronting would require المضارع in أكل الكمثرى موسى`], correct: 0 },
        {
          ...
          distractors: [`نائب فاعل مرفوع`, `مفعول به منصوب`, `مبتدأ مرفوع`, `فعل مضارع`, `فعل ماضٍ مبني للمجهول`, `اسم كان مرفوع`],
        },
        {
          ...
          distractors: [`حرف جر أصلي`, `مفعول به مجرور لفظًا منصوب محلًّا`, `فاعل مرفوع`, `حرف استفهام`, `مبتدأ مرفوع`, `فعل ماضٍ ومفعوله (الياء)`],
        },
        {
          ...
          distractors: [`فاعل مجرور لفظًا بِمِنْ مرفوع محلًّا`, `مفعول به منصوب`, `حال منصوبة`, `مبتدأ مرفوع`, `نائب فاعل مرفوع`, `تمييز مجرور`],
        },
        {
          ...
          distractors: [`مبتدأ مرفوع`, `فاعل مؤخّر مرفوع`, `مفعول به مقدّم منصوب`, `نائب فاعل مرفوع`, `مضاف إليه مجرور`, `خبر مرفوع`],
        },
        {
          ...
          distractors: [`مفعول به (ضمير متصل يلزم اتصاله)`, `فاعل مرفوع`, `نائب فاعل مرفوع`, `مبتدأ مرفوع`, `فعل مضارع`, `حال منصوبة`],
        },
        {
          ...
          distractors: [`فاعل مقدّم (ضمير متصل يلزم اتصاله)`, `نائب فاعل مقدّم (ضمير متصل يلزم اتصاله)`, `مفعول به مقدّم منصوب`, `فاعل مرفوع`, `مبتدأ مرفوع`, `خبر مرفوع`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`جاءَ in this سببي sense is متعدٍّ بحرف جر, not بنفسه, so no bare noun exists to promote — شبه الجملة itself steps in`, `شبه الجملة always outranks any bare noun as نائب الفاعل, regardless of how the verb takes its object`, `جَهَنَّمَ is مبني, so it cannot itself serve as نائب الفاعل no matter how the verb behaves`, `The verb جيءَ has no فاعل requirement at all, so نائب الفاعل never applies to it in the first place`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`(1) راغِبٌ مبتدأ مكتفٍ بمرفوعه وأَنْتَ فاعله سادّ مسدّ الخبر; (2) أَنْتَ مبتدأ مؤخّر وراغِبٌ خبر مقدّم`, `Only one reading is valid: راغِبٌ must be خبر مقدّم and أَنْتَ مبتدأ مؤخّر`, `(1) راغِبٌ فعل ماضٍ meaning "he wanted"; (2) أَنْتَ is simply its فاعل`, `أَراغِبٌ أَنْتَ has no valid grammatical reading at all — it is a broken sentence`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`لام قسم محذوف — every such sentence is treated as an implicit جواب قسم, as if a dropped وَلَفْظِ الجَلالَةِ preceded it`, `لام الجر, marking a dropped مجرور that the sentence never actually states`, `لام الأمر, marking a dropped فعل أمر that the speaker leaves understood`, `لام التعليل, marking a dropped سبب behind the statement that follows`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`عَمَلُهُ, understood from context — dropping is especially common right after فاء الجواب`, `هُوَ, understood from context — dropping is especially common after النداء`, `Nothing is dropped; لِنَفْسِهِ is itself المبتدأ here, fronted for emphasis`, `الرَّجُلُ, understood from context — dropping only happens after الاستفهام`],
            correct: 0,
          },
        },
      ],
      quiz: [
        ...
        { q: `﴿وَجيءَ يَوْمَئِذٍ بِجَهَنَّمَ﴾ has a شبه الجملة, not a bare noun, serving as نائب الفاعل. What condition on the underlying verb makes that possible?`, options: [`The verb (جاءَ in its سببي sense) is متعدٍّ بحرف جر, not بنفسه`, `The verb is مضارع, not ماضٍ, and only مضارع verbs allow a شبه جملة نائب فاعل`, `شبه الجملة can always replace a bare noun as نائب الفاعل, with no condition`, `The verb has no فاعل at all in its active form`], correct: 0 },
        { q: `In ﴿أَراغِبٌ أَنْتَ عَنْ آلِهَتي﴾, راغِبٌ is called المبتدأ المكتفي بمرفوعه on one valid reading. What does مكتفٍ بمرفوعه mean here?`, options: [`It has no separate خبر — راغِبٌ and أَنْتَ together already form a complete predication`, `It requires two separate أخبار, one for راغِبٌ and one for أَنْتَ`, `It can never take a فاعل, since مكتفٍ بمرفوعه noun types don't govern`, `It is معرفة, not نكرة, and that definiteness alone licenses it as مبتدأ`], correct: 0 },
        { q: `لَكاذِبٌ أَنْتَ carries لام التوكيد on كاذِبٌ rather than on أنت. Why?`, options: [`كاذِبٌ is خبر مقدّم here, and لام الابتداء may enter on a fronted خبر`, `لام الابتداء can never enter on المبتدأ itself, only ever on a fronted خبر`, `أنت already carries an implicit لام, so a second one on كاذِبٌ would be redundant`, `كاذِبٌ is فعل ماضٍ here, not خبر, so اللام marks the verb instead`], correct: 0 },
        { q: `﴿كُلٌّ يَعْمَلُ عَلى شاكِلَتِهِ﴾ opens with the نكرة كُلٌّ and nothing visibly narrows it. How does it still count as مخصوصة؟`, options: [`By an understood إضافة تقديرًا (أَيْ كُلُّ أَحَدٍ)`, `By coming after الاستفهام, which alone licenses a bare نكرة`, `By coming after النفي, which alone licenses a bare نكرة`, `It doesn't — كُلٌّ here is actually ungrammatical as مبتدأ`], correct: 0 },
      ...
      bank: [
        ...
        { title: `نوعا المبتدأ: التمييز`, kind: 'mcq', prompt: `محمد رسول الله shows one type of المبتدأ; أراغب أنت عن آلهتي shows the other. Which is which؟`, options: [`محمد: اسم مجرد عن عامل لفظي مسند إليه؛ راغب: اسم عامل رافع لاسم ظاهر بعد استفهام`, `محمد: اسم عامل رافع لاسم ظاهر؛ راغب: اسم مجرد عن عامل لفظي مسند إليه`, `Both illustrate the same type — the everyday اسم مجرد عن عامل مبتدأ`, `محمد is not مبتدأ at all here; it is simply خبر of a dropped pronoun`], correct: 0 },
        { title: `المبتدأ المكتفي بمرفوعه`, kind: 'mcq', prompt: `Why is راغِبٌ in أَراغِبٌ أَنْتَ called المبتدأ المكتفي بمرفوعه?`, options: [`Because it has no separate خبر — its own مرفوع (أَنْتَ) already completes the predication`, `Because it can never appear after استفهام without governing a following اسم`, `Because it always carries تنوين, marking it as indefinite by nature`, `Because it is معرفة by definition, unlike the ordinary نكرة مبتدأ`], correct: 0 },
        { title: `القراءتان الجائزتان لأراغب أنت`, kind: 'mcq', prompt: `أَراغِبٌ أَنْتَ has two valid grammatical parses. In the second one, what role does أَنْتَ play?`, options: [`مبتدأ مؤخّر, with راغِبٌ as خبر مقدّم`, `فاعل سادّ مسدّ الخبر, with راغِبٌ as مبتدأ`, `مفعول به of راغِبٌ, since راغِبٌ governs it in the accusative`, `مضاف إليه of راغِبٌ, completing an إضافة between the two`], correct: 0 },
        ...
        { title: `لام الابتداء على المضارع والماضي المقرون بقد`, kind: 'mcq', prompt: `لام الابتداء can enter on more than الجملة الاسمية; لَأَقولُ الحَقَّ and ﴿لَقَدْ جاءَتْ رُسُلُ رَبِّنا بِالحَقِّ﴾ show it entering on which two forms?`, options: [`المضارع, and الماضي المقرون بقد`, `الأمر, and المصدر`, `الجامد فقط, and nothing beyond that one category`, `الحال والتمييز, wherever either happens to open the sentence`], correct: 0 },
        { title: `لام قسم محذوف`, kind: 'mcq', prompt: `Some grammarians treat forms like لَقَدْ جاءَتْ رُسُلُ رَبِّنا بِالحَقِّ as carrying a dropped word before them. What is it?`, options: [`وَلَفْظِ الجَلالَةِ — every such sentence is an implicit جواب قسم`, `يا — an implicit نداء the speaker leaves out for brevity`, `إنّ — an implicit توكيد حرف strengthening the sentence that follows`, `لا — an implicit نفي that the surrounding context supplies`], correct: 0 },
        { title: `الأصل في المبتدأ: معرفة`, kind: 'mcq', prompt: `What is الأصل (the default) for المبتدأ's definiteness, and when is a نكرة allowed instead?`, options: [`The default is معرفة; a نكرة is allowed if it is مفيدة (conveys useful information)`, `The default is always نكرة, and معرفة only appears in special cases`, `المبتدأ can never be نكرة, no matter what قرينة exists`, `معرفة and نكرة are equally the default, with no difference`], correct: 0 },
        ...
        { title: `ما أحد خيرا من أحد إلا بالتقوى: نكرة عامة بعد النفي`, kind: 'mcq', prompt: `ما أَحَدٌ خَيْرًا مِنْ أَحَدٍ إِلّا بِالتَّقْوَى lets the bare نكرة أَحَدٌ serve as مبتدأ. What licenses it?`, options: [`Coming after النفي, which makes its generality the whole point`, `An implicit إضافة تقديرًا, narrowing أَحَدٌ down to a specific group`, `An implicit صفة تقديرًا, narrowing أَحَدٌ down without being written`, `Coming after إذا الفجائية, which alone licenses a bare نكرة`], correct: 0 },
        { title: `أإله مع الله: نكرة عامة بعد الاستفهام`, kind: 'mcq', prompt: `﴿ءَاِلٰهٌ مَعَ اللهِ﴾ lets the bare نكرة إِلٰهٌ serve as مبتدأ. Why?`, options: [`الاستفهام itself asks about existence in general, not a specific already-known إله`, `إِلٰهٌ carries an implicit إضافة, narrowing it down to a specific group`, `إِلٰهٌ carries an implicit صفة, narrowing it down without being written`, `الجملة here is دعاء, and a دعاء always licenses a bare نكرة مبتدأ`], correct: 0 },
        { title: `وفوق كل ذي علم عليم: خبر شبه جملة مقدم`, kind: 'mcq', prompt: `﴿وَفَوْقَ كُلِّ ذِي عِلْمٍ عَليمٌ﴾ lets the نكرة عَليمٌ serve as مبتدأ مؤخّر. What licenses it?`, options: [`Its خبر, the شبه الجملة فَوْقَ كُلِّ ذِي عِلْمٍ, has been fronted ahead of it`, `It comes after النفي, which alone licenses a bare نكرة`, `It comes after الاستفهام, which alone licenses a bare نكرة`, `الجملة هنا دعاء, and a دعاء always licenses a bare نكرة مبتدأ`], correct: 0 },
        { title: `فإذا رجل قاعد: بعد إذا الفجائية`, kind: 'mcq', prompt: `«فَإِذا رَجُلٌ قاعِدٌ» lets the نكرة رَجُلٌ serve as مبتدأ. What licenses it?`, options: [`إذا الفجائية alone`, `An implicit إضافة narrowing رَجُلٌ down`, `النفي, which alone licenses a bare نكرة`, `الاستفهام, which alone licenses a bare نكرة`], correct: 0 },
        ...
        { title: `حذف المبتدأ بعد القول`, kind: 'mcq', prompt: `In ﴿وَقَالُوا اَسَاطِيرُ الْاَوَّلِينَ﴾, what مبتدأ is dropped right after قالوا؟`, options: [`هِيَ`, `هُمْ`, `ذٰلِكَ`, `أَنْتَ`], correct: 0 },
        {
          ...
          distractors: [`فعل ماضٍ معلوم`, `فاعل مرفوع`, `مفعول به منصوب`, `معطوف على الفاعل مرفوع`, `معطوف على نائب الفاعل منصوب`, `نائب فاعل (شبه جملة)`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نائب فاعل مرفوع`, `خبر مقدّم`, `مبتدأ مؤخّر`, `فاعل سادّ مسدّ الخبر`, `نعت مرفوع`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `مضاف إليه مجرور`, `خبر مقدّم مؤكَّد باللام`, `مبتدأ مؤخّر`, `مبتدأ مؤكَّد باللام (نكرة مخصوصة بالإضافة)`, `مبتدأ مرفوع (نكرة عامة)`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نعت مرفوع`, `نائب فاعل مرفوع`, `خبر لمبتدأ محذوف`, `مبتدأ مرفوع (نكرة مخصوصة بالوصف)`, `جملة فعلية في محل نصب حال`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نائب فاعل مرفوع`, `مبتدأ مرفوع`, `خبر مرفوع`, `خبر لمبتدأ محذوف تقديره هو`, `فعل الشرط وفاعله`],
        },
        {
          ...
          distractors: [`فاعل مرفوع`, `نائب فاعل مرفوع`, `مبتدأ مرفوع (نكرة مخصوصة بالإضافة)`, `مفعول به منصوب`, `مبتدأ مرفوع (نكرة عامة بعد النفي)`, `خبر مرفوع`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`In these four مواضع the مبتدأ must be dropped — keeping it stated would itself be incorrect, not just unnecessary`, `وجوب الحذف means the exact opposite: the مبتدأ can never be dropped in these four مواضع`, `There is no real difference between جوازًا and وجوبًا here — both simply permit dropping`, `وجوب الحذف only applies to المبتدأ المكتفي بمرفوعه, not to these four مواضع at all`], correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`قطع (cutting the نعت loose for emphasis) — it stands as خبر of a dropped مبتدأ هو (أَيْ هُوَ الحَميدُ)`, `A simple grammatical error the matn overlooks, with no deeper rule behind it`, `That الحَميدُ is actually مضاف إليه too, agreeing with لَفْظِ الجَلالَةِ`, `That the whole phrase is مبني, not معرب, so no case ending really applies`], correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`عَهْدٌ (or وَعْدٌ/قَسَمٌ) — the جواب القسم لَأَقولَنَّ that follows already makes the solemn undertaking clear`, `هُوَ — dropped simply because المبتدأ is always droppable before في`, `الصِّدْقَ itself — moved from مفعول به into مبتدأ once the verb is dropped`, `أَنا — dropped because الفعل لَأَقولَنَّ is مضارع and already names its own فاعل`], correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It signals ثبات ودوام — patience as a settled, lasting state, rather than a فعل's one-off happening`, `Nothing — the shift is purely grammatical, with no added meaning`, `It changes الصبر from مفرد to جمع, intensifying the amount of patience meant`, `It turns the imperative into a question, softening the original command`], correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`المُجْتَهِدُ is مبتدأ مؤخّر, with the whole جملة نِعْمَ الطّالِبُ serving as خبر مقدّم for a dropped هو`, `المُجْتَهِدُ is فاعل نعم, and الطّالِبُ is المخصوص instead`, `المشهور rejects both readings and treats the sentence as ungrammatical`, `المُجْتَهِدُ is مفعول به of نعم, with الطّالِبُ still serving as its فاعل`], correct: 0,
          },
        },
      ],
      quiz: [
        { q: `Four positions require وجوب حذف المبتدأ. How does وجوبًا differ from the earlier rule on حذف المبتدأ جوازًا؟`, options: [`In these four positions the مبتدأ must be dropped, not merely permitted to drop`, `وجوبًا means the مبتدأ can never be dropped, the exact opposite of what's meant`, `There is no difference between the two — both merely permit dropping when a قرينة supplies it`, `وجوبًا only applies to اسم كان وأخواتها, not to المبتدأ الاسمي at all`], correct: 0 },
        { q: `الحَمْدُ لله الحَميدُ keeps الحَميدُ مرفوعًا despite describing the مجرور لَفْظِ الجَلالَةِ. What grammatical move does that reflect?`, options: [`النعت المقطوع إلى الرفع — cut loose from its منعوت's case, standing as خبر of a dropped مبتدأ هو`, `الخبر مصدر نائب عن فعله المحذوف — a dropped imperative's مصدر switching from منصوب to مرفوع`, `دلالة جواب القسم عليه — the following جواب القسم already signals a solemn undertaking`, `الخبر مخصوص بمدح أو ذم — the fixed praise/blame noun after نعم or بئس`], correct: 0 },
        { q: `في ذِمَّتي لَأَقولَنَّ الصِّدْقَ drops its مبتدأ (عهد/وعد/قسم). What licenses that drop?`, options: [`The following جواب القسم (لَأَقولَنَّ) already makes the solemn undertaking clear`, `النعت هنا مقطوع إلى الرفع, cut loose from its منعوت's case for emphasis`, `الخبر هنا مصدر نائب عن فعله, standing in for a dropped imperative`, `الخبر هنا مخصوص بمدح, the fixed praise noun after نعم`], correct: 0 },
        { q: `﴿فَصَبْرٌ جَميلٌ﴾'s أصل is اِصْبِرْ صَبْرًا جَميلًا. Why must the مبتدأ before صَبْرٌ be dropped once صَبْرًا shifts from منصوب to مرفوع؟`, options: [`Because الخبر here is a مصدر نائب عن فعله المحذوف — that specific position requires حذف المبتدأ`, `Because صَبْرٌ is مبني, not معرب, so it cannot itself carry the خبر's رفع`, `Because اِصْبِرْ is فعل أمر, and أفعال الأمر never take a مبتدأ`, `The مبتدأ is not actually dropped here; صَبْرٌ itself is المبتدأ`], correct: 0 },
        { q: `نِعْمَ الطّالِبُ المُجْتَهِدُ. On the plain reading given first, what is المُجْتَهِدُ's role?`, options: [`المخصوص بالمدح — خبر لمبتدأ محذوف تقديره هو`, `فاعل نعم, agreeing with الطّالِبُ as one grammatical unit`, `مفعول به, taking النصب from a hidden transitive sense`, `مضاف إليه, completing an إضافة with الطّالِبُ`], correct: 0 },
        { q: `النحاة disagree over نعم/بئس's مخصوص. What does المشهور (the well-known position) say about المُجْتَهِدُ in نِعْمَ الطّالِبُ المُجْتَهِدُ؟`, options: [`It is مبتدأ مؤخّر, and نِعْمَ الطّالِبُ as a whole is خبر مقدّم`, `It is فاعل نعم, with الطّالِبُ reanalyzed as المخصوص instead`, `It is حال منصوبة, describing the state of الطّالِبُ`, `النحاة all agree on one single reading, with no dispute`], correct: 0 },
      ],
      bank: [
        ...
        { title: `في ذمتي لأقولنّ الصدق: دلالة جواب القسم`, kind: 'mcq', prompt: `فِي ذِمَّتي لَأَقولَنَّ الصِّدْقَ drops its مبتدأ. What signals to the listener that a solemn undertaking is being made, letting the drop happen?`, options: [`جواب القسم — لَأَقولَنَّ — that follows`, `النعت المقطوع إلى الرفع — a نعت cut loose from its منعوت's case`, `الفاء الرابطة لجواب الشرط — the فاء linking a شرط's جواب`, `أداة الاستفهام — a question-word opening the sentence`], correct: 0 },
        ...
        { title: `فصبر جميل: الخبر مصدر نائب عن فعله`, kind: 'mcq', prompt: `In فَصَبْرٌ جَميلٌ, what role does صَبْرٌ play once the imperative اِصْبِرْ is dropped?`, options: [`خبر لمبتدأ محذوف — a مصدر standing in for the dropped فعل`, `مفعول به منصوب, taking النصب from a hidden transitive verb`, `فاعل مرفوع, agreeing with a hidden فعل مضارع`, `مضاف إليه مجرور, completing an إضافة with جَميلٌ`], correct: 0 },
        { title: `الدلالة في تحول صبرا إلى صبر`, kind: 'mcq', prompt: `Switching صَبْرًا (منصوب, نائب عن فعله) into صَبْرٌ (مرفوع, خبر لمبتدأ محذوف) does more than change الإعراب. What extra meaning does it add?`, options: [`ثبات ودوام — patience as a lasting state, not a single event`, `تقليل — a smaller amount of patience than intended`, `تنكير — making صبر indefinite for the first time`, `Nothing beyond the bare grammar — the shift carries no extra meaning at all`], correct: 0 },
        { title: `نعم الطالب المجتهد: المخصوص`, kind: 'mcq', prompt: `نِعْمَ الطّالِبُ المُجْتَهِدُ. On the plain reading, what role does المُجْتَهِدُ play?`, options: [`المخصوص بالمدح — خبر لمبتدأ محذوف تقديره هو`, `فاعل نعم, agreeing with الطّالِبُ as one grammatical unit`, `مفعول به لنعم, taking النصب from a hidden transitive sense`, `نعت للطالب, describing it directly rather than predicating anything`], correct: 0 },
        { title: `بئس الطالب الكسول: المخصوص بالذم`, kind: 'mcq', prompt: `بِئْسَ الطّالِبُ الكَسولُ. What role does الكَسولُ play, on the plain reading?`, options: [`المخصوص بالذم — خبر لمبتدأ محذوف تقديره هو`, `فاعل بئس, agreeing with الطّالِبُ as one grammatical unit`, `مفعول به لبئس, taking النصب from a hidden transitive sense`, `مضاف إليه, completing an إضافة with الطّالِبُ`], correct: 0 },
        ...
        { title: `تمييز المواضع الأربعة: أيها يقترن بالقسم`, kind: 'mcq', prompt: `Of the four مواضع لوجوب حذف المبتدأ, which one specifically depends on جواب القسم following it?`, options: [`إن دلّ عليه جواب القسم — as in في ذمتي لأقولنّ الصدق`, `النعت المقطوع إلى الرفع — a نعت cut loose from its منعوت's case for emphasis`, `الخبر مصدر نائب عن فعله — a مصدر standing in for a dropped imperative`, `الخبر مخصوص بمدح أو ذم — the fixed praise/blame noun after نعم or بئس`], correct: 0 },
        {
          ...
          distractors: [`فاعل مرفوع`, `نعت مجرور`, `مخصوص بمدح (خبر لمبتدأ محذوف تقديره هو)`, `مضاف إليه مجرور`, `خبر لمبتدأ محذوف تقديره عَهْدٌ`, `خبر لمبتدأ محذوف تقديره صَبْري`],
        },
        {
          ...
          distractors: [`مفعول به منصوب`, `فعل ماضٍ جامد للذم`, `فاعل بئس مرفوع`, `مخصوص بالذم (خبر لمبتدأ محذوف تقديره هو)`, `مبتدأ مؤخّر`, `خبر مقدّم`],
        },
        {
          ...
          distractors: [`مفعول به منصوب`, `فعل ماضٍ جامد للمدح`, `فاعل نعم مرفوع`, `مخصوص بالمدح (خبر لمبتدأ محذوف تقديره هو)`, `مبتدأ مؤخّر`, `خبر مقدّم`],
        },
        {
          ...
          distractors: [`مبتدأ مرفوع`, `نعت منصوب`, `مخصوص بمدح (خبر لمبتدأ محذوف تقديره هو)`, `فعل ماضٍ`, `خبر لمبتدأ محذوف تقديره صَبْري`, `فعل مضارع مبني في جواب الشرط وفاعله المستتر`],
        },
        {
          ...
          distractors: [`مبتدأ مرفوع`, `مفعول به منصوب`, `مخصوص بمدح (خبر لمبتدأ محذوف تقديره هو)`, `خبر لمبتدأ محذوف تقديره عَهْدٌ`, `نعت مقطوع مرفوع`, `خبر لمبتدأ محذوف تقديره صَبْرًا (مصدر نائب عن فعله المحذوف)`],
        },
      ],
    },
  ],
