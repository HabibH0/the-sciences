  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مُفاعَلة — a mutual, reciprocal action`, `تشبيه — a comparison`, `تَرْتيب — a sequence`, `it cannot be reinterpreted at all`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `صلَّى رسولُ الله ﷺ قاعدًا وصلَّى وراءَه رجالٌ قيامًا gives رجالٌ as an unlicensed indefinite ذو الحال, with none of the four مسوِّغات present. How does the source describe this pattern؟`, options: [`قليل نادر — rare and exceptional, not the norm`, `The standard, most common pattern`, `Impossible in Arabic`, `Only valid in poetry, never in حديث`], correct: 0 },
        ...
        { q: `بعتُه يدًا بيد uses يدًا بيد, a جامد pair, as a حال reinterpreted through one of three senses. Which one؟`, options: [`مُفاعَلة (a reciprocal action)`, `تشبيه`, `تَرْتيب`, `it cannot be reinterpreted`], correct: 0 },
        { q: `﴿فَتَمَّ مِيقَاتُ رَبِّهِ أَرْبَعِينَ لَيْلَةً﴾ uses أَرْبَعِينَ لَيْلَةً, a عدد, as حال. Under اشتقاق الحال, which category does a عدد حال fall into؟`, options: [`جامدة غير مؤوَّلة بالمشتق`, `جامدة مؤوَّلة بالمشتق`, `مشتقة`, `موطِّئة، وهذا اسم الموضع الوحيد`], correct: 0 },
      ],
      bank: [
        ...
        { title: `قرآنا عربيا: موصوفة`, kind: 'mcq', prompt: `﴿إِنَّا أَنزَلْنَاهُ قُرْآنًا عَرَبِيًّا﴾'s قُرْآنًا is qualified by the description that follows it, عَرَبِيًّا. Which جامدة غير مؤوَّلة position is that؟`, options: [`مَوْصوفة (الحال الموطِّئة)`, `عَدَد`, `أصل`, `فرع`], correct: 0 },
        {
          ...
          distractors: [`صاحب الحال المفعول به`, `حال مؤكِّدة`, `حال سببية`, `مفعول به`],
        },
        {
          ...
          distractors: [`صاحب الحال الفاعل`, `حال سببية`, `حال مترادفة`, `مفعول به`],
        },
        {
          ...
          distractors: [`مضاف إليه`, `حال مؤكِّدة`, `حال جامدة غير مؤوَّلة (موصوفة)`, `مفعول به`],
        },
        {
          ...
          distractors: [`مفعول به`, `حال محكية`, `حال جامدة مؤوَّلة بالمشتق (تشبيه)`, `حال جامدة غير مؤوَّلة (عدد)`],
        },
        {
          ...
          distractors: [`صاحب الحال الفاعل`, `حال مقدَّرة`, `حال جامدة غير مؤوَّلة (عدد)`, `مفعول به`],
        },
        {
          ...
          distractors: [`مفعول به`, `حال لازمة`, `حال جامدة غير مؤوَّلة (أصلًا لصاحبها)`, `حال جامدة مؤوَّلة بالمشتق (تشبيه)`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`لازِمة (ثابتة، دائمة)`, `مُتَنَقِّلة`, `مؤسِّسة`, `مقدَّرة`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`مقدَّرة (مستقبلة)`, `محكية (ماضية)`, `مقارِنة (حاضرة)`, `لازمة`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        { q: `الأصل في الحال أن تكون متنقلة. In ﴿وَخُلِقَ الْإِنسَانُ ضَعِيفًا﴾, الضعف is permanently attached to الإنسان rather than passing. What type is ضَعِيفًا؟`, options: [`لازمة (ثابتة)`, `متنقلة`, `مؤسِّسة`, `مقارِنة`], correct: 0 },
        { q: `﴿وَلَا تَمْشِ فِي الْأَرْضِ مَرَحًا﴾ — مَرَحًا adds the very manner being prohibited, genuinely new information beyond تمش itself. Which type, باعتبار الاستقلال؟`, options: [`مؤسِّسة (مبيِّنة)`, `مؤكِّدة`, `لازمة`, `محكية`], correct: 0 },
        ...
        { q: `In ﴿قَالَ رَبِّ أَنَّىٰ يَكُونُ لِي غُلَامٌ وَقَدْ بَلَغَنِيَ الْكِبَرُ﴾, بلوغ الكبر had already happened before the moment of speaking. Which زمن category is that حال؟`, options: [`محكية (ماضية)`, `مقارِنة`, `مقدَّرة`, `لازمة`], correct: 0 },
        { q: `In ﴿فَادْخُلُوهَا خَالِدِينَ﴾, الخلود happens after الدخول, not alongside it. Which زمن category؟`, options: [`مقدَّرة (مستقبلة)`, `محكية`, `مقارِنة`, `مؤسِّسة`], correct: 0 },
        { q: `يَبْكُونَ in ﴿وَجَاءُوا أَبَاهُمْ عِشَاءً يَبْكُونَ﴾ serves as the worked example for both متنقلة (باعتبار الثبات) and مقارِنة (باعتبار الزمن) at once. What does that double use show about these two محاور؟`, options: [`They classify the same حال independently, along separate axes, at the same time`, `Only one of the two axes can really apply`, `متنقلة always implies مقارِنة`, `مقارِنة overrides متنقلة whenever both apply`], correct: 0 },
      ],
      bank: [
        ...
        { title: `محكية vs مقدَّرة`, kind: 'mcq', prompt: `Both محكية and مقدَّرة place الحال outside the exact moment of العامل. What distinguishes them؟`, options: [`محكية is already past by حال القول; مقدَّرة still lies ahead of العامل`, `محكية is always مشتقة; مقدَّرة is always جامدة`, `They are two names for the identical category`, `مقدَّرة only applies to أفعال الأمر`], correct: 0 },
        ...
        { title: `جدول: باعتبار الزمن`, kind: 'mcq', prompt: `باعتبار الزمن produces exactly which three subtypes؟`, options: [`محكية، مقارِنة، مقدَّرة`, `متنقلة، لازمة، مؤسِّسة`, `مؤكِّدة، محكية، حقيقية`, `مترادفة، متداخلة، سببية`], correct: 0 },
        {
          ...
          distractors: [`حال لازمة`, `مضاف إليه`, `حال مقصودة`, `حال مؤسِّسة`],
        },
        {
          ...
          distractors: [`مفعول به`, `حال مقارِنة`, `حال متنقلة`, `فاعل`],
        },
        {
          ...
          distractors: [`مفعول به`, `حال محكية`, `حال مؤكِّدة`, `حال متنقلة`],
        },
        {
          ...
          distractors: [`مفعول به`, `حال مقدَّرة`, `حال مؤسِّسة`, `حال لازمة`],
        },
        {
          ...
          distractors: [`حال محكية`, `مفعول به ثانٍ`, `حال مقارِنة`, `حال متنقلة`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      bank: [
        ...
        { title: `موطِّئة: نفس الجامدة الموصوفة`, kind: 'mcq', prompt: `الحال الموطِّئة under باعتبار القصد is described as identical to which category already met under اشتقاق الحال؟`, options: [`الجامدة الموصوفة بمشتق`, `الجامدة المؤولة بتشبيه`, `الجامدة المؤولة بمفاعلة`, `المشتقة`], correct: 0 },
        ...
        { title: `التعدد: التعريف`, kind: 'mcq', prompt: `تعدد الحال arises under which specific condition؟`, options: [`When more than one حال attaches to a single صاحب`, `When ذو الحال is مركب`, `Whenever الحال is جامدة`, `Whenever الحال is مؤكِّدة`], correct: 0 },
        ...
        { title: `متداخلة: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines مُتَداخِلة؟`, options: [`الحال الثانية هي في الحقيقة حال من ضمير مستتر داخل الحال الأولى`, `صاحبها يبقى واحدًا، وكل الأحوال تصفه مباشرة`, `الحال جامدة غير مؤوَّلة بالمشتق`, `الحال تصف صاحبها مباشرة`], correct: 0 },
        ...
        { title: `سببية: التعريف`, kind: 'mcq', prompt: `Which of the following correctly defines الحال السببية؟`, options: [`تصف حال شيء متعلق بصاحبها، لا صاحبها نفسه مباشرة`, `تصف صاحبها مباشرة`, `تحمل تنوين العوض`, `تكون مشتقة دائمًا`], correct: 0 },
        { title: `خشعا: سببية، لا حقيقية`, kind: 'mcq', prompt: `خُشَّعًا in ﴿خُشَّعًا أَبْصَارُهُمْ يَخْرُجُونَ مِنَ الْأَجْدَاثِ﴾ describes أَبْصَارُهُمْ, not الناس (صاحب الحال) directly. Why is it not حقيقية؟`, options: [`Because حقيقية requires describing صاحبها directly, and خشعا instead describes something merely attached to صاحبها`, `Because خشعا is جامدة`, `Because خشعا is مقدَّرة`, `Because خشعا has no صاحب at all`], correct: 0 },
        ...
        { title: `سبعة محاور مستقلة`, kind: 'mcq', prompt: `Across both lessons on أقسام الحال, how many independent classification محاور does the source lay out for a single حال altogether (including الاشتقاق)؟`, options: [`سبعة`, `اثنان فقط`, `أربعة`, `عشرة`], correct: 0 },
        {
          ...
          distractors: [`حال مقصودة بذاتها`, `صاحب الحال`, `حال حقيقية`, `مفعول به`],
        },
        {
          ...
          distractors: [`حال متداخلة`, `مضاف إليه`, `حال حقيقية`],
        },
        {
          ...
          distractors: [`حال مترادفة`, `نعت`, `حال مقدَّرة`, `حال سببية`],
        },
        {
          ...
          distractors: [`حال حقيقية`, `مفعول به`, `حال متداخلة`, `مضاف إليه`],
        },
      ],
    },
  ],
