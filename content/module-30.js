  ...
  lessons: [
    // ---------------------------------------------------------------- L1
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Yes — the خبر of الأفعال الناقصة may be fronted ahead of its own اسم while الفعل الناقص itself stays put`, `No — the اسم must always precede the خبر, the same fixed order an ordinary مبتدأ وخبر pair keeps`, `Yes, but only with لَيْسَ specifically, since لَيْسَ alone among الأفعال الناقصة allows this kind of reordering`, `No — fronting is only allowed with كانَ, since كانَ is the most basic of الأفعال الناقصة`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because ما المصدرية has صَدارَةُ الكَلامِ and must stay at the very start of its own جملة`, `Because ما دامَ has no خبر at all, unlike the other أفعال ناقصة that always carry one`, `Because قائمًا can never be fronted in Arabic, not even ahead of an ordinary فعل تام`, `Because زيد must always come immediately after دام, the same way اسم كان normally follows كانَ directly`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because ما here resembles لَيْسَ in meaning (نفي) and borrows its whole عمل — رفع الاسم ونصب الخبر`, `Because بشرًا is always منصوب regardless of ما, the same way خبر الأفعال الناقصة is always منصوب regardless of which فعل ناقص is used`, `Because هذا governs بشرًا into النصب directly, the same way a فعل متعدٍ governs its مفعول به`, `Because ما here is ما المصدرية, not ما النافية, and only ما المصدرية carries صَدارَةُ الكَلامِ`],
            correct: 0,
          },
        },
        {
      ...
      quiz: [
        ...
        { q: `Why can't قائِمًا ما دامَ زَيْدٌ be said?`, options: [`Because ما المصدرية has صدارة الكلام and must open its own جملة`, `Because دام has no خبر, unlike the other أفعال ناقصة that always carry one`, `Because قائمًا can never serve as a خبر, only as حال`, `Because زيد must be indefinite, and only نكرة nouns can be fronted this way`], correct: 0 },
      ...
      bank: [
        ...
        { title: `إنه كان صديقا نبيا: عدد الأخبار`, kind: 'mcq', prompt: `﴿إِنَّهُ كَانَ صِدِّيقًا نَبِيًّا﴾ — صِدِّيقًا and نَبِيًّا. How many خبر منصوب does كانَ carry here?`, options: [`Two — both صديقًا and نبيًّا are خبران منصوبان لكان`, `One — نبيًّا is a نعت لصديقًا, not a second خبر`, `Two, but only نبيًّا is the true خبر`, `None — both are حال, describing the state of إنّه rather than serving as خبر كان`], correct: 0 },
        { title: `تقديم الخبر على الاسم: ليس سواء`, kind: 'mcq', prompt: `لَيْسَ سَواءً عالِمٌ وَجَهولٌ — سواءً comes before عالِمٌ, its own اسم. Is fronting the خبر ahead of اسم كان وأخواتها permitted?`, options: [`Yes — the خبر may be fronted ahead of its own اسم while الفعل الناقص stays put`, `No — the اسم must always precede the خبر, exactly as with an ordinary مبتدأ وخبر`, `Yes, but only for لَيْسَ specifically, since لَيْسَ alone permits this kind of reordering`, `No — fronting is only allowed with كانَ, since it is the most basic of الأفعال الناقصة`], correct: 0 },
        ...
        { title: `ما دام: امتناع التقديم`, kind: 'mcq', prompt: `Why can ما دامَ زَيْدٌ قائِمًا be said, but not قائِمًا ما دامَ زَيْدٌ?`, options: [`Because ما المصدرية has صدارة الكلام and must open its جملة, nothing may be fronted ahead of it`, `Because دام has no خبر to front, unlike the other أفعال ناقصة that always carry one`, `Because زيد must always come first, the same way الفاعل must always come right after its فعل`, `Because قائمًا cannot ever be fronted in Arabic, not even ahead of an ordinary فعل تام`], correct: 0 },
        ...
        { title: `صدارة الكلام`, kind: 'mcq', prompt: `صَدارَةُ الكَلامِ, the "right of first place," is why a particle like ما المصدرية or ما النافية must open its own جملة. What does that rule forbid?`, options: [`Fronting anything ahead of that particle, or even ahead of the word it immediately governs`, `Fronting the خبر ahead of the اسم only, since صدارة الكلام is specifically about that one type of fronting`, `Using the particle with أفعال ناقصة at all, as if صدارة الكلام forbade combining such particles with النواسخ altogether`, `Repeating the particle more than once, as if صدارة الكلام were a rule about repetition rather than position`], correct: 0 },
        ...
        { title: `ما هذا بشرا`, kind: 'mcq', prompt: `﴿مَا هَٰذَا بَشَرًا﴾ — بَشَرًا comes out منصوبًا. Why, given that ما is normally just a plain negating particle?`, options: [`Here ما resembles لَيْسَ in meaning (نفي), and borrows its whole عمل: رفع الاسم ونصب الخبر`, `بشرا is always منصوب regardless of ما, the same way خبر الأفعال الناقصة is always منصوب regardless of which فعل ناقص is used`, `هذا governs بشرا into النصب directly, the same way a فعل متعدٍ governs its مفعول به`, `ما here is ما المصدرية, not ما النافية, and only ما المصدرية carries صَدارَةُ الكَلامِ`], correct: 0 },
        ...
        { title: `أثر النواسخ على المبتدأ والخبر`, kind: 'mcq', prompt: `خبر الأفعال الناقصة and خبر الحروف المشبهة بليس both take النصب because of a governing عامل — a فعل ناقص in one case, a حرف مشبه بليس in the other. What do both أعمال do to a plain مبتدأ وخبر pair?`, options: [`Both raise the اسم into الرفع and push the خبر into النصب, unlike a plain خبر which stays مرفوع`, `Both raise the اسم and the خبر into الرفع, the way an ordinary مبتدأ وخبر pair both stay مرفوعان`, `Both push the اسم and the خبر into النصب, the same way الأفعال الناقصة push only the خبر`, `Neither changes the إعراب of either word — النواسخ only add emphasis, according to this view`], correct: 0 },
        {
    ...
    // ---------------------------------------------------------------- L2
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because الشمس والليل are both معرفة, and a single unrepeated لا cannot negate the whole جنس of an already-definite noun`, `Because الشمس والليل are مؤنث, and مؤنث nouns always require لا to be repeated`, `Because لا never governs more than one اسم, so a second لا is needed for each additional noun`, `Because الواو forces repetition automatically, the same way it forces agreement between two معطوفات`],
            correct: 0,
          },
        },
        {
      ...
      bank: [
        { title: `اسم لا: نصب لفظًا أم بناء؟`, kind: 'mcq', prompt: `اسم لا النافية للجنس never takes الرفع. Its two possible إعراب outcomes are نصب لفظًا and بناء في محل نصب. What decides which of the two applies?`, options: [`Its own shape — whether it is مضاف, شبيه بالمضاف, or a plain مفرد/جمع/مثنى`, `Whether its خبر is محذوف or ظاهر, the same way اسم لا itself can be dropped when السياق allows`, `Whether لا itself is مكررة (repeated) or not, since تكرار changes what إعراب the اسم can take`, `Whether the جملة is إثباتًا or نفيًا, since لا النافية للجنس only ever appears in a نفي جملة`], correct: 0 },
        ...
        { title: `دخول لا على المعرفة`, kind: 'mcq', prompt: `﴿لَا الشَّمْسُ يَنبَغِي لَهَا أَن تُدْرِكَ الْقَمَرَ وَلَا اللَّيْلُ سَابِقُ النَّهَارِ﴾ repeats لا once for الشمس and once for الليل. Why does لا need repeating here rather than negating both at once؟`, options: [`Because الشمس والليل are both معرفة, and a single unrepeated لا cannot negate the whole جنس of an already-definite noun`, `Because الشمس والليل are مؤنث, and مؤنث nouns always require تكرار لا for extra emphasis`, `Because لا can never govern more than one اسم in a sentence, so a second لا is required for each additional noun`, `Because الواو forces repetition automatically, the same way it forces agreement between two معطوفات`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L3
    {
      ...
      quiz: [
        ...
        { q: `A زائد حرف جر draws a noun into الجر لفظًا. Does that change the noun's true grammatical role؟`, options: [`No — the true role stays exactly what it would be without the حرف`, `Yes — the noun becomes truly مجرور, replacing whatever role it had before the حرف was added`, `Yes — the noun becomes مبنيًّا instead, the same way اسم لا becomes مبني when it is a plain مفرد`, `No, but only if the حرف is بـ specifically`], correct: 0 },
      ],
      bank: [
        ...
        { title: `أجيب دعوة الداع: أي نوع؟`, kind: 'mcq', prompt: `﴿أُجِيبُ دَعْوَةَ الدَّاعِ﴾ — الدَّاعِ is مجرور. Which type؟`, options: [`مجرور بالإضافة, because it is مضاف إليه`, `مجرور بحرف الجر, the way القِسط was drawn into الجر by الباء earlier in this lesson`, `مجرور لفظًا لكنه مرفوع محلًّا, the way لَفْظُ الجَلالَةِ appears in ﴿وَكَفَىٰ بِاللَّهِ وَكِيلًا﴾`, `مجرور لفظًا لكنه منصوب محلًّا, the way شيء appears in ﴿مَا كَانَ لَنَا أَن نُّشْرِكَ بِاللَّهِ مِن شَيْءٍ﴾`], correct: 0 },
        ...
        { title: `التمييز: منصوب أم مجرور؟`, kind: 'mcq', prompt: `التمييز is usually classified under المنصوبات as a matter of تغليب (convenience). Does that mean it is always منصوب in fact؟`, options: [`No — it can in fact be مجرور بالإضافة instead, as ﴿فِي سِتَّةِ أَيَّامٍ﴾ shows`, `Yes — التمييز is always منصوب without exception, exactly the way خبر الأفعال الناقصة is always منصوب`, `No — التمييز is always مجرور بحرف الجر, never منصوب, the same way المضاف إليه is always مجرور`, `Yes, unless it follows a عدد, in which case a different rule about الفاعلية takes over instead`], correct: 0 },
    ...
    // ---------------------------------------------------------------- L4
    {
      ...
      concepts: [
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It simply follows (تبعية) the إعراب of the word before it, its متبوع`, `It always takes النصب regardless of what precedes it`, `It is always مرفوع, like a مبتدأ, since every تابع is said to mirror the ابتداء of its جملة`, `It has no إعراب at all, since only a معمول governed by a direct عامل can have one`],
            correct: 0,
          },
        },
        {
        ...
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`No — it functions as نعت because ياء النسبة turns a جامد noun into a descriptive one, extending the مشابه للمشتق principle`, `Yes — every اسم منسوب is a true مشتق, since ياء النسبة is itself considered a derivational letter`, `No — الاسم المنسوب can never serve as نعت, since it always names a nationality or origin, not a quality`, `Yes, because it ends in تنوين, the same مشتق-marking تنوين that اسم الفاعل carries`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`Because it is نعت سببي, which follows its فاعل الظاهر (أهلها) in تذكير/تأنيث and عدد, not its منعوت`, `Because النعت never agrees with its منعوت in Arabic, not even in الإعراب or التعريف/التنكير`, `Because القرية is actually مذكر, despite its تاء مربوطة ending`, `Because الظالم is not really a نعت here, but a خبر ثانٍ instead`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`أل on العِقاب, standing in for the dropped عِقابُهُ`, `تنوين on شديد, marking it as نكرة the way تنوين usually does`, `Nothing — نعت سببي doesn't always need a ضمير`, `A hidden ضمير مستتر, the same kind نعت حقيقي uses`],
            correct: 0,
          },
        },
        {
          ...
          exercise: {
            ...
            kind: 'mcq',
            options: [`It has been dropped, leaving صَالِحًا (the نعت) alone to carry the sentence, since السياق makes عملا recoverable`, `It has become the نعت instead of صالحا, the two having simply swapped roles`, `It has been replaced by أل, the same way أل can stand in for a dropped ضمير elsewhere in this lesson`, `Nothing — عملا is still present, just unvoweled, and simply left out of the transcription here`],
            correct: 0,
          },
        },
      ],
      quiz: [
        { q: `Which of the following correctly defines النعت?`, options: [`The word that describes its متبوع and follows it in إعراب`, `A word that takes its إعراب from a direct عامل`, `The متبوع itself, the very word that a نعت is supposed to describe`, `A حرف linking two متبوعين together, the way a حرف عطف links two متعاطفين`], correct: 0 },
      ...
      bank: [
        { title: `النعت: تعريفه`, kind: 'mcq', prompt: `Which of the following correctly defines النعت (also called صِفَة)؟`, options: [`The word that describes its متبوع and follows it in إعراب`, `A word that takes its إعراب from a direct عامل, not from what precedes it`, `The word being described, also called منعوت, the one a نعت always follows in إعراب`, `A حرف that links two متبوعين together, the way a حرف عطف links two معطوفات`], correct: 0 },
        ...
        { title: `التابع: من أين يأخذ إعرابه؟`, kind: 'mcq', prompt: `Unlike المرفوعات، المنصوبات، والمجرورات, a تابع such as النعت doesn't take its إعراب from a direct عامل at all. Where does it come from instead؟`, options: [`It follows (تبعية) the إعراب of the word before it, its متبوع`, `It is always منصوب regardless of context, the same way خبر الأفعال الناقصة is always منصوب`, `It is always مرفوع, like a مبتدأ, since every تابع is thought to mirror ابتداء`, `It has no fixed إعراب at all, since only a معمول with a direct عامل is said to have one`], correct: 0 },
        ...
        { title: `اذهبوا بقميصي هذا: اسم الإشارة نعتًا`, kind: 'mcq', prompt: `﴿اذْهَبُوا بِقَمِيصِي هَٰذَا﴾ — هٰذا describes قميصي, meaning "the shirt that is pointed-to." Is هٰذا a true مشتق؟`, options: [`No — it is مشابه للمشتق, carrying a descriptive sense without being derived from a فعل`, `Yes — اسم الإشارة is always a true مشتق, since إشارة itself implies a derived action of pointing`, `No — اسم الإشارة can never serve as نعت, only اسم موصول can play that role`, `Yes, because it points to something specific, the same way a مشتق points to a specific فعل`], correct: 0 },
        ...
        { title: `كوكب دري: الاسم المنسوب نعتًا`, kind: 'mcq', prompt: `دُرِّيٌّ in ﴿كَوْكَبٌ دُرِّيٌّ﴾ ends in ياء النسبة and functions as نعت, meaning "resembling الدُّرّ (pearl) in brightness." Is الاسم المنسوب a true مشتق؟`, options: [`No — it functions as نعت because ياء النسبة turns a جامد noun into a descriptive one, extending the مشابه للمشتق principle`, `Yes — every اسم منسوب is a true مشتق, since ياء النسبة is itself considered a derivational letter`, `No — الاسم المنسوب can never serve as نعت, since it always names a nationality or origin, not a quality`, `Yes, because it ends in تنوين, the same مشتق-marking تنوين that اسم الفاعل carries`], correct: 0 },
        { title: `النعت الحقيقي: ماذا يتبع فيه متبوعه؟`, kind: 'mcq', prompt: `A نعت حقيقي follows its متبوع in every respect. Which four things؟`, options: [`الإعراب، التعريف أو التنكير، التذكير أو التأنيث، والإفراد أو التثنية أو الجمع`, `الإعراب والتعريف فقط, treating النعت الحقيقي the same way a نعت سببي is treated`, `التذكير والتأنيث فقط, since a نعت is fundamentally about matching gender before anything else`, `العدد فقط, since الإفراد والتثنية والجمع is the one category every تابع must match`], correct: 0 },
        { title: `النعت السببي: ماذا يتبع فيه متبوعه؟`, kind: 'mcq', prompt: `A نعت سببي follows its متبوع in only two respects, unlike النعت الحقيقي. Which two؟`, options: [`الإعراب، والتعريف أو التنكير`, `التذكير والتأنيث, the same two categories a نعت حقيقي must always match too`, `الإفراد والتثنية والجمع, since a نعت سببي is expected to match its منعوت in number, if nothing else`, `الإعراب فقط, since a نعت سببي otherwise behaves nothing like its منعوت at all`], correct: 0 },
        { title: `فاعل النعت الحقيقي والسببي`, kind: 'mcq', prompt: `A نعت حقيقي's فاعل is a hidden ضمير مستتر referring back to المنعوت. What kind of فاعل does a نعت سببي have instead؟`, options: [`اسم ظاهر (an explicit noun) named right after it`, `A second ضمير مستتر, identical to النعت الحقيقي's`, `No فاعل at all, since a نعت سببي is thought to describe its منعوت directly without one`, `A ضمير متصل attached to المنعوت itself`], correct: 0 },
        { title: `القرية الظالم أهلها: لماذا لم يطابق النعت متبوعه في التأنيث؟`, kind: 'mcq', prompt: `﴿مِنْ هَٰذِهِ الْقَرْيَةِ الظَّالِمِ أَهْلُهَا﴾ — الظّالِمِ is مفرد ومذكر even though its منعوت القَرْيَة is مؤنث. Why؟`, options: [`Because it is نعت سببي, and follows its فاعل الظاهر (أهلها, مذكر) in تذكير/تأنيث, not its منعوت`, `Because النعت never agrees with its منعوت in Arabic, not even in الإعراب or التعريف/التنكير`, `Because القرية is secretly مذكر, despite its تاء مربوطة ending`, `Because الظالم is not really a نعت in this ayah, but a خبر ثانٍ instead`], correct: 0 },
        { title: `شديد العقاب: أل بدل الضمير`, kind: 'mcq', prompt: `﴿شَدِيدِ الْعِقَابِ﴾ means شَديدٍ عِقابُهُ. A نعت سببي normally needs an explicit ضمير tying it back to its منعوت. What stands in for that ضمير here؟`, options: [`أل on العِقاب, filling in silently for the dropped عِقابُهُ that a نعت سببي would otherwise need`, `تنوين on شديد, the usual mark that shows a نعت سببي's noun is نكرة`, `No ضمير is needed at all in this case, since الإضافة alone does the job`, `A hidden ضمير مستتر, the same kind النعت الحقيقي uses`], correct: 0 },
        { title: `النكتة البلاغية في النعت السببي`, kind: 'mcq', prompt: `﴿الْقَرْيَةِ الظَّالِمِ أَهْلُهَا﴾ pins the wrongdoing on أهلها, not on القرية itself — while elsewhere the Qur'an calls مكة المكرمة directly, never المكة الظالمة, even though its people erred too. What does النعت السببي make possible that النعت الحقيقي doesn't؟`, options: [`Describing something through what is connected to it, without pinning the description directly onto the original noun`, `Describing something in a way that always flatters it, the way النعت الحقيقي is said to always do`, `Describing a معرفة noun without تكرار, the way لا النافية للجنس sometimes needs`, `Avoiding the need for a فاعل altogether, the way النعت الحقيقي's hidden ضمير مستتر seems to do`], correct: 0 },
        { title: `واعملوا صالحا: حذف المنعوت`, kind: 'mcq', prompt: `﴿وَاعْمَلُوا صَالِحًا﴾ is understood as وَاعْمَلُوا عَمَلًا صَالِحًا. What has happened to عَمَلًا, the منعوت, in the actual wording؟`, options: [`It has been dropped, leaving صَالِحًا (the نعت) alone to carry the sentence, since السياق makes عملا recoverable`, `It has become the نعت instead of صالحا, the two having simply swapped roles`, `It has been replaced by أل, the same way أل can stand in for a dropped ضمير elsewhere`, `It is still present, just spelled differently, and simply easy to miss in the transcription`], correct: 0 },
        {
