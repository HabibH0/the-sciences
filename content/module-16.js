    ...
    // ---------------------------------------------------------------- L1
    {
      ...
      bank: [
        ...
        { title: `تمييز نعم عن بلى في نفس السياق`, kind: 'mcq', prompt: `لَمْ يَقُمْ زَيْدٌ (Zayd did not stand) is answered once with نعم and once, hypothetically, with بلى. What is the difference in meaning between the two answers?`, options: [`نعم confirms Zayd did NOT stand; بلى would mean Zayd DID stand`, `Both would mean Zayd did not stand`, `Both would mean Zayd did stand`, `نعم is grammatically impossible here`], correct: 0 },
        {
          ...
          distractors: [`مبتدأ`, `حرف جواب: يقلب النفي إلى إثبات`, `حرف جواب: يوافق قطبية السؤال المنفي`, `حرف جواب نادر يجيب عن استفهام`],
        },
        {
          ...
          distractors: [`حرف جواب: يقلب النفي إلى إثبات`, `مفعول به`, `حرف جواب: يوافق قطبية السؤال المثبت`, `مبتدأ`],
        },
        {
          ...
          distractors: [`مبتدأ`, `حرف جواب: يوافق قطبية السؤال`, `حرف جواب: يقلب الخبر المنفي إلى مثبت`, `مفعول به`],
        },
        {
          ...
          distractors: [`مضاف إليه`, `حرف جواب: يوافق قطبية الخبر`, `حرف جواب: يقلب السؤال المنفي إلى مثبت`, `مفعول به`],
        },
      ],
    },
    // ---------------------------------------------------------------- L2
    {
      ...
      bank: [
        ...
        { title: `القسم: الشرط الوحيد على إي`, kind: 'mcq', prompt: `Which of the following best describes the single grammatical restriction placed on إي؟`, options: [`It must be immediately followed by a قسم`, `It must never be followed by anything`, `It must always answer a negative question`, `It must always be repeated twice`], correct: 0 },
        {
          ...
          distractors: [`حرف جواب يقلب المنفي إلى مثبت`, `مبتدأ`, `حرف جواب يوافق على خبر سابق`, `حرف جواب نادر يجيب عن استفهام`],
        },
        {
          ...
          distractors: [`حرف جواب يأتي جوابا عن استفهام فقط`, `حرف نفي`, `حرف جواب لا يأتي إلا قبل القسم`, `فاعل`],
        },
      ],
    },
    // ---------------------------------------------------------------- L3
    {
      ...
      bank: [
        ...
        { title: `الردع يفترض كلاما سابقا`, kind: 'mcq', prompt: `كلا's rebuking sense (الزجر) is described as a رد عن مضمون كلام سابق. What does that require the rebuke to be directed at؟`, options: [`The content of something said or implied just before it`, `A future event that has not yet occurred`, `A grammatical rule stated elsewhere`, `Nothing in particular — it can stand with no preceding content at all`], correct: 0 },
        {
          ...
          distractors: [`حرف زجر وردع`, `مبتدأ`, `حرف جواب: يوافق قطبية السؤال المنفي`, `حرف جواب: يقلب النفي إلى إثبات`],
        },
        {
          ...
          distractors: [`حرف نفي محايد`, `حرف جواب: يوافق قطبية السؤال`, `حرف تصديق لما قبلها`, `حرف استفتاح`],
        },
        {
          ...
          distractors: [`حرف زجر وردع`, `مفعول به`, `فعل مضارع مجزوم`, `مضاف إليه`],
        },
      ],
    },
    // ---------------------------------------------------------------- L4
    {
      ...
      bank: [
        ...
        { title: `وقف كلا يتبع معناها لا شكلها`, kind: 'mcq', prompt: `What determines where the recitation pause falls around a given instance of كلا؟`, options: [`Which of its meanings is intended in that instance`, `The number of letters in the surrounding سورة`, `Whether the سورة is long or short`, `Whether كلا appears at the very start of the سورة`], correct: 0 },
        {
          ...
          distractors: [`حرف زجر وردع`, `مفعول به`, `حرف استفتاح`, `حرف تصديق`],
        },
        {
          ...
          distractors: [`حرف جواب: تصديق`, `حرف استفتاح`, `حرف زجر وردع`, `فاعل`],
        },
      ],
    },
    // ---------------------------------------------------------------- L5
    {
      ...
      bank: [
        ...
        { title: `التوكيد بلا تغيير في المعنى الأساسي`, kind: 'mcq', prompt: `Does adding لام الابتداء or اللام المزحلقة change a sentence's basic meaning, or only add emphasis؟`, options: [`It only adds emphasis; the basic meaning stays the same`, `It reverses the sentence's basic meaning`, `It changes السؤال into a خبر`, `It changes المبتدأ into الخبر`], correct: 0 },
        {
          ...
          distractors: [`مقترن باللام المزحلقة`, `حرف جواب`, `خبر مقترن باللام في جواب القسم`, `فاعل`],
        },
        {
          ...
          distractors: [`مبتدأ مقترن بلام الابتداء`, `حرف جواب`, `خبر إنّ مقترن باللام في جواب القسم`, `فاعل`],
        },
        {
          ...
          distractors: [`مبتدأ مقترن بلام الابتداء`, `جواب القسم`, `خبر إنّ مقترن باللام في جواب القسم`, `فعل مضارع مقترن بنون التوكيد`],
        },
        {
          ...
          distractors: [`مبتدأ مقترن بلام الابتداء`, `جواب القسم`, `شبه جملة خبر إنّ مقترن باللام في جواب القسم`, `اسم إنّ مقترن باللام المزحلقة`],
        },
        {
          ...
          distractors: [`مبتدأ مقترن بلام الابتداء`, `خبر إنّ مقترن باللام المزحلقة`, `فعل مضارع مقترن بنون التوكيد الثقيلة`, `القسم مقترن باللام`],
        },
        {
          ...
          distractors: [`مبتدأ مقترن بلام الابتداء`, `جواب القسم`, `خبر إنّ مؤخر مقترن باللام المزحلقة`, `شبه جملة خبر إنّ مقدم مقترن باللام المزحلقة`],
        },
      ],
    },
    // ---------------------------------------------------------------- L6
    {
      ...
      bank: [
        ...
        { title: `أحرف التأكيد الخمسة مجتمعة`, kind: 'mcq', prompt: `Naming all five together, which list correctly gives the complete set of أحرف التأكيد؟`, options: [`لام الابتداء, اللام المزحلقة, اللام في جواب القسم, نونا التأكيد, and قد`, `لام الابتداء, اللام المزحلقة, نعم, بلى, and قد`, `نونا التأكيد, قد, لا, كلا, and إي`, `اللام المزحلقة, اللام في جواب القسم, أجل, إنه, and جير`], correct: 0 },
        {
          ...
          distractors: [`فعل ماضٍ`, `مبتدأ مقترن بلام الابتداء`, `فعل مضارع مقترن باللام المزحلقة`, `فعل مضارع مقترن بقد للتحقيق`],
        },
        {
          ...
          distractors: [`حرف تقليل دخل على فعل مضارع`, `حرف جواب`, `حرف توقع دخل على فعل مضارع`, `حرف تكثير دخل على فعل مضارع`],
        },
        {
          ...
          distractors: [`حرف تقليل دخل على فعل مضارع`, `مفعول به`, `حرف تكثير دخل على فعل مضارع`, `حرف توقع دخل على فعل مضارع`],
        },
        {
          ...
          distractors: [`حرف تحقيق دخل على فعل ماضٍ`, `مفعول به`, `حرف تقليل دخل على فعل مضارع (المعنى الغالب)`, `حرف تكثير دخل على فعل مضارع`],
        },
        {
          ...
          distractors: [`حرف تحقيق دخل على فعل ماضٍ`, `مفعول به`, `حرف توقّع دخل على فعل مضارع`, `حرف تكثير دخل على فعل مضارع`],
        },
      ],
    },
  ],
