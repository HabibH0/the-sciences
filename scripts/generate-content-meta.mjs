...
import { MODULES as LOGIC_MODULES } from '../content-mantiq/index.js';
...
const courseSources = [
  {
    id: 'mantiq', name: 'Logic', arabicName: 'المنطق',
...
function lessonShell(lesson) {
  return {
    ...
    learningModel: lesson.learningModel || 'grammar',
  };
}
